...
m74 -27 c18 -7 22 -34 5 -34 -17 0 -49 20 -49 30 0 11 21 13 44 4z"></path></g></g></svg>`);function l3(a,n){let c=pt(n,"class",3,"");var s=s3();L(()=>p1(s,0,Ve(c()))),k(a,s)}var i3=P2('<circle cx="100" cy="100" fill="none" stroke-width="18" stroke-linecap="butt" transform="rotate(-90 100 100)" class="transition-all duration-300"></circle>'),c3=E('<span class="flex items-center gap-1 text-xs text-base-content/50 tabular-nums"><span class="inline-block w-2 h-2 rounded-full flex-shrink-0"></span> </span>'),d3=E('<div class="flex flex-wrap justify-center gap-x-3 gap-y-0.5 mt-1"></div>'),u3=E('<button type="button"> </button>'),m3=E('<div class="flex items-center gap-2"><span class="inline-block w-3 h-3 rounded-full flex-shrink-0"></span> <span class="text-xs text-base-content/70 flex-1 min-w-0 truncate"> </span> <div class="flex items-center gap-2 flex-1"><input type="range" min="0" max="100" step="1" class="range range-sm range-secondary flex-1"/> <input type="number" min="0" max="100" step="1" class="input input-xs w-14 text-right tabular-nums"/> <span class="text-xs text-base-content/70">%</span></div></div>'),p3=E('<button type="button" class="btn btn-xs btn-ghost text-secondary border border-secondary/30"> </button>'),v3=E('<div class="mt-3 space-y-2"></div> <div class="flex items-center justify-between mt-2"><span class="text-xs text-base-content/50"> <span> </span></span> <!></div>',1),b3=E('<div class="px-5 pb-3"><!></div>'),g3=E('<button type="button"><!> <span class="text-xs font-bold"> </span></button>'),f3=E('<button type="button"> </button>'),h3=E('<button type="button"> </button>'),M3=E('<div class="form-control mt-3 pl-4 border-l-2 border-secondary/20"><label for="fridge-temp" class="label"><span class="label-text text-xs font-semibold text-base-content/70 uppercase tracking-wide"> </span></label> <input id="fridge-temp" type="number" step="0.5" class="input border-0 border-b-2 border-base-300 rounded-none focus:border-secondary focus:outline-none bg-transparent w-full"/></div>'),x3=E('<button type="button"> </button>'),y3=E('<div class="form-control mt-3 pl-4 border-l-2 border-secondary/20"><label for="start-time" class="label"><span class="label-text text-xs font-semibold text-base-content/70 uppercase tracking-wide"> </span></label> <input id="start-time" type="time" class="input border-0 border-b-2 border-base-300 rounded-none focus:border-secondary focus:outline-none bg-transparent w-full"/></div>'),z3=E('<div class="form-control"><input id="salt-pct" type="number" min="1" max="3" step="0.1" class="input border-0 border-b-2 border-base-300 rounded-none focus:border-secondary focus:outline-none bg-transparent w-full" placeholder="2.0"/></div> <p class="text-xs text-base-content/50 mt-1"> </p>',1),_3=E('<div class="form-control"><input id="starter-hyd" type="number" min="50" max="200" step="5" class="input border-0 border-b-2 border-base-300 rounded-none focus:border-secondary focus:outline-none bg-transparent w-full"/></div>'),k3=E('<div><div class="flex justify-between text-xs text-base-content/70 mb-1"><span> </span> <span class="font-semibold text-base-content"> </span></div> <progress class="progress progress-secondary progress-sm w-full"></progress> <div class="flex justify-between text-xs text-base-content/50 mt-0.5"><span></span> <span></span></div></div>'),w3=E('<div class="modal modal-open"><button type="button" class="modal-backdrop"></button> <div class="modal-box w-full max-w-sm p-0 overflow-hidden" role="dialog" aria-modal="true" aria-labelledby="philosophy-modal-title"><div class="flex items-center justify-between px-5 py-4 border-b border-base-200"><h2 id="philosophy-modal-title" class="text-base font-semibold text-base-content"> </h2> <button type="button" class="btn btn-ghost btn-sm btn-circle"><svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12"></path></svg></button></div> <div class="px-5 py-4 space-y-4"><div><p class="text-xs font-semibold text-secondary uppercase tracking-wide mb-1"> </p> <p class="text-sm text-base-content/70 leading-relaxed"> </p></div> <div class="border-t border-base-200 pt-4"><p class="text-xs font-semibold text-secondary uppercase tracking-wide mb-1"> </p> <p class="text-sm text-base-content/70 leading-relaxed"> </p></div></div> <div class="px-5 pb-5"><button type="button" class="btn btn-primary w-full"> </button></div></div></div>'),T3=E("<li> </li>"),F3=E("<li> </li>"),S3=E('<div class="modal modal-open"><button type="button" class="modal-backdrop"></button> <div class="modal-box w-full max-w-md p-0 overflow-hidden" role="dialog" aria-modal="true" aria-labelledby="autolyse-modal-title"><div class="flex items-center justify-between px-5 py-4 border-b border-base-200"><h2 id="autolyse-modal-title" class="text-base font-semibold text-base-content"> </h2> <button type="button" class="btn btn-ghost btn-sm btn-circle"><svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12"></path></svg></button></div> <div class="px-5 py-4 space-y-4"><p class="text-sm text-base-content/70 leading-relaxed"> </p> <div><p class="text-xs font-semibold text-success uppercase tracking-wide mb-1"> </p> <ul class="list-disc pl-5 space-y-1 text-sm text-base-content/70 leading-relaxed"></ul></div> <div class="border-t border-base-200 pt-4"><p class="text-xs font-semibold text-warning uppercase tracking-wide mb-1"> </p> <ul class="list-disc pl-5 space-y-1 text-sm text-base-content/70 leading-relaxed"></ul></div></div> <div class="px-5 pb-5"><button type="button" class="btn btn-primary w-full"> </button></div></div></div>'),C3=E('<div class="modal modal-open"><button type="button" class="modal-backdrop"></button> <div class="modal-box w-full max-w-sm p-0 overflow-hidden" role="dialog" aria-modal="true" aria-labelledby="proof-method-modal-title"><div class="flex items-center justify-between px-5 py-4 border-b border-base-200"><h2 id="proof-method-modal-title" class="text-base font-semibold text-base-content"> </h2> <button type="button" class="btn btn-ghost btn-sm btn-circle"><svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12"></path></svg></button></div> <div class="px-5 py-4 space-y-4"><div><p class="text-xs font-semibold text-secondary uppercase tracking-wide mb-1"> </p> <p class="text-sm text-base-content/70 leading-relaxed"> </p></div> <div class="border-t border-base-200 pt-4"><p class="text-xs font-semibold text-secondary uppercase tracking-wide mb-1"> </p> <p class="text-sm text-base-content/70 leading-relaxed"> </p></div></div> <div class="px-5 pb-5"><button type="button" class="btn btn-primary w-full"> </button></div></div></div>'),A3=E('<div class="modal modal-open"><button type="button" class="modal-backdrop"></button> <div class="modal-box w-full max-w-sm p-0 overflow-hidden" role="dialog" aria-modal="true" aria-labelledby="crumb-goal-modal-title"><div class="flex items-center justify-between px-5 py-4 border-b border-base-200"><h2 id="crumb-goal-modal-title" class="text-base font-semibold text-base-content"> </h2> <button type="button" class="btn btn-ghost btn-sm btn-circle"><svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12"></path></svg></button></div> <div class="px-5 py-4 space-y-4"><div><p class="text-xs font-semibold text-secondary uppercase tracking-wide mb-1"> </p> <p class="text-sm text-base-content/70 leading-relaxed"> </p></div> <div class="border-t border-base-200 pt-4"><p class="text-xs font-semibold text-secondary uppercase tracking-wide mb-1"> </p> <p class="text-sm text-base-content/70 leading-relaxed"> </p></div> <div class="border-t border-base-200 pt-4"><p class="text-xs font-semibold text-secondary uppercase tracking-wide mb-1"> </p> <p class="text-sm text-base-content/70 leading-relaxed"> </p></div></div> <div class="px-5 pb-5"><button type="button" class="btn btn-primary w-full"> </button></div></div></div>'),B3=E('<div class="card bg-base-100 shadow-sm ring-1 ring-base-300/70 overflow-hidden"><div class="px-5 pt-5 pb-3"><h2 class="text-base font-semibold text-base-content uppercase tracking-wide"> </h2></div> <div class="px-5 pb-5 space-y-5"><div class="flex flex-col items-center"><div class="relative w-44 h-44"><svg viewBox="0 0 200 200" class="w-full h-full"><circle cx="100" cy="100" fill="none" class="stroke-base-300/30" stroke-width="18"></circle><!></svg> <div class="absolute inset-0 flex flex-col items-center justify-center pointer-events-none"><div class="flex items-baseline pointer-events-auto"><input id="total-flour" type="number" min="0" step="50" class="w-28 bg-transparent border-none text-center text-3xl font-bold text-base-content focus:outline-none tabular-nums [appearance:textfield] [&amp;::-webkit-outer-spin-button]:appearance-none [&amp;::-webkit-inner-spin-button]:appearance-none" placeholder="500"/> <span class="text-lg font-bold text-base-content/70 -ml-1">g</span></div> <span class="text-xs text-base-content/50"> </span></div></div> <!></div> <div><span class="text-xs font-semibold text-base-content/70 uppercase tracking-wide"> </span> <div class="grid grid-cols-3 gap-2 mt-2"></div> <!></div> <div><div class="flex items-center justify-between mb-2"><span class="text-xs font-semibold text-base-content/70 uppercase tracking-wide"> </span> <button type="button" class="btn btn-ghost btn-xs rounded-full border border-base-300 bg-base-100"><span>°C</span> <span class="text-base-content/30">/</span> <span>°F</span></button></div> <div class="grid grid-cols-2 gap-3"><div class="form-control"><label for="ambient-temp" class="label py-1"><span class="label-text text-xs text-base-content/70"> </span></label> <input id="ambient-temp" type="number" step="0.5" class="input border-0 border-b-2 border-base-300 rounded-none focus:border-secondary focus:outline-none bg-transparent w-full"/></div> <div class="form-control"><label for="dough-temp" class="label py-1"><span class="label-text text-xs text-base-content/70"> <span class="text-base-content/40"> </span></span></label> <input id="dough-temp" type="number" step="0.5" class="input border-0 border-b-2 border-base-300 rounded-none focus:border-secondary focus:outline-none bg-transparent w-full placeholder:text-base-content/30"/></div></div></div></div> <!> <div class="border-t border-base-200"><div class="px-5 py-3"><span class="text-xs font-semibold text-base-content/70 uppercase tracking-wide"> </span></div> <div class="px-5 pb-5 space-y-5"><div><div class="flex items-center gap-1.5 mb-2"><p class="text-xs font-semibold text-base-content/70 uppercase tracking-wide"> </p> <button type="button" class="btn btn-ghost btn-xs btn-circle flex-shrink-0"><svg xmlns="http://www.w3.org/2000/svg" class="w-[1.14rem] h-[1.14rem]" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true"><path fill-rule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7-4a1 1 0 11-2 0 1 1 0 012 0zM9 9a1 1 0 000 2v3a1 1 0 001 1h1a1 1 0 100-2v-3a1 1 0 00-1-1H9z" clip-rule="evenodd"></path></svg></button></div> <div class="grid grid-cols-3 gap-2"></div> <p class="text-xs text-base-content/70 mt-2 leading-snug"> </p></div> <div><div class="flex items-center gap-1.5 mb-2"><p class="text-xs font-semibold text-base-content/70 uppercase tracking-wide"> </p> <button type="button" class="btn btn-ghost btn-xs btn-circle flex-shrink-0"><svg xmlns="http://www.w3.org/2000/svg" class="w-[1.14rem] h-[1.14rem]" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true"><path fill-rule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7-4a1 1 0 11-2 0 1 1 0 012 0zM9 9a1 1 0 000 2v3a1 1 0 001 1h1a1 1 0 100-2v-3a1 1 0 00-1-1H9z" clip-rule="evenodd"></path></svg></button></div> <div class="grid grid-cols-2 gap-2"></div> <p class="text-xs text-base-content/70 mt-2 leading-snug"> </p></div> <div><div class="flex items-center gap-1.5 mb-2"><p class="text-xs font-semibold text-base-content/70 uppercase tracking-wide"> </p> <button type="button" class="btn btn-ghost btn-xs btn-circle flex-shrink-0"><svg xmlns="http://www.w3.org/2000/svg" class="w-[1.14rem] h-[1.14rem]" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true"><path fill-rule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7-4a1 1 0 11-2 0 1 1 0 012 0zM9 9a1 1 0 000 2v3a1 1 0 001 1h1a1 1 0 100-2v-3a1 1 0 00-1-1H9z" clip-rule="evenodd"></path></svg></button></div> <div class="grid grid-cols-2 gap-2"></div> <!></div> <div><p class="text-xs font-semibold text-base-content/70 uppercase tracking-wide mb-2"> </p> <div class="grid grid-cols-2 gap-2"></div> <!></div></div></div> <div class="border-t border-base-200"><div class="px-5 py-3"><span class="text-xs font-semibold text-base-content/70 uppercase tracking-wide"> </span></div> <div class="px-5 pb-5 space-y-4"><div><div class="flex items-center justify-between mb-1.5"><span class="text-xs font-semibold text-base-content/70 uppercase tracking-wide"> </span> <div class="flex items-center gap-2"><span class="text-xs text-base-content/50"><!></span> <input type="checkbox" class="toggle toggle-secondary toggle-sm" role="switch"/> <span class="text-xs text-base-content/70"> </span></div></div> <!></div> <div><div class="flex items-center justify-between mb-1.5"><span class="text-xs font-semibold text-base-content/70 uppercase tracking-wide"> </span> <div class="flex items-center gap-2"><span class="text-xs text-base-content/50"> </span> <input type="checkbox" class="toggle toggle-secondary toggle-sm" role="switch"/> <span class="text-xs text-base-content/70"> </span></div></div> <!></div> <div><div class="flex items-center justify-between mb-1.5"><div class="flex items-center gap-1.5"><span class="text-xs font-semibold text-base-content/70 uppercase tracking-wide"> </span> <button type="button" class="btn btn-ghost btn-xs btn-circle flex-shrink-0"><svg xmlns="http://www.w3.org/2000/svg" class="w-[1.14rem] h-[1.14rem]" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true"><path fill-rule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7-4a1 1 0 11-2 0 1 1 0 012 0zM9 9a1 1 0 000 2v3a1 1 0 001 1h1a1 1 0 100-2v-3a1 1 0 00-1-1H9z" clip-rule="evenodd"></path></svg></button></div> <div class="flex items-center gap-2"><span> </span> <input type="checkbox" class="toggle toggle-secondary toggle-sm" role="switch"/> <span> </span></div></div> <!></div></div></div></div> <!> <!> <!> <!>',1);function H3(a,n){Re(n,!0);const c=()=>re(xe,"$lang",f),s=()=>re(ge,"$inputs",f),b=()=>re(Yt,"$result",f),[f,d]=Le(),i=m1(()=>Ne[c()]);let g=oe(!1),S=oe(!1),y=oe(!1),F=oe(!1);const I=["Tight","Balanced","Open"],q={Tight:r3,Balanced:o3,Open:l3};let P=m1(()=>s().flourBlend.reduce((m,p)=>m+p.pct,0)),_=m1(()=>Math.round(r(P))===100);function u(m){return s().flourBlend.some(p=>p.type===m)}function j(m){ge.update(p=>{if(p.flourBlend.find(h=>h.type===m)){if(p.flourBlend.length<=1)return p;const h=p.flourBlend.filter(a1=>a1.type!==m),w=h.reduce((a1,Z)=>a1+Z.pct,0);let A;if(w>0){const a1=100/w;A=h.map(Z=>({...Z,pct:Math.round(Z.pct*a1)}))}else{const a1=Math.floor(100/h.length);A=h.map((Z,z1)=>({...Z,pct:z1===0?a1+(100-a1*h.length):a1}))}const Q=A.reduce((a1,Z)=>a1+Z.pct,0);return Q!==100&&A.length>0&&(A[0]={...A[0],pct:A[0].pct+(100-Q)}),{...p,flourBlend:A}}else{const h=p.flourBlend.length+1,w=Math.round(100/h),A=(100-w)/100,Q=p.flourBlend.map(Z=>({...Z,pct:Math.round(Z.pct*A)}));Q.push({type:m,pct:w});const a1=Q.reduce((Z,z1)=>Z+z1.pct,0);return a1!==100&&Q.length>0&&(Q[0]={...Q[0],pct:Q[0].pct+(100-a1)}),{...p,flourBlend:Q}}})}function G(m,p){const v=Math.max(0,Math.min(100,parseFloat(p)||0));ge.update(h=>{const w=h.flourBlend.filter(Z=>Z.type!==m),A=w.reduce((Z,z1)=>Z+z1.pct,0),Q=100-v;let a1;if(w.length===0)a1=h.flourBlend.map(Z=>({...Z,pct:100}));else if(A===0){const Z=Math.floor(Q/w.length),z1=Q-Z*w.length;a1=h.flourBlend.map((f1,C1)=>{if(f1.type===m)return{...f1,pct:v};const H1=w.indexOf(f1);return{...f1,pct:Z+(H1===0?z1:0)}})}else{const Z=Q/A,z1=w.map(r1=>({...r1,pct:r1.pct*Z})),f1=z1.map(r1=>({...r1,pct:Math.floor(r1.pct)})),C1=f1.reduce((r1,V1)=>r1+V1.pct,0);let H1=Q-C1;const pe=z1.map((r1,V1)=>({i:V1,frac:r1.pct-Math.floor(r1.pct)})).sort((r1,V1)=>V1.frac-r1.frac);for(let r1=0;r1<H1;r1++)f1[pe[r1].i].pct+=1;const U1=new Map(f1.map(r1=>[r1.type,r1.pct]));a1=h.flourBlend.map(r1=>r1.type===m?{...r1,pct:v}:{...r1,pct:U1.get(r1.type)??r1.pct})}return{...h,flourBlend:a1}})}function R(){ge.update(m=>{const p=m.flourBlend.reduce((A,Q)=>A+Q.pct,0);if(p===0||p===100)return m;const v=100/p,h=m.flourBlend.map(A=>({...A,pct:Math.round(A.pct*v)})),w=h.reduce((A,Q)=>A+Q.pct,0);return w!==100&&h.length>0&&(h[0]={...h[0],pct:h[0].pct+(100-w)}),{...m,flourBlend:h}})}const O={BreadFlour:"#F59E0B",AllPurpose:"#60A5FA",WholeWheat:"#92400E",Rye:"#059669",Spelt:"#7C3AED",Einkorn:"#F43F5E"},M=80,T=2*Math.PI*M;let z=m1(()=>{let m=0;return s().flourBlend.map(p=>{const v=p.pct/100*T,h={type:p.type,color:O[p.type],dasharray:`${v} ${T-v}`,dashoffset:-m};return m+=v,h})}),N=m1(()=>b().formula.autoSaltPct),J=m1(()=>Math.round(b().formula.saltG)),X=m1(()=>s().tempUnit==="F"?Math.round(nt(s().ambientTempC)):s().ambientTempC),K=m1(()=>s().doughTempC===null?"":s().tempUnit==="F"?Math.round(nt(s().doughTempC)):s().doughTempC),l1=m1(()=>s().tempUnit==="F"?Math.round(nt(s().fridgeTempC)):s().fridgeTempC);function y1(m,p){const v=s().tempUnit==="F"?$r(p):p;ge.update(h=>{const w={...h,[m]:v};return h.autolyseOn&&(m==="ambientTempC"||m==="doughTempC")?{...w,autolyseMins:M2(w.ambientTempC,w.doughTempC)}:w})}function n1(m,p){ge.update(v=>({...v,[m]:p}))}function s1(){ge.update(m=>({...m,tempUnit:m.tempUnit==="C"?"F":"C"}))}function x1(m){const p=Math.max(0,parseFloat(m.target.value)||0);n1("totalFlourInputG",p)}function b1(m){const p=m.target;let v=parseFloat(p.value);isNaN(v)||(v=Math.min(r(k1),Math.max(r(_1),v)),y1("ambientTempC",v))}function D(m){const v=m.target.value;if(v==="")ge.update(h=>{const w={...h,doughTempC:null};return h.autolyseOn?{...w,autolyseMins:M2(w.ambientTempC,w.doughTempC)}:w});else{let h=parseFloat(v);isNaN(h)||(h=Math.min(r(k1),Math.max(r(_1),h)),y1("doughTempC",h))}}function h1(){ge.update(m=>m.autolyseOn?{...m,autolyseOn:!1}:{...m,autolyseOn:!0,autolyseMins:M2(m.ambientTempC,m.doughTempC)})}function w1(m){let p=parseFloat(m.target.value);isNaN(p)||(p=Math.min(r(T1),Math.max(r(B1),p)),y1("fridgeTempC",p))}const L1='a[href],button:not([disabled]),input:not([disabled]),select:not([disabled]),textarea:not([disabled]),[tabindex]:not([tabindex="-1"])';function A1(m,p){const v=Array.from(m.querySelectorAll(L1));v.length&&v[0].focus();function h(w){if(w.key==="Escape"){$(g,!1),$(S,!1),$(y,!1),$(F,!1);return}if(w.key!=="Tab")return;const A=v[0],Q=v[v.length-1];w.shiftKey?document.activeElement===A&&(w.preventDefault(),Q.focus()):document.activeElement===Q&&(w.preventDefault(),A.focus())}return m.addEventListener("keydown",h),{destroy(){m.removeEventListener("keydown",h)}}}function P1(m){return A1(m)}const _1=m1(()=>s().tempUnit==="F"?32:0),k1=m1(()=>s().tempUnit==="F"?120:50),B1=m1(()=>s().tempUnit==="F"?28:-2),T1=m1(()=>s().tempUnit==="F"?50:10),J1=20,K1=60-J1,I1=m1(()=>Math.max(0,Math.min(K1,s().autolyseMins-J1)));var $1=B3(),d1=se($1),g1=t(d1),N1=t(g1),O1=t(N1,!0);e(N1),e(g1);var e1=o(g1,2),B=t(e1),x=t(B),C=t(x),i1=t(C);V(i1,"r",M);var u1=o(i1);te(u1,17,()=>r(z),m=>m.type,(m,p)=>{var v=i3();V(v,"r",M),L(()=>{V(v,"stroke",r(p).color),V(v,"stroke-dasharray",r(p).dasharray),V(v,"stroke-dashoffset",r(p).dashoffset)}),k(m,v)}),e(C);var j1=o(C,2),t1=t(j1),Y=t(t1);le(Y),r2(2),e(t1);var U=o(t1,2),W=t(U,!0);e(U),e(j1),e(x);var o1=o(x,2);{var c1=m=>{var p=d3();te(p,5,()=>s().flourBlend,v=>v.type,(v,h)=>{var w=c3(),A=t(w),Q=o(A);e(w),L(a1=>{Rt(A,`background-color: ${O[r(h).type]??""}`),l(Q,` ${r(i).flourTypes[r(h).type]??""}: ${a1??""}g`)},[()=>Math.round(s().totalFlourInputG*r(h).pct/100)]),k(v,w)}),e(p),k(m,p)};v1(o1,m=>{s().flourBlend.length>1&&m(c1)})}e(B);var M1=o(B,2),F1=t(M1),G1=t(F1,!0);e(F1);var S1=o(F1,2);te(S1,21,()=>Br,he,(m,p)=>{var v=u3(),h=t(v,!0);e(v),L(w=>{p1(v,1,`btn btn-sm rounded-xl border-2 h-auto py-2 px-1 text-xs
							${w??""}`),l(h,r(i).flourTypes[r(p)])},[()=>u(r(p))?"btn-secondary border-secondary text-secondary-content":"btn-ghost border-base-300"]),H("click",v,()=>j(r(p))),k(m,v)}),e(S1);var R1=o(S1,2);{var W1=m=>{var p=v3(),v=se(p);te(v,5,()=>s().flourBlend,f1=>f1.type,(f1,C1)=>{var H1=m3(),pe=t(H1),U1=o(pe,2),r1=t(U1,!0);e(U1);var V1=o(U1,2),Q1=t(V1);le(Q1);var ve=o(Q1,2);le(ve),r2(2),e(V1),e(H1),L(Z1=>{Rt(pe,`background-color: ${O[r(C1).type]??""}`),l(r1,r(i).flourTypes[r(C1).type]),ae(Q1,r(C1).pct),ae(ve,Z1)},[()=>Math.round(r(C1).pct)]),H("input",Q1,Z1=>G(r(C1).type,Z1.target.value)),H("change",ve,Z1=>G(r(C1).type,Z1.target.value)),k(f1,H1)}),e(v);var h=o(v,2),w=t(h),A=t(w),Q=o(A),a1=t(Q);e(Q),e(w);var Z=o(w,2);{var z1=f1=>{var C1=p3(),H1=t(C1,!0);e(C1),L(()=>l(H1,r(i).blendNormalize)),H("click",C1,R),k(f1,C1)};v1(Z,f1=>{r(_)||f1(z1)})}e(h),L(f1=>{l(A,`${r(i).blendTotal??""}: `),p1(Q,1,`font-semibold tabular-nums ${r(_)?"text-success":"text-error"}`),l(a1,`${f1??""}%`)},[()=>Math.round(r(P))]),k(m,p)};v1(R1,m=>{s().flourBlend.length>1&&m(W1)})}e(M1);var Y1=o(M1,2),D1=t(Y1),X1=t(D1),Se=t(X1,!0);e(X1);var ne=o(X1,2),Ce=t(ne),ye=o(Ce,4);e(ne),e(D1);var ce=o(D1,2),de=t(ce),ue=t(de),ze=t(ue),Ae=t(ze,!0);e(ze),e(ue);var me=o(ue,2);le(me),e(de);var qe=o(de,2),Oe=t(qe),Ke=t(Oe),x2=t(Ke),Ye=o(x2),j2=t(Ye,!0);e(Ye),e(Ke),e(Oe);var Te=o(Oe,2);le(Te),e(qe),e(ce),e(Y1),e(e1);var y2=o(e1,2);{var z2=m=>{var p=b3(),v=t(p);t3(v,{get warnings(){return b().warnings}}),e(p),k(m,p)};v1(y2,m=>{s().totalFlourInputG>0&&m(z2)})}var Ie=o(y2,2),s2=t(Ie),Ze=t(s2),R2=t(Ze,!0);e(Ze),e(s2);var l2=o(s2,2),Je=t(l2),Xe=t(Je),i2=t(Xe),_2=t(i2,!0);e(i2);var c2=o(i2,2);e(Xe);var $e=o(Xe,2);te($e,21,()=>I,he,(m,p)=>{const v=m1(()=>q[r(p)]);var h=g3(),w=t(h);cr(w,()=>r(v),(a1,Z)=>{Z(a1,{class:"w-full h-auto max-h-full"})});var A=o(w,2),Q=t(A,!0);e(A),e(h),L(()=>{p1(h,1,`btn rounded-xl border-2 flex-col h-auto py-3 px-2 gap-1.5
								${s().crumbGoal===r(p)?"btn-secondary border-secondary text-secondary-content":"btn-ghost border-base-300"}`),l(Q,r(i).crumbGoalNames[r(p)])}),H("click",h,()=>n1("crumbGoal",r(p))),k(m,h)}),e($e);var k2=o($e,2),w2=t(k2,!0);e(k2),e(Je);var d2=o(Je,2),Fe=t(d2),_e=t(Fe),Ee=t(_e,!0);e(_e);var Be=o(_e,2);e(Fe);var Ge=o(Fe,2);te(Ge,20,()=>["Predictability","FlavorDevelopment"],he,(m,p)=>{var v=f3(),h=t(v,!0);e(v),L(()=>{p1(v,1,`btn btn-sm rounded-xl border-2 h-auto py-2.5 px-3
							${s().fermentationPhilosophy===p?"btn-secondary border-secondary text-secondary-content":"btn-ghost border-base-300"}`),l(h,p==="Predictability"?r(i).philosophyPredictability:r(i).philosophyFlavorDev)}),H("click",v,()=>n1("fermentationPhilosophy",p)),k(m,v)}),e(Ge);var He=o(Ge,2),u2=t(He,!0);e(He),e(d2);var Pe=o(d2,2),m2=t(Pe),p2=t(m2),ea=t(p2,!0);e(p2);var bt=o(p2,2);e(m2);var D2=o(m2,2);te(D2,20,()=>["Room","ColdRetard"],he,(m,p)=>{var v=h3(),h=t(v,!0);e(v),L(()=>{p1(v,1,`btn btn-sm rounded-xl border-2 h-auto py-2.5 px-3
								${s().proofMethod===p?"btn-secondary border-secondary text-secondary-content":"btn-ghost border-base-300"}`),l(h,p==="Room"?r(i).roomTemp:r(i).coldRetard)}),H("click",v,()=>n1("proofMethod",p)),k(m,v)}),e(D2);var ta=o(D2,2);{var aa=m=>{var p=M3(),v=t(p),h=t(v),w=t(h);e(h),e(v);var A=o(v,2);le(A),e(p),L(()=>{l(w,`${r(i).fridgeTemp??""} (°${s().tempUnit??""})`),V(A,"min",r(B1)),V(A,"max",r(T1)),ae(A,r(l1))}),H("input",A,w1),k(m,p)};v1(ta,m=>{s().proofMethod==="ColdRetard"&&m(aa)})}e(Pe);var gt=o(Pe,2),L2=t(gt),ra=t(L2,!0);e(L2);var N2=o(L2,2);te(N2,20,()=>["relative","clock"],he,(m,p)=>{var v=x3(),h=t(v,!0);e(v),L(()=>{p1(v,1,`btn btn-sm rounded-xl border-2 h-auto py-2.5 px-3
								${s().scheduleMode===p?"btn-secondary border-secondary text-secondary-content":"btn-ghost border-base-300"}`),l(h,p==="relative"?r(i).relative:r(i).clock)}),H("click",v,()=>n1("scheduleMode",p)),k(m,v)}),e(N2);var na=o(N2,2);{var oa=m=>{var p=y3(),v=t(p),h=t(v),w=t(h,!0);e(h),e(v);var A=o(v,2);le(A),e(p),L(()=>{l(w,r(i).startTime),ae(A,s().startTime??"08:00")}),H("input",A,Q=>n1("startTime",Q.target.value||null)),k(m,p)};v1(na,m=>{s().scheduleMode==="clock"&&m(oa)})}e(gt),e(l2),e(Ie);var ft=o(Ie,2),O2=t(ft),ht=t(O2),sa=t(ht,!0);e(ht),e(O2);var Mt=o(O2,2),I2=t(Mt),$2=t(I2),E2=t($2),la=t(E2,!0);e(E2);var xt=o(E2,2),G2=t(xt),ia=t(G2);{var ca=m=>{var p=Me();L(v=>l(p,v),[()=>r(i).saltAutoLabel(r(N).toFixed(2),String(r(J)))]),k(m,p)},da=m=>{var p=Me();L(()=>l(p,r(i).saltManual)),k(m,p)};v1(ia,m=>{s().saltAutoCalc?m(ca):m(da,-1)})}e(G2);var Qe=o(G2,2);le(Qe);var yt=o(Qe,2),ua=t(yt,!0);e(yt),e(xt),e($2);var ma=o($2,2);{var pa=m=>{var p=z3(),v=se(p),h=t(v);le(h),e(v);var w=o(v,2),A=t(w,!0);e(w),L(()=>{ae(h,s().saltPct),l(A,r(i).saltBakersPct)}),H("input",h,Q=>n1("saltPct",parseFloat(Q.target.value)||2)),k(m,p)};v1(ma,m=>{s().saltAutoCalc||m(pa)})}e(I2);var W2=o(I2,2),U2=t(W2),V2=t(U2),va=t(V2,!0);e(V2);var zt=o(V2,2),q2=t(zt),ba=t(q2,!0);e(q2);var e2=o(q2,2);le(e2);var _t=o(e2,2),ga=t(_t,!0);e(_t),e(zt),e(U2);var fa=o(U2,2);{var ha=m=>{var p=_3(),v=t(p);le(v),e(p),L(()=>ae(v,s().starterHydrationPct)),H("input",v,h=>n1("starterHydrationPct",parseFloat(h.target.value)||100)),k(m,p)};v1(fa,m=>{s().starterHydrationAutoCalc||m(ha)})}e(W2);var kt=o(W2,2),K2=t(kt),Y2=t(K2),Z2=t(Y2),Ma=t(Z2,!0);e(Z2);var wt=o(Z2,2);e(Y2);var Tt=o(Y2,2),T2=t(Tt),xa=t(T2,!0);e(T2);var t2=o(T2,2);le(t2);var J2=o(t2,2),ya=t(J2,!0);e(J2),e(Tt),e(K2);var za=o(K2,2);{var _a=m=>{var p=k3(),v=t(p),h=t(v),w=t(h,!0);e(h);var A=o(h,2),Q=t(A);e(A),e(v);var a1=o(v,2);V(a1,"max",K1);var Z=o(a1,2),z1=t(Z);z1.textContent="20 min";var f1=o(z1,2);f1.textContent="60 min",e(Z),e(p),L(()=>{l(w,r(i).duration),l(Q,`${s().autolyseMins??""} min`),ae(a1,r(I1)),V(a1,"aria-label",r(i).ariaLabels.autolyseDurationProgress)}),k(m,p)};v1(za,m=>{s().autolyseOn&&m(_a)})}e(kt),e(Mt),e(ft),e(d1);var Ft=o(d1,2);{var ka=m=>{var p=w3(),v=t(p),h=o(v,2),w=t(h),A=t(w),Q=t(A,!0);e(A);var a1=o(A,2);e(w);var Z=o(w,2),z1=t(Z),f1=t(z1),C1=t(f1,!0);e(f1);var H1=o(f1,2),pe=t(H1,!0);e(H1),e(z1);var U1=o(z1,2),r1=t(U1),V1=t(r1,!0);e(r1);var Q1=o(r1,2),ve=t(Q1,!0);e(Q1),e(U1),e(Z);var Z1=o(Z,2),ee=t(Z1),We=t(ee,!0);e(ee),e(Z1),e(h),h2(h,be=>P1?.(be)),e(p),L(()=>{V(v,"aria-label",r(i).ariaLabels.closeFermentationPhilosophyModal),l(Q,r(i).philosophyModalTitle),V(a1,"aria-label",r(i).ariaLabels.closeButton),l(C1,r(i).philosophyPredictability),l(pe,r(i).philosophyModalPredictabilityBody),l(V1,r(i).philosophyFlavorDev),l(ve,r(i).philosophyModalFlavorDevBody),l(We,r(i).done)}),H("click",v,()=>$(g,!1)),H("click",a1,()=>$(g,!1)),H("click",ee,()=>$(g,!1)),k(m,p)};v1(Ft,m=>{r(g)&&m(ka)})}var St=o(Ft,2);{var wa=m=>{var p=S3(),v=t(p),h=o(v,2),w=t(h),A=t(w),Q=t(A,!0);e(A);var a1=o(A,2);e(w);var Z=o(w,2),z1=t(Z),f1=t(z1,!0);e(z1);var C1=o(z1,2),H1=t(C1),pe=t(H1,!0);e(H1);var U1=o(H1,2);te(U1,21,()=>r(i).autolyseModalUseItems,he,(be,v2)=>{var ke=T3(),Ue=t(ke,!0);e(ke),L(()=>l(Ue,r(v2))),k(be,ke)}),e(U1),e(C1);var r1=o(C1,2),V1=t(r1),Q1=t(V1,!0);e(V1);var ve=o(V1,2);te(ve,21,()=>r(i).autolyseModalAvoidItems,he,(be,v2)=>{var ke=F3(),Ue=t(ke,!0);e(ke),L(()=>l(Ue,r(v2))),k(be,ke)}),e(ve),e(r1),e(Z);var Z1=o(Z,2),ee=t(Z1),We=t(ee,!0);e(ee),e(Z1),e(h),h2(h,be=>P1?.(be)),e(p),L(()=>{V(v,"aria-label",r(i).ariaLabels.closeAutolyseModal),l(Q,r(i).autolyseModalTitle),V(a1,"aria-label",r(i).ariaLabels.closeButton),l(f1,r(i).autolyseModalIntro),l(pe,r(i).autolyseModalUseTitle),l(Q1,r(i).autolyseModalAvoidTitle),l(We,r(i).done)}),H("click",v,()=>$(S,!1)),H("click",a1,()=>$(S,!1)),H("click",ee,()=>$(S,!1)),k(m,p)};v1(St,m=>{r(S)&&m(wa)})}var Ct=o(St,2);{var Ta=m=>{var p=C3(),v=t(p),h=o(v,2),w=t(h),A=t(w),Q=t(A,!0);e(A);var a1=o(A,2);e(w);var Z=o(w,2),z1=t(Z),f1=t(z1),C1=t(f1,!0);e(f1);var H1=o(f1,2),pe=t(H1,!0);e(H1),e(z1);var U1=o(z1,2),r1=t(U1),V1=t(r1,!0);e(r1);var Q1=o(r1,2),ve=t(Q1,!0);e(Q1),e(U1),e(Z);var Z1=o(Z,2),ee=t(Z1),We=t(ee,!0);e(ee),e(Z1),e(h),h2(h,be=>P1?.(be)),e(p),L(()=>{V(v,"aria-label",r(i).ariaLabels.closeProofMethodModal),l(Q,r(i).proofMethodModalTitle),V(a1,"aria-label",r(i).ariaLabels.closeProofMethodModal),l(C1,r(i).roomTemp),l(pe,r(i).proofMethodRoomBody),l(V1,r(i).coldRetard),l(ve,r(i).proofMethodColdRetardBody),l(We,r(i).done)}),H("click",v,()=>$(y,!1)),H("click",a1,()=>$(y,!1)),H("click",ee,()=>$(y,!1)),k(m,p)};v1(Ct,m=>{r(y)&&m(Ta)})}var Fa=o(Ct,2);{var Sa=m=>{var p=A3(),v=t(p),h=o(v,2),w=t(h),A=t(w),Q=t(A,!0);e(A);var a1=o(A,2);e(w);var Z=o(w,2),z1=t(Z),f1=t(z1),C1=t(f1,!0);e(f1);var H1=o(f1,2),pe=t(H1,!0);e(H1),e(z1);var U1=o(z1,2),r1=t(U1),V1=t(r1,!0);e(r1);var Q1=o(r1,2),ve=t(Q1,!0);e(Q1),e(U1);var Z1=o(U1,2),ee=t(Z1),We=t(ee,!0);e(ee);var be=o(ee,2),v2=t(be,!0);e(be),e(Z1),e(Z);var ke=o(Z,2),Ue=t(ke),Ca=t(Ue,!0);e(Ue),e(ke),e(h),h2(h,Aa=>P1?.(Aa)),e(p),L(()=>{V(v,"aria-label",r(i).ariaLabels.closeCrumbGoalModal),l(Q,r(i).crumbModalTitle),V(a1,"aria-label",r(i).ariaLabels.closeButton),l(C1,r(i).crumbGoalNames.Tight),l(pe,r(i).crumbModalTightBody),l(V1,r(i).crumbGoalNames.Balanced),l(ve,r(i).crumbModalBalancedBody),l(We,r(i).crumbGoalNames.Open),l(v2,r(i).crumbModalOpenBody),l(Ca,r(i).done)}),H("click",v,()=>$(F,!1)),H("click",a1,()=>$(F,!1)),H("click",Ue,()=>$(F,!1)),k(m,p)};v1(Fa,m=>{r(F)&&m(Sa)})}L(()=>{l(O1,r(i).parameters),ae(Y,s().totalFlourInputG),l(W,r(i).totalFlour),l(G1,r(i).flourSelection),l(Se,r(i).temperatures),V(ne,"aria-label",r(i).ariaLabels.toggleTempUnit),p1(Ce,1,Ve(s().tempUnit==="C"?"text-secondary font-semibold":"text-base-content/50")),p1(ye,1,Ve(s().tempUnit==="F"?"text-secondary font-semibold":"text-base-content/50")),l(Ae,r(i).kitchenTemp),V(me,"min",r(_1)),V(me,"max",r(k1)),ae(me,r(X)),l(x2,`${r(i).doughTemp??""} `),l(j2,r(i).optional),V(Te,"min",r(_1)),V(Te,"max",r(k1)),ae(Te,r(K)),V(Te,"placeholder",r(i).leaveBlankAmbient),l(R2,r(i).bakingProfile),l(_2,r(i).crumbGoal),V(c2,"aria-label",r(i).ariaLabels.learnCrumbGoal),l(w2,r(i).crumbDescriptions[s().crumbGoal]),l(Ee,r(i).fermentationPhilosophyLabel),V(Be,"aria-label",r(i).ariaLabels.learnFermentationPhilosophy),l(u2,s().fermentationPhilosophy==="Predictability"?r(i).philosophyPredictabilityDesc:r(i).philosophyFlavorDevDesc),l(ea,r(i).proofMethod),V(bt,"aria-label",r(i).ariaLabels.learnProofMethod),l(ra,r(i).scheduleMode),l(sa,r(i).fineTuning),l(la,r(i).salt),at(Qe,!s().saltAutoCalc),V(Qe,"aria-checked",!s().saltAutoCalc),V(Qe,"aria-label",r(i).ariaLabels.overrideSalt),l(ua,r(i).saltOverride),l(va,r(i).starterHydration),l(ba,s().starterHydrationAutoCalc?r(i).starterHydrationDefaultLabel:r(i).starterHydrationManual),at(e2,!s().starterHydrationAutoCalc),V(e2,"aria-checked",!s().starterHydrationAutoCalc),V(e2,"aria-label",r(i).ariaLabels.overrideStarterHydration),l(ga,r(i).starterHydrationOverride),l(Ma,r(i).autolyse),V(wt,"aria-label",r(i).ariaLabels.learnAutolyse),p1(T2,1,Ve(s().autolyseOn?"text-xs text-base-content/40":"text-xs text-base-content/70 font-semibold")),l(xa,r(i).off),at(t2,s().autolyseOn),V(t2,"aria-checked",s().autolyseOn),V(t2,"aria-label",r(i).ariaLabels.toggleAutolyseAuto),p1(J2,1,Ve(s().autolyseOn?"text-xs text-base-content/70 font-semibold":"text-xs text-base-content/40")),l(ya,r(i).auto)}),H("input",Y,x1),H("click",ne,s1),H("input",me,b1),H("input",Te,D),H("click",c2,()=>$(F,!0)),H("click",Be,()=>$(g,!0)),H("click",bt,()=>$(y,!0)),H("change",Qe,()=>n1("saltAutoCalc",!s().saltAutoCalc)),H("change",e2,()=>n1("starterHydrationAutoCalc",!s().starterHydrationAutoCalc)),H("click",wt,()=>$(S,!0)),H("change",t2,h1),k(a,$1),De(),d()}n2(["input","click","change"]);var P3=E('<tr class="bg-base-200/30"><td class="py-1.5 text-base-content/70 text-xs pl-4"> </td><td class="py-1.5 text-right tabular-nums text-base-content/70 text-xs"> </td><td class="py-1.5 text-right tabular-nums text-base-content/50 text-xs"> </td></tr>'),j3=E('<div class="px-5 pb-4"><table class="w-full text-sm"><thead><tr class="border-b border-base-200"><th class="text-left py-2 text-xs font-semibold text-base-content/50 uppercase tracking-wide"> </th><th class="text-right py-2 text-xs font-semibold text-base-content/50 uppercase tracking-wide"> </th><th class="text-right py-2 text-xs font-semibold text-base-content/50 uppercase tracking-wide"> </th></tr></thead><tbody class="divide-y divide-base-200"><tr><td class="py-2.5 text-base-content font-medium"> </td><td class="py-2.5 text-right tabular-nums text-base-content font-semibold"> </td><td class="py-2.5 text-right tabular-nums text-base-content/70">100%</td></tr><!><tr><td class="py-2.5 text-base-content font-medium"> </td><td class="py-2.5 text-right tabular-nums text-base-content font-semibold"> </td><td class="py-2.5 text-right tabular-nums text-base-content/70"> </td></tr><tr><td class="py-2.5 text-base-content font-medium"> </td><td class="py-2.5 text-right tabular-nums text-base-content font-semibold"> </td><td class="py-2.5 text-right tabular-nums text-base-content/70"> </td></tr><tr><td class="py-2.5 text-base-content font-medium"> </td><td class="py-2.5 text-right tabular-nums text-base-content font-semibold"> </td><td class="py-2.5 text-right tabular-nums text-base-content/70"> <span class="text-[10px] text-base-content/40 block leading-tight"> </span></td></tr></tbody><tfoot><tr class="border-t-2 border-secondary/30 bg-secondary/10"><td class="py-3 font-bold text-secondary"> </td><td class="py-3 text-right tabular-nums font-bold text-secondary"> </td><td class="py-3 text-right"></td></tr></tfoot></table></div>'),R3=E('<div class="modal modal-open"><button type="button" class="modal-backdrop"></button> <div class="modal-box w-full max-w-sm p-0 overflow-hidden" role="dialog" aria-modal="true" aria-labelledby="formula-modal-title"><div class="flex items-center justify-between px-5 py-4 border-b border-base-200"><h2 id="formula-modal-title" class="text-base font-semibold text-base-content"> </h2> <button type="button" class="btn btn-ghost btn-sm btn-circle"><svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12"></path></svg></button></div> <div class="px-5 py-4 space-y-4"><div><p class="text-xs font-semibold text-secondary uppercase tracking-wide mb-1"> </p> <p class="text-sm text-base-content/70 leading-relaxed"> </p></div> <div class="border-t border-base-200 pt-4"><p class="text-xs font-semibold text-secondary uppercase tracking-wide mb-1"> </p> <p class="text-sm text-base-content/70 leading-relaxed"> </p></div></div> <div class="px-5 pb-5"><button type="button" class="btn btn-primary w-full"> </button></div></div></div>'),D3=E('<div class="card bg-base-100 shadow-sm ring-1 ring-base-300/70 overflow-hidden"><div class="flex items-center justify-between px-5 pt-5 pb-3"><div><div class="flex items-center gap-1.5"><h2 class="text-base font-semibold text-base-content uppercase tracking-wide"> </h2> <button type="button" class="btn btn-ghost btn-xs btn-circle flex-shrink-0"><svg xmlns="http://www.w3.org/2000/svg" class="w-[1.14rem] h-[1.14rem]" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true"><path fill-rule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7-4a1 1 0 11-2 0 1 1 0 012 0zM9 9a1 1 0 000 2v3a1 1 0 001 1h1a1 1 0 100-2v-3a1 1 0 00-1-1H9z" clip-rule="evenodd"></path></svg></button></div> <p class="text-xs text-base-content/50 mt-0.5"> </p></div> <div class="badge badge-secondary badge-lg tabular-nums font-bold gap-1"> </div></div> <div class="px-5 pb-4"><p class="text-xs font-semibold text-base-content/70 uppercase tracking-wide mb-3"> </p> <div class="grid grid-cols-2 gap-3"><div class="rounded-xl bg-base-200/80 ring-1 ring-base-300/60 px-3 py-3 text-center"><div class="text-2xl font-bold tabular-nums text-base-content"> </div> <div class="text-xs text-base-content/60 mt-1 font-medium"> </div></div> <div class="rounded-xl bg-base-200/80 ring-1 ring-base-300/60 px-3 py-3 text-center"><div class="text-2xl font-bold tabular-nums text-base-content"> </div> <div class="text-xs text-base-content/60 mt-1 font-medium"> </div></div> <div class="rounded-xl bg-accent/10 ring-1 ring-accent/20 px-3 py-3 text-center"><div class="text-2xl font-bold tabular-nums text-accent"> </div> <div class="text-xs text-accent/70 mt-1 font-medium"> </div></div> <div class="rounded-xl bg-base-200/80 ring-1 ring-base-300/60 px-3 py-3 text-center"><div class="text-2xl font-bold tabular-nums text-base-content"> </div> <div class="text-xs text-base-content/60 mt-1 font-medium"> </div></div></div> <p class="text-xs text-base-content/50 mt-2.5 italic"> </p></div> <div class="border-t border-base-200"><button type="button" class="w-full flex items-center justify-between px-5 py-3 text-left hover:bg-base-200/50 transition-colors"><span class="text-xs font-semibold text-base-content/70 uppercase tracking-wide"> </span> <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor"><path fill-rule="evenodd" d="M5.23 7.21a.75.75 0 011.06.02L10 11.168l3.71-3.938a.75.75 0 111.08 1.04l-4.25 4.5a.75.75 0 01-1.08 0l-4.25-4.5a.75.75 0 01.02-1.06z" clip-rule="evenodd"></path></svg></button> <!></div></div> <!>',1);function L3(a,n){Re(n,!0);const c=()=>re(xe,"$lang",b),s=()=>re(dt,"$showFullFormula",b),[b,f]=Le(),d=m1(()=>Ne[c()]);function i(Y,U){return U<=0?"—":`${(Y/U*100).toFixed(1)}%`}function g(Y){return Math.round(Y).toString()}function S(Y,U){const W=Math.round(Y),o1=Math.round(U);if(W<=0||o1<=0)return"—";let c1=W,M1=o1;for(;M1;)[c1,M1]=[M1,c1%M1];return`${W/c1}:${o1/c1}`}let y=oe(!1);const F='a[href],button:not([disabled]),input:not([disabled]),select:not([disabled]),textarea:not([disabled]),[tabindex]:not([tabindex="-1"])';function I(Y,U){const W=Array.from(Y.querySelectorAll(F));W.length&&W[0].focus();function o1(c1){if(c1.key==="Escape"){$(y,!1);return}if(c1.key!=="Tab")return;const M1=W[0],F1=W[W.length-1];c1.shiftKey?document.activeElement===M1&&(c1.preventDefault(),F1.focus()):document.activeElement===F1&&(c1.preventDefault(),M1.focus())}return Y.addEventListener("keydown",o1),{destroy(){Y.removeEventListener("keydown",o1)}}}function q(Y){return I(Y)}var P=D3(),_=se(P),u=t(_),j=t(u),G=t(j),R=t(G),O=t(R,!0);e(R);var M=o(R,2);e(G);var T=o(G,2),z=t(T,!0);e(T),e(j);var N=o(j,2),J=t(N);e(N),e(u);var X=o(u,2),K=t(X),l1=t(K,!0);e(K);var y1=o(K,2),n1=t(y1),s1=t(n1),x1=t(s1);e(s1);var b1=o(s1,2),D=t(b1,!0);e(b1),e(n1);var h1=o(n1,2),w1=t(h1),L1=t(w1);e(w1);var A1=o(w1,2),P1=t(A1,!0);e(A1),e(h1);var _1=o(h1,2),k1=t(_1),B1=t(k1);e(k1);var T1=o(k1,2),J1=t(T1,!0);e(T1),e(_1);var E1=o(_1,2),K1=t(E1),I1=t(K1);e(K1);var $1=o(K1,2),d1=t($1,!0);e($1),e(E1),e(y1);var g1=o(y1,2),N1=t(g1,!0);e(g1),e(X);var O1=o(X,2),e1=t(O1),B=t(e1),x=t(B,!0);e(B);var C=o(B,2);e(e1);var i1=o(e1,2);{var u1=Y=>{var U=j3(),W=t(U),o1=t(W),c1=t(o1),M1=t(c1),F1=t(M1,!0);e(M1);var G1=o(M1),S1=t(G1,!0);e(G1);var R1=o(G1),W1=t(R1,!0);e(R1),e(c1),e(o1);var Y1=o(o1),D1=t(Y1),X1=t(D1),Se=t(X1,!0);e(X1);var ne=o(X1),Ce=t(ne);e(ne),r2(),e(D1);var ye=o(D1);te(ye,17,()=>n.flourBlend,Fe=>Fe.type,(Fe,_e)=>{var Ee=P3(),Be=t(Ee),Ge=t(Be);e(Be);var He=o(Be),u2=t(He);e(He);var Pe=o(He),m2=t(Pe);e(Pe),e(Ee),L(p2=>{l(Ge,`— ${r(d).flourTypes[r(_e).type]??r(_e).type??""}`),l(u2,`${p2??""}g`),l(m2,`${r(_e).pct??""}%`)},[()=>g(n.formula.totalFlourG*r(_e).pct/100)]),k(Fe,Ee)});var ce=o(ye),de=t(ce),ue=t(de,!0);e(de);var ze=o(de),Ae=t(ze);e(ze);var me=o(ze),qe=t(me);e(me),e(ce);var Oe=o(ce),Ke=t(Oe),x2=t(Ke,!0);e(Ke);var Ye=o(Ke),j2=t(Ye);e(Ye);var Te=o(Ye),y2=t(Te,!0);e(Te),e(Oe);var z2=o(Oe),Ie=t(z2),s2=t(Ie,!0);e(Ie);var Ze=o(Ie),R2=t(Ze);e(Ze);var l2=o(Ze),Je=t(l2),Xe=o(Je),i2=t(Xe,!0);e(Xe),e(l2),e(z2),e(Y1);var _2=o(Y1),c2=t(_2),$e=t(c2),k2=t($e,!0);e($e);var w2=o($e),d2=t(w2);e(w2),r2(),e(c2),e(_2),e(W),e(U),L((Fe,_e,Ee,Be,Ge,He,u2,Pe)=>{l(F1,r(d).ingredient),l(S1,r(d).grams),l(W1,r(d).bakersPct),l(Se,r(d).totalFlourRow),l(Ce,`${Fe??""}g`),l(ue,r(d).water),l(Ae,`${_e??""}g`),l(qe,`${Ee??""}%`),l(x2,r(d).saltRow),l(j2,`${Be??""}g`),l(y2,Ge),l(s2,r(d).starter),l(R2,`${He??""}g`),l(Je,`${u2??""} `),l(i2,r(d).preFermentedFlour),l(k2,r(d).totalDough),l(d2,`${Pe??""}g`)},[()=>g(n.formula.totalFlourG),()=>g(n.formula.totalWaterG),()=>n.formula.finalHydrationPct.toFixed(1),()=>g(n.formula.saltG),()=>i(n.formula.saltG,n.formula.totalFlourG),()=>g(n.formula.starterTotalG),()=>i(n.formula.starterFlourG,n.formula.totalFlourG),()=>g(n.formula.totalDoughWeightG)]),k(Y,U)};v1(i1,Y=>{s()&&Y(u1)})}e(O1),e(_);var j1=o(_,2);{var t1=Y=>{var U=R3(),W=t(U),o1=o(W,2),c1=t(o1),M1=t(c1),F1=t(M1,!0);e(M1);var G1=o(M1,2);e(c1);var S1=o(c1,2),R1=t(S1),W1=t(R1),Y1=t(W1,!0);e(W1);var D1=o(W1,2),X1=t(D1,!0);e(D1),e(R1);var Se=o(R1,2),ne=t(Se),Ce=t(ne,!0);e(ne);var ye=o(ne,2),ce=t(ye,!0);e(ye),e(Se),e(S1);var de=o(S1,2),ue=t(de),ze=t(ue,!0);e(ue),e(de),e(o1),h2(o1,Ae=>q?.(Ae)),e(U),L(()=>{V(W,"aria-label",r(d).ariaLabels.closeFormulaModal),l(F1,r(d).formulaInfoTitle),V(G1,"aria-label",r(d).ariaLabels.closeFormulaModal),l(Y1,r(d).mixAdditions),l(X1,r(d).formulaInfoMixBody),l(Ce,r(d).fullFormula),l(ce,r(d).formulaInfoFormulaBody),l(ze,r(d).done)}),H("click",W,()=>$(y,!1)),H("click",G1,()=>$(y,!1)),H("click",ue,()=>$(y,!1)),k(Y,U)};v1(j1,Y=>{r(y)&&Y(t1)})}L((Y,U,W,o1,c1,M1)=>{l(O,r(d).formula),V(M,"aria-label",r(d).ariaLabels.learnFormula),l(z,r(d).bakersPctSubtitle),l(J,`${Y??""}g`),l(l1,r(d).mixAdditions),l(x1,`${U??""}g`),l(D,r(d).mixFlour),l(L1,`${W??""}g`),l(P1,r(d).mixWater),l(B1,`${o1??""}g`),l(J1,r(d).starter),l(I1,`${c1??""}g`),l(d1,r(d).saltRow),l(N1,M1),l(x,r(d).fullFormula),p1(C,0,`w-4 h-4 text-base-content/40 transition-transform ${s()?"rotate-180":""}`)},[()=>g(n.formula.totalDoughWeightG),()=>g(n.formula.mixFlourG),()=>g(n.formula.mixWaterG),()=>g(n.formula.starterTotalG),()=>g(n.formula.saltG),()=>r(d).starterContains(g(n.formula.starterFlourG),g(n.formula.starterWaterG),S(n.formula.starterFlourG,n.formula.starterWaterG))]),H("click",M,()=>$(y,!0)),H("click",e1,()=>dt.update(Y=>!Y)),k(a,P),De(),f()}n2(["click"]);var N3=E('<div class="flex justify-between items-center mb-2"><span class="text-sm font-semibold text-base-content"> </span> <span class="text-sm tabular-nums font-bold text-info"> </span></div> <div class="relative h-3"><progress class="progress progress-info w-full absolute inset-0 opacity-50" max="100"></progress> <progress class="progress progress-info w-full absolute inset-0" max="100"></progress></div>',1),O3=E('<div class="flex justify-between items-center mb-2"><span class="text-sm font-semibold text-base-content"> </span> <span class="text-sm tabular-nums font-bold text-secondary"> </span></div> <div class="relative h-3"><progress class="progress progress-secondary w-full absolute inset-0 opacity-50" value="100" max="100"></progress> <progress class="progress progress-secondary w-full absolute inset-0" max="100"></progress></div> <p class="text-xs text-base-content/70 mt-1"> </p>',1),I3=E('<div class="modal modal-open"><button type="button" class="modal-backdrop"></button> <div class="modal-box w-full max-w-md p-0 overflow-hidden" role="dialog" aria-modal="true" aria-labelledby="timing-bars-modal-title"><div class="flex items-center justify-between px-5 py-4 border-b border-base-200"><h2 id="timing-bars-modal-title" class="text-base font-semibold text-base-content"> </h2> <button type="button" class="btn btn-ghost btn-sm btn-circle"><svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12"></path></svg></button></div> <div class="px-5 py-4 space-y-4"><p class="text-sm text-base-content/70 leading-relaxed"> </p> <div><p class="text-xs font-semibold text-secondary uppercase tracking-wide mb-1"> </p> <p class="text-sm text-base-content/70 leading-relaxed"> </p></div> <div class="border-t border-base-200 pt-4"><p class="text-xs font-semibold text-secondary uppercase tracking-wide mb-1"> </p> <p class="text-sm text-base-content/70 leading-relaxed"> </p></div></div> <div class="px-5 pb-5"><button type="button" class="btn btn-primary w-full"> </button></div></div></div>'),$3=E('<div class="card bg-base-100 shadow-sm ring-1 ring-base-300/70"><div class="card-body gap-5 p-5"><div class="flex items-center gap-1.5"><h2 class="text-base font-semibold text-base-content uppercase tracking-wide"> </h2> <button type="button" class="btn btn-ghost btn-xs btn-circle flex-shrink-0"><svg xmlns="http://www.w3.org/2000/svg" class="w-[1.14rem] h-[1.14rem]" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true"><path fill-rule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7-4a1 1 0 11-2 0 1 1 0 012 0zM9 9a1 1 0 000 2v3a1 1 0 001 1h1a1 1 0 100-2v-3a1 1 0 00-1-1H9z" clip-rule="evenodd"></path></svg></button></div> <div class="flex flex-wrap gap-2"><span> </span> <span> </span> <span class="badge badge-soft badge-accent badge-md font-medium"> </span></div> <div><div class="flex justify-between items-center mb-2"><span class="text-sm font-semibold text-base-content"> </span> <span class="text-sm tabular-nums font-bold text-secondary"> </span></div> <div class="relative h-3"><progress class="progress progress-warning w-full absolute inset-0" max="100"></progress> <progress class="progress progress-secondary w-full absolute inset-0 opacity-80" max="100"></progress></div> <div class="flex justify-between text-xs text-base-content/50 mt-1"><span> </span> <span> </span></div> <p class="text-xs text-base-content/70 mt-1"> </p></div> <div><!></div> <div class="rounded-xl bg-secondary/10 ring-1 ring-secondary/20 px-4 py-3 text-sm"><span class="text-base-content/70"> </span> <span class="font-bold text-base-content ml-1"> </span></div> <p class="text-xs text-base-content/50 text-center"> </p></div></div> <!>',1);function E3(a,n){Re(n,!0);const c=()=>re(xe,"$lang",b),s=()=>re(ge,"$inputs",b),[b,f]=Le(),d=85,i=95,g=m1(()=>Ne[c()]);let S=oe(!1);const y=12;function F(U){return Math.min(100,U/y*100)}const I={Cold:"badge-info",VeryCold:"badge-info",Standard:"badge-success",Warm:"badge-warning",Hot:"badge-error"},q={Low:"badge-warning",Medium:"badge-success",High:"badge-info",VeryHigh:"badge-error"},P=m1(()=>F(n.timing.bulkMax)),_=m1(()=>F(n.timing.bulkMin)),u=m1(()=>F(n.timing.proofMax)),j=m1(()=>F(n.timing.proofMin)),G=m1(()=>F(n.timing.coldRetardMin));var R=$3(),O=se(R),M=t(O),T=t(M),z=t(T),N=t(z,!0);e(z);var J=o(z,2);e(T);var X=o(T,2),K=t(X),l1=t(K);e(K);var y1=o(K,2),n1=t(y1);e(y1);var s1=o(y1,2),x1=t(s1);e(s1),e(X);var b1=o(X,2),D=t(b1),h1=t(D),w1=t(h1,!0);e(h1);var L1=o(h1,2),A1=t(L1);e(L1),e(D);var P1=o(D,2),_1=t(P1),k1=o(_1,2);e(P1);var B1=o(P1,2),T1=t(B1),J1=t(T1,!0);e(T1);var E1=o(T1,2),K1=t(E1,!0);e(E1),e(B1);var I1=o(B1,2),$1=t(I1,!0);e(I1),e(b1);var d1=o(b1,2),g1=t(d1);{var N1=U=>{var W=N3(),o1=se(W),c1=t(o1),M1=t(c1,!0);e(c1);var F1=o(c1,2),G1=t(F1);e(F1),e(o1);var S1=o(o1,2),R1=t(S1),W1=o(R1,2);e(S1),L((Y1,D1)=>{l(M1,r(g).roomProof),l(G1,`${Y1??""} – ${D1??""}`),ae(R1,r(u)),ae(W1,r(j))},[()=>fe(n.timing.proofMin*60),()=>fe(n.timing.proofMax*60)]),k(U,W)},O1=U=>{var W=O3(),o1=se(W),c1=t(o1),M1=t(c1,!0);e(c1);var F1=o(c1,2),G1=t(F1);e(F1),e(o1);var S1=o(o1,2),R1=o(t(S1),2);e(S1);var W1=o(S1,2),Y1=t(W1,!0);e(W1),L(()=>{l(M1,r(g).coldRetardProof),l(G1,`${n.timing.coldRetardMin??""}h – ${n.timing.coldRetardMax??""}h`),ae(R1,r(G)),l(Y1,r(g).bakeColdNote)}),k(U,W)};v1(g1,U=>{n.proofMethod==="Room"?U(N1):U(O1,-1)})}e(d1);var e1=o(d1,2),B=t(e1),x=t(B,!0);e(B);var C=o(B,2),i1=t(C);e(C),e(e1);var u1=o(e1,2),j1=t(u1,!0);e(u1),e(M),e(O);var t1=o(O,2);{var Y=U=>{var W=I3(),o1=t(W),c1=o(o1,2),M1=t(c1),F1=t(M1),G1=t(F1,!0);e(F1);var S1=o(F1,2);e(M1);var R1=o(M1,2),W1=t(R1),Y1=t(W1,!0);e(W1);var D1=o(W1,2),X1=t(D1),Se=t(X1,!0);e(X1);var ne=o(X1,2),Ce=t(ne,!0);e(ne),e(D1);var ye=o(D1,2),ce=t(ye),de=t(ce,!0);e(ce);var ue=o(ce,2),ze=t(ue,!0);e(ue),e(ye),e(R1);var Ae=o(R1,2),me=t(Ae),qe=t(me,!0);e(me),e(Ae),e(c1),e(W),L(()=>{V(o1,"aria-label",r(g).ariaLabels.closeTimingBarModal),l(G1,r(g).timingBarsModalTitle),V(S1,"aria-label",r(g).ariaLabels.closeButton),l(Y1,r(g).timingBarsModalIntro),l(Se,r(g).timingBarsBulkTitle),l(Ce,r(g).timingBarsBulkBody),l(de,r(g).timingBarsColdTitle),l(ze,r(g).timingBarsColdBody),l(qe,r(g).done)}),H("click",o1,()=>$(S,!1)),H("click",S1,()=>$(S,!1)),H("click",me,()=>$(S,!1)),k(U,W)};v1(t1,U=>{r(S)&&U(Y)})}L((U,W,o1,c1,M1,F1,G1,S1)=>{l(N,r(g).timing),V(J,"aria-label",r(g).ariaLabels.learnTimingBars),p1(K,1,`badge badge-soft ${I[n.formula.tempBand]??"badge-ghost"??""} badge-md font-medium`),l(l1,`${r(g).tempBands[n.formula.tempBand]??""} (${U??""})`),p1(y1,1,`badge badge-soft ${q[n.formula.hydrationBand]??"badge-ghost"??""} badge-md font-medium`),l(n1,`${r(g).hydrationBands[n.formula.hydrationBand]??""} ${r(g).hydration??""} (${W??""}%)`),l(x1,`${o1??""}% ${r(g).inoculation??""}`),l(w1,r(g).bulkFermentation),l(A1,`${c1??""} – ${M1??""}`),ae(_1,r(P)),ae(k1,r(_)),l(J1,r(g).fastest),l(K1,r(g).slowest),l($1,F1),l(x,r(g).totalActiveTime),l(i1,`${G1??""} –
				${S1??""}`),l(j1,r(g).timingDisclaimer)},[()=>s().tempUnit==="F"?(n.formula.effectiveTempC*9/5+32).toFixed(1)+"°F":n.formula.effectiveTempC.toFixed(1)+"°C",()=>n.formula.finalHydrationPct.toFixed(1),()=>n.formula.inoculationPct.toFixed(1),()=>fe(n.timing.bulkMin*60),()=>fe(n.timing.bulkMax*60),()=>r(g).foldSchedule(n.timing.foldCount,n.timing.foldIntervalMins),()=>fe((n.timing.bulkMin+(n.proofMethod==="Room"?n.timing.proofMin:n.timing.coldRetardMin))*60+d),()=>fe((n.timing.bulkMax+(n.proofMethod==="Room"?n.timing.proofMax:n.timing.coldRetardMax))*60+i)]),H("click",J,()=>$(S,!0)),k(a,R),De(),f()}n2(["click"]);var G3=E("<div> </div>"),W3=E("<div> </div>"),U3=E("<p> </p>"),V3=E('<li class="relative flex gap-3 pb-3 cursor-pointer select-none group pl-11" role="checkbox" tabindex="0"><div class="absolute top-0 bottom-0 w-px left-4 bg-secondary/20"></div> <div><span class="-rotate-45"><!></span></div> <div><div class="flex items-start justify-between gap-2"><span> </span> <div class="text-right shrink-0"><!></div></div> <!></div></li>'),q3=E('<div class="absolute bottom-0 w-px left-4 top-8 bg-secondary/20"></div>'),K3=E("<div> </div>"),Y3=E("<div> </div> <!>",1),Z3=E("<div> </div>"),J3=E("<p> </p>"),X3=E("<button><!></button>"),Q3=E('<div class="flex flex-wrap items-center gap-2 mt-2"></div>'),en=E('<li class="relative flex gap-4 pb-5 cursor-pointer select-none group" role="checkbox" tabindex="0"><!> <div><!></div> <div><div class="flex items-start justify-between gap-2"><span> </span> <div class="text-right shrink-0"><!></div></div> <!> <!></div></li>'),tn=E('<div class="shadow-sm card bg-base-100 ring-1 ring-base-300/70"><div class="p-5 card-body"><h2 class="mb-1 text-base font-semibold tracking-wide uppercase text-base-content"> </h2> <p class="mb-3 text-xs italic text-base-content/60"> </p> <ol class="relative space-y-0"></ol></div></div>');function an(a,n){Re(n,!0);const c=()=>re(xe,"$lang",s),[s,b]=Le(),f=m1(()=>Ne[c()]);let d=oe(Pt(new Set)),i=oe(Pt(new Map)),g=oe("");C2(()=>{const M=JSON.stringify(n.steps.map(T=>T.label+"|"+T.durationMins+"|"+T.rangeMinMins));M!==r(g)&&($(g,M,!0),$(d,new Set,!0),$(i,new Map,!0))});function S(M){const T=new Set(r(d));T.has(M)?T.delete(M):T.add(M),$(d,T,!0)}function y(M,T){const z=new Map(r(i)),N=new Set(z.get(M)??[]);N.has(T)?N.delete(T):N.add(T),z.set(M,N),$(i,z,!0);const J=n.steps[M]?.setCount??0;if(J>0&&N.size===J){const X=new Set(r(d));X.add(M),$(d,X,!0)}}function F(M,T){return r(i).get(M)?.has(T)??!1}const I=m1(()=>{let M=0;if(n.scheduleMode!=="clock"||!n.startTime)return n.steps.map(z=>{const N=z.isSubStep?-1:M++;return{step:z,clockTime:null,endClockTime:null,topLevelIndex:N}});let T=0;return n.steps.map(z=>{const N=z.isSubStep?-1:M++,J=Nt(n.startTime,T),X=z.durationMins??(z.rangeMinMins!=null?z.rangeMinMins:0);T+=X;const K=Nt(n.startTime,T);return{step:z,clockTime:J,endClockTime:K,topLevelIndex:N}})});function q(M){return M.durationMins!==null&&M.durationMins!==void 0?fe(M.durationMins):M.rangeMinMins!==void 0&&M.rangeMaxMins!==void 0?`${fe(M.rangeMinMins)} – ${fe(M.rangeMaxMins)}`:""}var P=tn(),_=t(P),u=t(_),j=t(u,!0);e(u);var G=o(u,2),R=t(G,!0);e(G);var O=o(G,2);te(O,21,()=>r(I),he,(M,T,z)=>{let N=()=>r(T).step,J=()=>r(T).clockTime,X=()=>r(T).endClockTime,K=()=>r(T).topLevelIndex;var l1=ut(),y1=se(l1);{var n1=x1=>{var b1=V3(),D=o(t(b1),2),h1=t(D),w1=t(h1);{var L1=d1=>{var g1=Me("✓");k(d1,g1)},A1=m1(()=>r(d).has(z));v1(w1,d1=>{r(A1)&&d1(L1)})}e(h1),e(D);var P1=o(D,2),_1=t(P1),k1=t(_1),B1=t(k1,!0);e(k1);var T1=o(k1,2),J1=t(T1);{var E1=d1=>{var g1=G3(),N1=t(g1,!0);e(g1),L(O1=>{p1(g1,1,`text-xs tabular-nums ${O1??""}`),l(N1,J())},[()=>r(d).has(z)?"text-base-content/40 line-through":"text-secondary/70"]),k(d1,g1)},K1=d1=>{var g1=W3(),N1=t(g1,!0);e(g1),L((O1,e1)=>{p1(g1,1,`text-xs tabular-nums ${O1??""}`),l(N1,e1)},[()=>r(d).has(z)?"text-base-content/40 line-through":"text-secondary/70",()=>q(N())]),k(d1,g1)};v1(J1,d1=>{n.scheduleMode==="clock"&&J()?d1(E1):d1(K1,-1)})}e(T1),e(_1);var I1=o(_1,2);{var $1=d1=>{var g1=U3(),N1=t(g1,!0);e(g1),L(O1=>{p1(g1,1,`text-[11px] mt-0.5 leading-snug ${O1??""}`),l(N1,N().notes)},[()=>r(d).has(z)?"text-base-content/25 line-through":"text-base-content/55"]),k(d1,g1)};v1(I1,d1=>{N().notes&&d1($1)})}e(P1),e(b1),L((d1,g1,N1,O1)=>{V(b1,"aria-checked",d1),p1(D,1,`shrink-0 w-5 h-5 rounded-sm rotate-45 text-[9px] font-bold flex items-center justify-center z-10 transition-colors mt-0.5
							${g1??""}`),p1(P1,1,`flex-1 min-w-0 transition-opacity ${N1??""}`),p1(k1,1,`text-xs font-medium leading-tight transition-colors
									${O1??""}`),l(B1,N().label)},[()=>r(d).has(z),()=>r(d).has(z)?"bg-success/15 text-success":"bg-secondary/10 text-secondary/70 group-hover:bg-secondary/20",()=>r(d).has(z)?"opacity-50":"",()=>r(d).has(z)?"text-base-content/40 line-through":"text-base-content/80"]),H("click",b1,()=>S(z)),H("keydown",b1,d1=>{(d1.key==="Enter"||d1.key===" ")&&(d1.preventDefault(),S(z))}),k(x1,b1)},s1=x1=>{var b1=en(),D=t(b1);{var h1=B=>{var x=q3();k(B,x)};v1(D,B=>{z<r(I).length-1&&B(h1)})}var w1=o(D,2),L1=t(w1);{var A1=B=>{var x=Me("✓");k(B,x)},P1=m1(()=>r(d).has(z)),_1=B=>{var x=Me();L(()=>l(x,K()+1)),k(B,x)};v1(L1,B=>{r(P1)?B(A1):B(_1,-1)})}e(w1);var k1=o(w1,2),B1=t(k1),T1=t(B1),J1=t(T1,!0);e(T1);var E1=o(T1,2),K1=t(E1);{var I1=B=>{var x=Y3(),C=se(x),i1=t(C,!0);e(C);var u1=o(C,2);{var j1=t1=>{var Y=K3(),U=t(Y);e(Y),L(W=>{p1(Y,1,`text-xs text-base-content/50 tabular-nums ${W??""}`),l(U,`→ ${X()??""}`)},[()=>r(d).has(z)?"line-through":""]),k(t1,Y)};v1(u1,t1=>{X()&&X()!==J()&&t1(j1)})}L(t1=>{p1(C,1,`text-xs font-bold tabular-nums ${t1??""}`),l(i1,J())},[()=>r(d).has(z)?"text-base-content/50 line-through":"text-secondary"]),k(B,x)},$1=B=>{var x=Z3(),C=t(x,!0);e(x),L((i1,u1)=>{p1(x,1,`text-xs font-bold tabular-nums ${i1??""}`),l(C,u1)},[()=>r(d).has(z)?"text-base-content/50 line-through":"text-secondary",()=>q(N())]),k(B,x)};v1(K1,B=>{n.scheduleMode==="clock"&&J()?B(I1):B($1,-1)})}e(E1),e(B1);var d1=o(B1,2);{var g1=B=>{var x=J3(),C=t(x,!0);e(x),L(i1=>{p1(x,1,`text-xs mt-1 leading-snug ${i1??""}`),l(C,N().notes)},[()=>r(d).has(z)?"text-base-content/30 line-through":"text-base-content/70"]),k(B,x)};v1(d1,B=>{N().notes&&B(g1)})}var N1=o(d1,2);{var O1=B=>{var x=Q3();te(x,21,()=>Array.from({length:N().setCount},(C,i1)=>i1),he,(C,i1)=>{var u1=X3(),j1=t(u1);{var t1=W=>{var o1=Me("✓");k(W,o1)},Y=m1(()=>F(z,r(i1))),U=W=>{var o1=Me();L(()=>l(o1,r(i1)+1)),k(W,o1)};v1(j1,W=>{r(Y)?W(t1):W(U,-1)})}e(u1),L(W=>p1(u1,1,`w-7 h-7 rounded-full font-bold text-xs flex items-center justify-center transition-colors ${W??""}`),[()=>F(z,r(i1))?"bg-success/15 text-success":"bg-secondary/15 text-secondary hover:bg-secondary/25"]),H("click",u1,W=>{W.stopPropagation(),y(z,r(i1))}),k(C,u1)}),e(x),k(B,x)},e1=m1(()=>N().setCount&&!r(d).has(z));v1(N1,B=>{r(e1)&&B(O1)})}e(k1),e(b1),L((B,x,C,i1)=>{V(b1,"aria-checked",B),p1(w1,1,`shrink-0 w-8 h-8 rounded-full font-bold text-xs flex items-center justify-center z-10 transition-colors
							${x??""}`),p1(k1,1,`flex-1 min-w-0 transition-opacity ${C??""}`),p1(T1,1,`text-sm font-semibold leading-tight transition-colors
									${i1??""}`),l(J1,N().label)},[()=>r(d).has(z),()=>r(d).has(z)?"bg-success/15 text-success":"bg-secondary/15 text-secondary group-hover:bg-secondary/25",()=>r(d).has(z)?"opacity-50":"",()=>r(d).has(z)?"text-base-content/50 line-through":"text-base-content"]),H("click",b1,()=>S(z)),H("keydown",b1,B=>{(B.key==="Enter"||B.key===" ")&&(B.preventDefault(),S(z))}),k(x1,b1)};v1(y1,x1=>{N().isSubStep?x1(n1):x1(s1,-1)})}k(M,l1)}),e(O),e(_),e(P),L(()=>{l(j,r(f).schedule),l(R,r(f).scheduleComplete)}),k(a,P),De(),b()}n2(["click","keydown"]);var rn=E('<div class="card bg-base-100 shadow-sm ring-1 ring-base-300/70"><div class="card-body p-5"><h2 class="text-base font-semibold text-base-content uppercase tracking-wide mb-3"> </h2> <div class="text-sm text-base-content space-y-2"><p><span class="font-semibold text-secondary"> </span> </p> <p><span class="font-semibold text-warning"> </span> </p> <p><span class="font-semibold text-error"> </span> </p></div> <div class="mt-4 pt-4 border-t border-base-200 text-xs text-base-content/70 space-y-1"><p><strong> </strong> </p> <p><strong> </strong> </p> <p><strong> </strong> </p></div></div></div>');function nn(a,n){Re(n,!0);const c=()=>re(xe,"$lang",s),[s,b]=Le(),f=m1(()=>Ne[c()]),d=m1(()=>r(f).guidance[n.crumbGoal]),i=m1(()=>r(f).crumbGoalNames[n.crumbGoal]);var g=rn(),S=t(g),y=t(S),F=t(y,!0);e(y);var I=o(y,2),q=t(I),P=t(q),_=t(P,!0);e(P);var u=o(P);e(q);var j=o(q,2),G=t(j),R=t(G,!0);e(G);var O=o(G);e(j);var M=o(j,2),T=t(M),z=t(T,!0);e(T);var N=o(T);e(M),e(I);var J=o(I,2),X=t(J),K=t(X),l1=t(K,!0);e(K);var y1=o(K);e(X);var n1=o(X,2),s1=t(n1),x1=t(s1,!0);e(s1);var b1=o(s1);e(n1);var D=o(n1,2),h1=t(D),w1=t(h1,!0);e(h1);var L1=o(h1);e(D),e(J),e(S),e(g),L(A1=>{l(F,r(f).readingYourCrumb),l(_,A1),l(u,` ${r(d).description??""}`),l(R,r(f).underFermented),l(O,` ${r(d).underFermented??""}`),l(z,r(f).overFermented),l(N,` ${r(d).overFermented??""}`),l(l1,r(f).floatTest),l(y1,` ${r(f).floatTestDesc??""}`),l(x1,r(f).pokeTest),l(b1,` ${r(f).pokeTestDesc??""}`),l(w1,r(f).jiggleTest),l(L1,` ${r(f).jiggleTestDesc??""}`)},[()=>r(f).target(r(i))]),k(a,g),De(),b()}var on=E('<div class="flex justify-between items-center py-2 border-b border-base-200"><dt class="text-sm text-base-content/70"> </dt> <dd class="text-sm font-semibold text-base-content tabular-nums"> </dd></div>'),sn=E('<button type="button" class="fixed inset-0 z-40 bg-neutral/40 backdrop-blur-sm"></button> <div class="fixed bottom-0 left-0 right-0 z-50 max-h-[70vh] overflow-y-auto rounded-t-2xl bg-base-100 shadow-xl ring-1 ring-base-300/80" role="dialog" aria-modal="true"><div class="sticky top-0 flex items-center justify-between px-5 py-4 bg-base-100/95 backdrop-blur border-b border-base-200"><h2 class="text-base font-semibold text-base-content"> </h2> <button type="button" class="btn btn-ghost btn-sm btn-circle"><svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12"></path></svg></button></div> <div class="px-5 py-4"><p class="text-sm text-base-content/70 mb-4"> </p> <dl class="space-y-2"></dl></div> <div class="px-5 pb-6"><button type="button" class="btn btn-primary w-full"> </button></div></div>',1);function ln(a,n){Re(n,!0);const c=()=>re(xe,"$lang",b),s=()=>re(ct,"$assumptionsOpen",b),[b,f]=Le(),d=m1(()=>Ne[c()]);function i(){ct.set(!1)}var g=ut(),S=se(g);{var y=F=>{var I=sn(),q=se(I),P=o(q,2),_=t(P),u=t(_),j=t(u,!0);e(u);var G=o(u,2);e(_);var R=o(_,2),O=t(R),M=t(O,!0);e(O);var T=o(O,2);te(T,21,()=>Object.entries(n.assumptions),he,(X,K)=>{var l1=m1(()=>lr(r(K),2));let y1=()=>r(l1)[0],n1=()=>r(l1)[1];var s1=on(),x1=t(s1),b1=t(x1,!0);e(x1);var D=o(x1,2),h1=t(D,!0);e(D),e(s1),L(()=>{l(b1,y1()),l(h1,n1())}),k(X,s1)}),e(T),e(R);var z=o(R,2),N=t(z),J=t(N,!0);e(N),e(z),e(P),L(()=>{V(q,"aria-label",r(d).ariaLabels.closeAssumptionsDrawer),V(P,"aria-label",r(d).calculationAssumptions),l(j,r(d).calculationAssumptions),V(G,"aria-label",r(d).ariaLabels.closeButton),l(M,r(d).assumptionsDesc),l(J,r(d).done)}),H("click",q,i),H("click",G,i),H("click",N,i),k(F,I)};v1(S,F=>{s()&&F(y)})}k(a,g),De(),f()}n2(["click"]);var cn=E('<div class="install-cta-row border-b border-neutral-content/15 bg-neutral/70 svelte-1uha8ag"><div class="max-w-2xl mx-auto px-4 py-2 flex justify-end"><button type="button"> </button></div></div>'),dn=E('<!> <!> <!> <!> <div class="flex justify-center mt-4"><a href="https://www.reddit.com/r/Sourdough/s/AeZMGcjrV1" target="_blank" rel="noopener noreferrer" class="btn btn-sm btn-ghost gap-2 text-base-content/60 hover:text-[#FF4500]"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="currentColor"><path d="M14.238 15.348c.085.084.085.221 0 .306-.465.462-1.194.687-2.231.687l-.008-.002-.008.002c-1.036 0-1.766-.225-2.231-.688-.085-.084-.085-.221 0-.305.084-.084.222-.084.307 0 .379.377 1.008.561 1.924.561l.008.002.008-.002c.915 0 1.544-.184 1.924-.561.085-.084.223-.084.307 0zm-3.44-2.418c0-.507-.414-.919-.922-.919-.509 0-.922.412-.922.919 0 .506.414.918.922.918.508 0 .922-.412.922-.918zm4.04-.919c-.509 0-.922.412-.922.919 0 .506.414.918.922.918.508 0 .922-.412.922-.918 0-.507-.414-.919-.922-.919zM12 0C5.373 0 0 5.373 0 12s5.373 12 12 12 12-5.373 12-12S18.627 0 12 0zm5.492 13.612c.018.162.028.326.028.492 0 2.51-2.924 4.546-6.528 4.546-3.606 0-6.53-2.036-6.53-4.546 0-.166.012-.33.028-.492a1.252 1.252 0 0 1-.464-.993c0-.694.565-1.257 1.262-1.257.334 0 .637.134.857.353 1.063-.731 2.528-1.202 4.147-1.26l.786-3.693.003-.013a.282.282 0 0 1 .34-.208l2.614.591c.163-.36.534-.614.965-.614.585 0 1.06.474 1.06 1.057 0 .584-.475 1.058-1.06 1.058-.583 0-1.054-.472-1.058-1.052l-2.35-.531-.693 3.263c1.594.07 3.034.543 4.08 1.265.219-.218.521-.351.853-.351.698 0 1.262.563 1.262 1.257 0 .427-.214.805-.547.998z"></path></svg> </a></div>',1),un=E('<div class="card bg-base-100/95 shadow-sm ring-1 ring-base-300/70"><div class="card-body items-center text-center"><div class="text-4xl mb-3" aria-hidden="true">⚖️</div> <p class="text-base-content/70 font-medium"> </p> <p class="text-base-content/50 text-sm mt-1"> </p></div></div>'),mn=E('<dialog class="modal modal-open" aria-modal="true" aria-labelledby="install-help-title"><div class="modal-box max-w-lg"><h3 id="install-help-title" class="text-lg font-semibold"> </h3> <p class="mt-2 text-sm text-base-content/80"> </p> <ul class="mt-3 list-disc space-y-2 pl-5 text-sm leading-relaxed text-base-content/90"><li> </li> <li> </li> <li> </li></ul> <div class="modal-action"><button type="button" class="btn btn-primary btn-sm rounded-full"> </button></div></div> <form method="dialog" class="modal-backdrop"><button type="button"> </button></form></dialog>'),pn=E('<div class="min-h-screen bg-gradient-to-b from-base-200 via-base-200 to-base-300/40"><header class="bg-neutral/95 text-neutral-content border-b border-primary/25 shadow-sm backdrop-blur supports-[backdrop-filter]:bg-neutral/90 sticky top-0 z-30"><!> <div class="max-w-2xl mx-auto px-4 py-4 flex flex-wrap items-center justify-between gap-y-3"><div class="flex items-center gap-3 min-w-0"><span class="flex h-9 w-9 shrink-0 items-center justify-center rounded-xl bg-primary/20 text-xl text-primary ring-1 ring-primary/35" aria-hidden="true">🍞</span> <div><h1 class="text-base font-bold text-neutral-content leading-tight">DoughCulator</h1> <p class="text-xs text-neutral-content/70 leading-tight"> </p></div></div> <div class="flex items-center flex-wrap justify-end gap-2"><label class="swap swap-rotate inline-grid h-9 w-9 place-items-center rounded-full border border-transparent bg-transparent text-neutral-content/75 transition-colors duration-200 hover:border-neutral-content/35 hover:bg-neutral-content/10 hover:text-neutral-content focus-within:border-primary/45 focus-within:ring-2 focus-within:ring-primary/55 focus-within:ring-offset-2 focus-within:ring-offset-neutral/95"><input type="checkbox" class="sr-only appearance-none"/> <svg class="swap-on h-5 w-5 fill-current" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M5.64,17l-.71.71a1,1,0,0,0,0,1.41,1,1,0,0,0,1.41,0l.71-.71A1,1,0,0,0,5.64,17ZM5,12a1,1,0,0,0-1-1H3a1,1,0,0,0,0,2H4A1,1,0,0,0,5,12Zm7-7a1,1,0,0,0,1-1V3a1,1,0,0,0-2,0V4A1,1,0,0,0,12,5ZM5.64,7.05a1,1,0,0,0,.7.29,1,1,0,0,0,.71-.29,1,1,0,0,0,0-1.41l-.71-.71A1,1,0,0,0,4.93,6.34Zm12,.29a1,1,0,0,0,.7-.29l.71-.71a1,1,0,1,0-1.41-1.41L17,5.64a1,1,0,0,0,0,1.41A1,1,0,0,0,17.66,7.34ZM21,11H20a1,1,0,0,0,0,2h1a1,1,0,0,0,0-2Zm-9,8a1,1,0,0,0-1,1v1a1,1,0,0,0,2,0V20A1,1,0,0,0,12,19ZM18.36,17A1,1,0,0,0,17,18.36l.71.71a1,1,0,0,0,1.41,0,1,1,0,0,0,0-1.41ZM12,6.5A5.5,5.5,0,1,0,17.5,12,5.51,5.51,0,0,0,12,6.5Zm0,9A3.5,3.5,0,1,1,15.5,12,3.5,3.5,0,0,1,12,15.5Z"></path></svg> <svg class="swap-off h-5 w-5 fill-current" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M21.64,13a1,1,0,0,0-1.05-.14,8.05,8.05,0,0,1-3.37.73A8.15,8.15,0,0,1,9.08,5.49a8.59,8.59,0,0,1,.25-2A1,1,0,0,0,8,2.36,10.14,10.14,0,1,0,22,14.05,1,1,0,0,0,21.64,13Zm-9.5,6.69A8.14,8.14,0,0,1,7.08,5.22v.27A10.15,10.15,0,0,0,17.22,15.63a9.79,9.79,0,0,0,2.1-.22A8.11,8.11,0,0,1,12.14,19.73Z"></path></svg></label> <div class="join border border-neutral-content/25 rounded-full bg-neutral-content/5 p-0.5"><button type="button">EN</button> <button type="button">ES</button> <button type="button">SV</button></div> <button type="button" class="btn btn-outline btn-sm rounded-full border-neutral-content/25 text-neutral-content/80 hover:border-neutral-content/40 hover:bg-neutral-content/10 hover:text-neutral-content"> </button> <button type="button"> </button></div></div></header> <main class="max-w-2xl mx-auto px-4 py-6 space-y-4"><!> <!></main> <footer class="max-w-2xl mx-auto px-4 py-8 text-center text-xs text-base-content/60"><p> </p> <p class="mt-1"> </p> <div class="mt-6 flex justify-center"><a href="https://www.buymeacoffee.com/alestryperez" target="_blank" rel="noopener noreferrer"><img src="https://cdn.buymeacoffee.com/buttons/v2/default-yellow.png" alt="Buy Me A Coffee" style="height: 60px !important; width: 217px !important;" loading="lazy"/></a></div></footer> <!></div> <!>',1);function xn(a,n){Re(n,!0);const c=()=>re(xe,"$lang",f),s=()=>re(Yt,"$result",f),b=()=>re(ge,"$inputs",f),[f,d]=Le(),i=m1(()=>Ne[c()]);let g=oe(!1),S=oe(null),y=oe(!1),F=oe("idle");function I(){const x=s().formula,C=s().schedule,i1=s().assumptions,u1=C.map((t1,Y)=>{let U="";return t1.durationMins!==null&&t1.durationMins!==void 0?U=fe(t1.durationMins):t1.rangeMinMins!==void 0&&t1.rangeMaxMins!==void 0&&(U=`${fe(t1.rangeMinMins)} – ${fe(t1.rangeMaxMins)}`),`${Y+1}. ${t1.label}${U?" ("+U+")":""}${t1.notes?" — "+t1.notes:""}`}),j1=Object.entries(i1).map(([t1,Y])=>`${t1}: ${Y}`);return[r(i).copyTitle,r(i).copyDivider,`${r(i).totalFlourRow}: ${Math.round(x.totalFlourG)}g (${b().flourBlend.map(t1=>`${r(i).flourTypes[t1.type]??t1.type}: ${Math.round(x.totalFlourG*t1.pct/100)}g`).join(", ")})`,`${r(i).water}: ${Math.round(x.totalWaterG)}g (${x.finalHydrationPct.toFixed(1)}%)`,`${r(i).saltRow}: ${Math.round(x.saltG)}g`,`${r(i).starter}: ${Math.round(x.starterTotalG)}g`,"",r(i).copyScheduleHeader,r(i).copyScheduleDivider,...u1,"",r(i).copyAssumptionsHeader,r(i).copyAssumptionsDivider,...j1,"",r(i).copyFooter].join(`
`)}async function q(){const x=I();try{if(!navigator.clipboard?.writeText)throw new Error("Clipboard API unavailable");await navigator.clipboard.writeText(x),$(g,!0),setTimeout(()=>$(g,!1),2500)}catch{const C=document.createElement("textarea");C.value=x,C.setAttribute("readonly",""),C.style.position="fixed",C.style.opacity="0",C.style.pointerEvents="none",document.body.appendChild(C),C.focus(),C.select();try{document.execCommand("copy")&&($(g,!0),setTimeout(()=>$(g,!1),2500))}finally{document.body.removeChild(C)}}}function P(){ct.set(!0)}function _(x){xe.set(x)}function u(){if(typeof window>"u")return!1;const x=navigator;return window.matchMedia("(display-mode: standalone)").matches||x.standalone===!0}async function j(){if(u()){$(F,"installed");return}if(!r(S)){$(y,!0);return}await r(S).prompt();const{outcome:x}=await r(S).userChoice;$(F,x,!0),$(S,null),$(y,!1)}function G(){$(y,!1)}const R=m1(()=>b().totalFlourInputG);let O=oe(!1);C2(()=>{if(u()){$(F,"installed"),$(S,null);return}const x=i1=>{const u1=i1;u1.preventDefault(),$(S,u1,!0),$(F,"idle")},C=()=>{$(F,"installed"),$(S,null),$(y,!1)};return window.addEventListener("beforeinstallprompt",x),window.addEventListener("appinstalled",C),()=>{window.removeEventListener("beforeinstallprompt",x),window.removeEventListener("appinstalled",C)}}),C2(()=>{$(O,localStorage.getItem("theme")==="dark")}),C2(()=>{const x=r(O)?"dark":"bumblebee";document.documentElement.setAttribute("data-theme",x),localStorage.setItem("theme",x)});var M=pn();dr("1uha8ag",x=>{Gt(()=>{ir.title="DoughCulator"})});var T=se(M),z=t(T),N=t(z);{var J=x=>{var C=cn(),i1=t(C),u1=t(i1),j1=t(u1,!0);e(u1),e(i1),e(C),L(()=>{p1(u1,1,`btn btn-xs sm:btn-sm rounded-full shadow-sm ${r(S)?"btn-primary":"btn-outline border-neutral-content/30 text-neutral-content hover:border-neutral-content/45 hover:bg-neutral-content/10 hover:text-neutral-content"}`),l(j1,r(i).saveToHomeScreen)}),H("click",u1,j),k(x,C)};v1(N,x=>{r(F)!=="installed"&&x(J)})}var X=o(N,2),K=t(X),l1=o(t(K),2),y1=o(t(l1),2),n1=t(y1,!0);e(y1),e(l1),e(K);var s1=o(K,2),x1=t(s1),b1=t(x1);le(b1),r2(4),e(x1);var D=o(x1,2),h1=t(D),w1=o(h1,2),L1=o(w1,2);e(D);var A1=o(D,2),P1=t(A1,!0);e(A1);var _1=o(A1,2),k1=t(_1,!0);e(_1),e(s1),e(X),e(z);var B1=o(z,2),T1=t(B1);H3(T1,{});var J1=o(T1,2);{var E1=x=>{var C=dn(),i1=se(C);L3(i1,{get formula(){return s().formula},get flourBlend(){return b().flourBlend}});var u1=o(i1,2);E3(u1,{get timing(){return s().timing},get formula(){return s().formula},get proofMethod(){return b().proofMethod}});var j1=o(u1,2);{let o1=m1(()=>b().scheduleMode==="clock"?b().startTime??"08:00":null);an(j1,{get steps(){return s().schedule},get scheduleMode(){return b().scheduleMode},get startTime(){return r(o1)}})}var t1=o(j1,2);nn(t1,{get crumbGoal(){return b().crumbGoal}});var Y=o(t1,2),U=t(Y),W=o(t(U));e(U),e(Y),L(()=>l(W,` ${r(i).redditBadge??""}`)),k(x,C)},K1=x=>{var C=un(),i1=t(C),u1=o(t(i1),2),j1=t(u1,!0);e(u1);var t1=o(u1,2),Y=t(t1,!0);e(t1),e(i1),e(C),L(()=>{l(j1,r(i).emptyStateTitle),l(Y,r(i).emptyStateSubtitle)}),k(x,C)};v1(J1,x=>{r(R)>0?x(E1):x(K1,-1)})}e(B1);var I1=o(B1,2),$1=t(I1),d1=t($1,!0);e($1);var g1=o($1,2),N1=t(g1,!0);e(g1),r2(2),e(I1);var O1=o(I1,2);{var e1=x=>{var C=mn(),i1=t(C),u1=t(i1),j1=t(u1,!0);e(u1);var t1=o(u1,2),Y=t(t1,!0);e(t1);var U=o(t1,2),W=t(U),o1=t(W,!0);e(W);var c1=o(W,2),M1=t(c1,!0);e(c1);var F1=o(c1,2),G1=t(F1,!0);e(F1),e(U);var S1=o(U,2),R1=t(S1),W1=t(R1,!0);e(R1),e(S1),e(i1);var Y1=o(i1,2),D1=t(Y1),X1=t(D1,!0);e(D1),e(Y1),e(C),L(()=>{l(j1,r(i).installHelpTitle),l(Y,r(i).installHelpIntro),l(o1,r(i).installHelpIOS),l(M1,r(i).installHelpAndroid),l(G1,r(i).installHelpDesktop),l(W1,r(i).close),V(D1,"aria-label",r(i).close),l(X1,r(i).close)}),H("click",R1,G),H("click",D1,G),k(x,C)};v1(O1,x=>{r(y)&&x(e1)})}e(T);var B=o(T,2);ln(B,{get assumptions(){return s().assumptions}}),L(()=>{l(n1,r(i).appSubtitle),V(x1,"aria-label",r(i).ariaLabels.toggleDarkMode),V(D,"aria-label",r(i).ariaLabels.selectLanguage),p1(h1,1,`btn btn-xs join-item rounded-l-full border-0 ${c()==="en"?"btn-primary":"btn-ghost text-neutral-content/70 hover:text-neutral-content hover:bg-neutral-content/10"}`),p1(w1,1,`btn btn-xs join-item border-0 ${c()==="es"?"btn-primary":"btn-ghost text-neutral-content/70 hover:text-neutral-content hover:bg-neutral-content/10"}`),p1(L1,1,`btn btn-xs join-item rounded-r-full border-0 ${c()==="sv"?"btn-primary":"btn-ghost text-neutral-content/70 hover:text-neutral-content hover:bg-neutral-content/10"}`),l(P1,r(i).assumptions),_1.disabled=r(R)<=0,p1(_1,1,`btn btn-sm rounded-full shadow-sm ${r(g)?"btn-success":r(R)>0?"btn-primary":"btn-disabled"}`),l(k1,r(g)?r(i).copied:r(i).copyRecipe),l(d1,r(i).footerLine1),l(N1,r(i).footerLine2)}),_r(b1,()=>r(O),x=>$(O,x)),H("click",h1,()=>_("en")),H("click",w1,()=>_("es")),H("click",L1,()=>_("sv")),H("click",A1,P),H("click",_1,q),k(a,M),De(),d()}n2(["click"]);export{xn as component};
