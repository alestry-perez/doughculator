...
m74 -27 c18 -7 22 -34 5 -34 -17 0 -49 20 -49 30 0 11 21 13 44 4z"></path></g></g></svg>`);function l3(a,n){let c=p2(n,"class",3,"");var s=s3();L(()=>p1(s,0,Ve(c()))),k(a,s)}var i3=Pt('<circle cx="100" cy="100" fill="none" stroke-width="18" stroke-linecap="butt" transform="rotate(-90 100 100)" class="transition-all duration-300"></circle>'),c3=$('<span class="flex items-center gap-1 text-xs text-base-content/50 tabular-nums"><span class="inline-block w-2 h-2 rounded-full flex-shrink-0"></span> </span>'),d3=$('<div class="flex flex-wrap justify-center gap-x-3 gap-y-0.5 mt-1"></div>'),u3=$('<button type="button"> </button>'),m3=$('<div class="flex items-center gap-2"><span class="inline-block w-3 h-3 rounded-full flex-shrink-0"></span> <span class="text-xs text-base-content/70 flex-1 min-w-0 truncate"> </span> <div class="flex items-center gap-2 flex-1"><input type="range" min="0" max="100" step="1" class="range range-sm range-secondary flex-1"/> <input type="number" min="0" max="100" step="1" class="input input-xs w-14 text-right tabular-nums"/> <span class="text-xs text-base-content/70">%</span></div></div>'),p3=$('<button type="button" class="btn btn-xs btn-ghost text-secondary border border-secondary/30"> </button>'),v3=$('<div class="mt-3 space-y-2"></div> <div class="flex items-center justify-between mt-2"><span class="text-xs text-base-content/50"> <span> </span></span> <!></div>',1),b3=$('<div class="px-5 pb-3"><!></div>'),g3=$('<button type="button"><!> <span class="text-xs font-bold"> </span></button>'),f3=$('<button type="button"> </button>'),h3=$('<button type="button"> </button>'),M3=$('<div class="form-control mt-3 pl-4 border-l-2 border-secondary/20"><label for="fridge-temp" class="label"><span class="label-text text-xs font-semibold text-base-content/70 uppercase tracking-wide"> </span></label> <input id="fridge-temp" type="number" step="0.5" class="input border-0 border-b-2 border-base-300 rounded-none focus:border-secondary focus:outline-none bg-transparent w-full"/></div>'),x3=$('<button type="button"> </button>'),y3=$('<div class="form-control mt-3 pl-4 border-l-2 border-secondary/20"><label for="start-time" class="label"><span class="label-text text-xs font-semibold text-base-content/70 uppercase tracking-wide"> </span></label> <input id="start-time" type="time" class="input border-0 border-b-2 border-base-300 rounded-none focus:border-secondary focus:outline-none bg-transparent w-full"/></div>'),z3=$('<div class="form-control"><input id="salt-pct" type="number" min="1" max="3" step="0.1" class="input border-0 border-b-2 border-base-300 rounded-none focus:border-secondary focus:outline-none bg-transparent w-full" placeholder="2.0"/></div> <p class="text-xs text-base-content/50 mt-1"> </p>',1),_3=$('<div class="form-control"><input id="starter-hyd" type="number" min="50" max="200" step="5" class="input border-0 border-b-2 border-base-300 rounded-none focus:border-secondary focus:outline-none bg-transparent w-full"/></div>'),k3=$('<div><div class="flex justify-between text-xs text-base-content/70 mb-1"><span> </span> <span class="font-semibold text-base-content"> </span></div> <progress class="progress progress-secondary progress-sm w-full"></progress> <div class="flex justify-between text-xs text-base-content/50 mt-0.5"><span></span> <span></span></div></div>'),w3=$('<div class="modal modal-open"><button type="button" class="modal-backdrop"></button> <div class="modal-box w-full max-w-sm p-0 overflow-hidden" role="dialog" aria-modal="true" aria-labelledby="philosophy-modal-title"><div class="flex items-center justify-between px-5 py-4 border-b border-base-200"><h2 id="philosophy-modal-title" class="text-base font-semibold text-base-content"> </h2> <button type="button" class="btn btn-ghost btn-sm btn-circle"><svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12"></path></svg></button></div> <div class="px-5 py-4 space-y-4"><div><p class="text-xs font-semibold text-secondary uppercase tracking-wide mb-1"> </p> <p class="text-sm text-base-content/70 leading-relaxed"> </p></div> <div class="border-t border-base-200 pt-4"><p class="text-xs font-semibold text-secondary uppercase tracking-wide mb-1"> </p> <p class="text-sm text-base-content/70 leading-relaxed"> </p></div></div> <div class="px-5 pb-5"><button type="button" class="btn btn-primary w-full"> </button></div></div></div>'),T3=$("<li> </li>"),F3=$("<li> </li>"),S3=$('<div class="modal modal-open"><button type="button" class="modal-backdrop"></button> <div class="modal-box w-full max-w-md p-0 overflow-hidden" role="dialog" aria-modal="true" aria-labelledby="autolyse-modal-title"><div class="flex items-center justify-between px-5 py-4 border-b border-base-200"><h2 id="autolyse-modal-title" class="text-base font-semibold text-base-content"> </h2> <button type="button" class="btn btn-ghost btn-sm btn-circle"><svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12"></path></svg></button></div> <div class="px-5 py-4 space-y-4"><p class="text-sm text-base-content/70 leading-relaxed"> </p> <div><p class="text-xs font-semibold text-success uppercase tracking-wide mb-1"> </p> <ul class="list-disc pl-5 space-y-1 text-sm text-base-content/70 leading-relaxed"></ul></div> <div class="border-t border-base-200 pt-4"><p class="text-xs font-semibold text-warning uppercase tracking-wide mb-1"> </p> <ul class="list-disc pl-5 space-y-1 text-sm text-base-content/70 leading-relaxed"></ul></div></div> <div class="px-5 pb-5"><button type="button" class="btn btn-primary w-full"> </button></div></div></div>'),C3=$('<div class="modal modal-open"><button type="button" class="modal-backdrop"></button> <div class="modal-box w-full max-w-sm p-0 overflow-hidden" role="dialog" aria-modal="true" aria-labelledby="proof-method-modal-title"><div class="flex items-center justify-between px-5 py-4 border-b border-base-200"><h2 id="proof-method-modal-title" class="text-base font-semibold text-base-content"> </h2> <button type="button" class="btn btn-ghost btn-sm btn-circle"><svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12"></path></svg></button></div> <div class="px-5 py-4 space-y-4"><div><p class="text-xs font-semibold text-secondary uppercase tracking-wide mb-1"> </p> <p class="text-sm text-base-content/70 leading-relaxed"> </p></div> <div class="border-t border-base-200 pt-4"><p class="text-xs font-semibold text-secondary uppercase tracking-wide mb-1"> </p> <p class="text-sm text-base-content/70 leading-relaxed"> </p></div></div> <div class="px-5 pb-5"><button type="button" class="btn btn-primary w-full"> </button></div></div></div>'),A3=$('<div class="modal modal-open"><button type="button" class="modal-backdrop"></button> <div class="modal-box w-full max-w-sm p-0 overflow-hidden" role="dialog" aria-modal="true" aria-labelledby="crumb-goal-modal-title"><div class="flex items-center justify-between px-5 py-4 border-b border-base-200"><h2 id="crumb-goal-modal-title" class="text-base font-semibold text-base-content"> </h2> <button type="button" class="btn btn-ghost btn-sm btn-circle"><svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12"></path></svg></button></div> <div class="px-5 py-4 space-y-4"><div><p class="text-xs font-semibold text-secondary uppercase tracking-wide mb-1"> </p> <p class="text-sm text-base-content/70 leading-relaxed"> </p></div> <div class="border-t border-base-200 pt-4"><p class="text-xs font-semibold text-secondary uppercase tracking-wide mb-1"> </p> <p class="text-sm text-base-content/70 leading-relaxed"> </p></div> <div class="border-t border-base-200 pt-4"><p class="text-xs font-semibold text-secondary uppercase tracking-wide mb-1"> </p> <p class="text-sm text-base-content/70 leading-relaxed"> </p></div></div> <div class="px-5 pb-5"><button type="button" class="btn btn-primary w-full"> </button></div></div></div>'),B3=$('<div class="card bg-base-100 shadow-sm ring-1 ring-base-300/70 overflow-hidden"><div class="px-5 pt-5 pb-3"><h2 class="text-base font-semibold text-base-content uppercase tracking-wide"> </h2></div> <div class="px-5 pb-5 space-y-5"><div class="flex flex-col items-center"><div class="relative w-44 h-44"><svg viewBox="0 0 200 200" class="w-full h-full"><circle cx="100" cy="100" fill="none" class="stroke-base-300/30" stroke-width="18"></circle><!></svg> <div class="absolute inset-0 flex flex-col items-center justify-center pointer-events-none"><div class="flex items-baseline pointer-events-auto"><input id="total-flour" type="number" min="0" step="50" class="w-28 bg-transparent border-none text-center text-3xl font-bold text-base-content focus:outline-none tabular-nums [appearance:textfield] [&amp;::-webkit-outer-spin-button]:appearance-none [&amp;::-webkit-inner-spin-button]:appearance-none" placeholder="500"/> <span class="text-lg font-bold text-base-content/70 -ml-1">g</span></div> <span class="text-xs text-base-content/50"> </span></div></div> <!></div> <div><span class="text-xs font-semibold text-base-content/70 uppercase tracking-wide"> </span> <div class="grid grid-cols-3 gap-2 mt-2"></div> <!></div> <div><div class="flex items-center justify-between mb-2"><span class="text-xs font-semibold text-base-content/70 uppercase tracking-wide"> </span> <button type="button" class="btn btn-ghost btn-xs rounded-full border border-base-300 bg-base-100"><span>°C</span> <span class="text-base-content/30">/</span> <span>°F</span></button></div> <div class="grid grid-cols-2 gap-3"><div class="form-control"><label for="ambient-temp" class="label py-1"><span class="label-text text-xs text-base-content/70"> </span></label> <input id="ambient-temp" type="number" step="0.5" class="input border-0 border-b-2 border-base-300 rounded-none focus:border-secondary focus:outline-none bg-transparent w-full"/></div> <div class="form-control"><label for="dough-temp" class="label py-1"><span class="label-text text-xs text-base-content/70"> <span class="text-base-content/40"> </span></span></label> <input id="dough-temp" type="number" step="0.5" class="input border-0 border-b-2 border-base-300 rounded-none focus:border-secondary focus:outline-none bg-transparent w-full placeholder:text-base-content/30"/></div></div></div></div> <!> <div class="border-t border-base-200"><div class="px-5 py-3"><span class="text-xs font-semibold text-base-content/70 uppercase tracking-wide"> </span></div> <div class="px-5 pb-5 space-y-5"><div><div class="flex items-center gap-1.5 mb-2"><p class="text-xs font-semibold text-base-content/70 uppercase tracking-wide"> </p> <button type="button" class="btn btn-ghost btn-xs btn-circle flex-shrink-0"><svg xmlns="http://www.w3.org/2000/svg" class="w-[1.14rem] h-[1.14rem]" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true"><path fill-rule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7-4a1 1 0 11-2 0 1 1 0 012 0zM9 9a1 1 0 000 2v3a1 1 0 001 1h1a1 1 0 100-2v-3a1 1 0 00-1-1H9z" clip-rule="evenodd"></path></svg></button></div> <div class="grid grid-cols-3 gap-2"></div> <p class="text-xs text-base-content/70 mt-2 leading-snug"> </p></div> <div><div class="flex items-center gap-1.5 mb-2"><p class="text-xs font-semibold text-base-content/70 uppercase tracking-wide"> </p> <button type="button" class="btn btn-ghost btn-xs btn-circle flex-shrink-0"><svg xmlns="http://www.w3.org/2000/svg" class="w-[1.14rem] h-[1.14rem]" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true"><path fill-rule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7-4a1 1 0 11-2 0 1 1 0 012 0zM9 9a1 1 0 000 2v3a1 1 0 001 1h1a1 1 0 100-2v-3a1 1 0 00-1-1H9z" clip-rule="evenodd"></path></svg></button></div> <div class="grid grid-cols-2 gap-2"></div> <p class="text-xs text-base-content/70 mt-2 leading-snug"> </p></div> <div><div class="flex items-center gap-1.5 mb-2"><p class="text-xs font-semibold text-base-content/70 uppercase tracking-wide"> </p> <button type="button" class="btn btn-ghost btn-xs btn-circle flex-shrink-0"><svg xmlns="http://www.w3.org/2000/svg" class="w-[1.14rem] h-[1.14rem]" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true"><path fill-rule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7-4a1 1 0 11-2 0 1 1 0 012 0zM9 9a1 1 0 000 2v3a1 1 0 001 1h1a1 1 0 100-2v-3a1 1 0 00-1-1H9z" clip-rule="evenodd"></path></svg></button></div> <div class="grid grid-cols-2 gap-2"></div> <!></div> <div><p class="text-xs font-semibold text-base-content/70 uppercase tracking-wide mb-2"> </p> <div class="grid grid-cols-2 gap-2"></div> <!></div></div></div> <div class="border-t border-base-200"><div class="px-5 py-3"><span class="text-xs font-semibold text-base-content/70 uppercase tracking-wide"> </span></div> <div class="px-5 pb-5 space-y-4"><div><div class="flex items-center justify-between mb-1.5"><span class="text-xs font-semibold text-base-content/70 uppercase tracking-wide"> </span> <div class="flex items-center gap-2"><span class="text-xs text-base-content/50"><!></span> <input type="checkbox" class="toggle toggle-secondary toggle-sm" role="switch"/> <span class="text-xs text-base-content/70"> </span></div></div> <!></div> <div><div class="flex items-center justify-between mb-1.5"><span class="text-xs font-semibold text-base-content/70 uppercase tracking-wide"> </span> <div class="flex items-center gap-2"><span class="text-xs text-base-content/50"> </span> <input type="checkbox" class="toggle toggle-secondary toggle-sm" role="switch"/> <span class="text-xs text-base-content/70"> </span></div></div> <!></div> <div><div class="flex items-center justify-between mb-1.5"><div class="flex items-center gap-1.5"><span class="text-xs font-semibold text-base-content/70 uppercase tracking-wide"> </span> <button type="button" class="btn btn-ghost btn-xs btn-circle flex-shrink-0"><svg xmlns="http://www.w3.org/2000/svg" class="w-[1.14rem] h-[1.14rem]" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true"><path fill-rule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7-4a1 1 0 11-2 0 1 1 0 012 0zM9 9a1 1 0 000 2v3a1 1 0 001 1h1a1 1 0 100-2v-3a1 1 0 00-1-1H9z" clip-rule="evenodd"></path></svg></button></div> <div class="flex items-center gap-2"><span> </span> <input type="checkbox" class="toggle toggle-secondary toggle-sm" role="switch"/> <span> </span></div></div> <!></div></div></div></div> <!> <!> <!> <!>',1);function H3(a,n){Re(n,!0);const c=()=>re(xe,"$lang",f),s=()=>re(ge,"$inputs",f),b=()=>re(Y2,"$result",f),[f,d]=Le(),i=m1(()=>Ne[c()]);let g=oe(!1),S=oe(!1),y=oe(!1),F=oe(!1);const I=["Tight","Balanced","Open"],V={Tight:r3,Balanced:o3,Open:l3};let P=m1(()=>s().flourBlend.reduce((m,p)=>m+p.pct,0)),_=m1(()=>Math.round(r(P))===100);function u(m){return s().flourBlend.some(p=>p.type===m)}function j(m){ge.update(p=>{if(p.flourBlend.find(h=>h.type===m)){if(p.flourBlend.length<=1)return p;const h=p.flourBlend.filter(t1=>t1.type!==m),w=h.reduce((t1,K)=>t1+K.pct,0);let A;if(w>0){const t1=100/w;A=h.map(K=>({...K,pct:Math.round(K.pct*t1)}))}else{const t1=Math.floor(100/h.length);A=h.map((K,z1)=>({...K,pct:z1===0?t1+(100-t1*h.length):t1}))}const Q=A.reduce((t1,K)=>t1+K.pct,0);return Q!==100&&A.length>0&&(A[0]={...A[0],pct:A[0].pct+(100-Q)}),{...p,flourBlend:A}}else{const h=p.flourBlend.length+1,w=Math.round(100/h),A=(100-w)/100,Q=p.flourBlend.map(K=>({...K,pct:Math.round(K.pct*A)}));Q.push({type:m,pct:w});const t1=Q.reduce((K,z1)=>K+z1.pct,0);return t1!==100&&Q.length>0&&(Q[0]={...Q[0],pct:Q[0].pct+(100-t1)}),{...p,flourBlend:Q}}})}function G(m,p){const v=Math.max(0,Math.min(100,parseFloat(p)||0));ge.update(h=>{const w=h.flourBlend.filter(K=>K.type!==m),A=w.reduce((K,z1)=>K+z1.pct,0),Q=100-v;let t1;if(w.length===0)t1=h.flourBlend.map(K=>({...K,pct:100}));else if(A===0){const K=Math.floor(Q/w.length),z1=Q-K*w.length;t1=h.flourBlend.map((f1,C1)=>{if(f1.type===m)return{...f1,pct:v};const H1=w.indexOf(f1);return{...f1,pct:K+(H1===0?z1:0)}})}else{const K=Q/A,z1=w.map(a1=>({...a1,pct:a1.pct*K})),f1=z1.map(a1=>({...a1,pct:Math.floor(a1.pct)})),C1=f1.reduce((a1,V1)=>a1+V1.pct,0);let H1=Q-C1;const pe=z1.map((a1,V1)=>({i:V1,frac:a1.pct-Math.floor(a1.pct)})).sort((a1,V1)=>V1.frac-a1.frac);for(let a1=0;a1<H1;a1++)f1[pe[a1].i].pct+=1;const U1=new Map(f1.map(a1=>[a1.type,a1.pct]));t1=h.flourBlend.map(a1=>a1.type===m?{...a1,pct:v}:{...a1,pct:U1.get(a1.type)??a1.pct})}return{...h,flourBlend:t1}})}function R(){ge.update(m=>{const p=m.flourBlend.reduce((A,Q)=>A+Q.pct,0);if(p===0||p===100)return m;const v=100/p,h=m.flourBlend.map(A=>({...A,pct:Math.round(A.pct*v)})),w=h.reduce((A,Q)=>A+Q.pct,0);return w!==100&&h.length>0&&(h[0]={...h[0],pct:h[0].pct+(100-w)}),{...m,flourBlend:h}})}const O={BreadFlour:"#F59E0B",AllPurpose:"#60A5FA",WholeWheat:"#92400E",Rye:"#059669",Spelt:"#7C3AED",Einkorn:"#F43F5E"},M=80,T=2*Math.PI*M;let z=m1(()=>{let m=0;return s().flourBlend.map(p=>{const v=p.pct/100*T,h={type:p.type,color:O[p.type],dasharray:`${v} ${T-v}`,dashoffset:-m};return m+=v,h})}),N=m1(()=>b().formula.autoSaltPct),Y=m1(()=>Math.round(b().formula.saltG)),Z=m1(()=>s().tempUnit==="F"?Math.round(n2(s().ambientTempC)):s().ambientTempC),q=m1(()=>s().doughTempC===null?"":s().tempUnit==="F"?Math.round(n2(s().doughTempC)):s().doughTempC),s1=m1(()=>s().tempUnit==="F"?Math.round(n2(s().fridgeTempC)):s().fridgeTempC);function y1(m,p){const v=s().tempUnit==="F"?Er(p):p;ge.update(h=>{const w={...h,[m]:v};return h.autolyseOn&&(m==="ambientTempC"||m==="doughTempC")?{...w,autolyseMins:Mt(w.ambientTempC,w.doughTempC)}:w})}function r1(m,p){ge.update(v=>({...v,[m]:p}))}function o1(){ge.update(m=>({...m,tempUnit:m.tempUnit==="C"?"F":"C"}))}function x1(m){const p=Math.max(0,parseFloat(m.target.value)||0);r1("totalFlourInputG",p)}function b1(m){const p=m.target;let v=parseFloat(p.value);isNaN(v)||(v=Math.min(r(k1),Math.max(r(_1),v)),y1("ambientTempC",v))}function D(m){const v=m.target.value;if(v==="")ge.update(h=>{const w={...h,doughTempC:null};return h.autolyseOn?{...w,autolyseMins:Mt(w.ambientTempC,w.doughTempC)}:w});else{let h=parseFloat(v);isNaN(h)||(h=Math.min(r(k1),Math.max(r(_1),h)),y1("doughTempC",h))}}function h1(){ge.update(m=>m.autolyseOn?{...m,autolyseOn:!1}:{...m,autolyseOn:!0,autolyseMins:Mt(m.ambientTempC,m.doughTempC)})}function w1(m){let p=parseFloat(m.target.value);isNaN(p)||(p=Math.min(r(T1),Math.max(r(B1),p)),y1("fridgeTempC",p))}const L1='a[href],button:not([disabled]),input:not([disabled]),select:not([disabled]),textarea:not([disabled]),[tabindex]:not([tabindex="-1"])';function A1(m,p){const v=Array.from(m.querySelectorAll(L1));v.length&&v[0].focus();function h(w){if(w.key==="Escape"){E(g,!1),E(S,!1),E(y,!1),E(F,!1);return}if(w.key!=="Tab")return;const A=v[0],Q=v[v.length-1];w.shiftKey?document.activeElement===A&&(w.preventDefault(),Q.focus()):document.activeElement===Q&&(w.preventDefault(),A.focus())}return m.addEventListener("keydown",h),{destroy(){m.removeEventListener("keydown",h)}}}function P1(m){return A1(m)}const _1=m1(()=>s().tempUnit==="F"?32:0),k1=m1(()=>s().tempUnit==="F"?120:50),B1=m1(()=>s().tempUnit==="F"?28:-2),T1=m1(()=>s().tempUnit==="F"?50:10),J1=20,K1=60-J1,I1=m1(()=>Math.max(0,Math.min(K1,s().autolyseMins-J1)));var E1=B3(),d1=se(E1),g1=t(d1),N1=t(g1),O1=t(N1,!0);e(N1),e(g1);var e1=o(g1,2),B=t(e1),x=t(B),C=t(x),l1=t(C);U(l1,"r",M);var u1=o(l1);te(u1,17,()=>r(z),m=>m.type,(m,p)=>{var v=i3();U(v,"r",M),L(()=>{U(v,"stroke",r(p).color),U(v,"stroke-dasharray",r(p).dasharray),U(v,"stroke-dashoffset",r(p).dashoffset)}),k(m,v)}),e(C);var j1=o(C,2),n1=t(j1),J=t(n1);le(J),rt(2),e(n1);var X=o(n1,2),W=t(X,!0);e(X),e(j1),e(x);var i1=o(x,2);{var c1=m=>{var p=d3();te(p,5,()=>s().flourBlend,v=>v.type,(v,h)=>{var w=c3(),A=t(w),Q=o(A);e(w),L(t1=>{R2(A,`background-color: ${O[r(h).type]??""}`),l(Q,` ${r(i).flourTypes[r(h).type]??""}: ${t1??""}g`)},[()=>Math.round(s().totalFlourInputG*r(h).pct/100)]),k(v,w)}),e(p),k(m,p)};v1(i1,m=>{s().flourBlend.length>1&&m(c1)})}e(B);var M1=o(B,2),F1=t(M1),G1=t(F1,!0);e(F1);var S1=o(F1,2);te(S1,21,()=>Br,he,(m,p)=>{var v=u3(),h=t(v,!0);e(v),L(w=>{p1(v,1,`btn btn-sm rounded-xl border-2 h-auto py-2 px-1 text-xs
							${w??""}`),l(h,r(i).flourTypes[r(p)])},[()=>u(r(p))?"btn-secondary border-secondary text-secondary-content":"btn-ghost border-base-300"]),H("click",v,()=>j(r(p))),k(m,v)}),e(S1);var R1=o(S1,2);{var W1=m=>{var p=v3(),v=se(p);te(v,5,()=>s().flourBlend,f1=>f1.type,(f1,C1)=>{var H1=m3(),pe=t(H1),U1=o(pe,2),a1=t(U1,!0);e(U1);var V1=o(U1,2),Q1=t(V1);le(Q1);var ve=o(Q1,2);le(ve),rt(2),e(V1),e(H1),L(Z1=>{R2(pe,`background-color: ${O[r(C1).type]??""}`),l(a1,r(i).flourTypes[r(C1).type]),ae(Q1,r(C1).pct),ae(ve,Z1)},[()=>Math.round(r(C1).pct)]),H("input",Q1,Z1=>G(r(C1).type,Z1.target.value)),H("change",ve,Z1=>G(r(C1).type,Z1.target.value)),k(f1,H1)}),e(v);var h=o(v,2),w=t(h),A=t(w),Q=o(A),t1=t(Q);e(Q),e(w);var K=o(w,2);{var z1=f1=>{var C1=p3(),H1=t(C1,!0);e(C1),L(()=>l(H1,r(i).blendNormalize)),H("click",C1,R),k(f1,C1)};v1(K,f1=>{r(_)||f1(z1)})}e(h),L(f1=>{l(A,`${r(i).blendTotal??""}: `),p1(Q,1,`font-semibold tabular-nums ${r(_)?"text-success":"text-error"}`),l(t1,`${f1??""}%`)},[()=>Math.round(r(P))]),k(m,p)};v1(R1,m=>{s().flourBlend.length>1&&m(W1)})}e(M1);var Y1=o(M1,2),D1=t(Y1),X1=t(D1),Se=t(X1,!0);e(X1);var ne=o(X1,2),Ce=t(ne),ye=o(Ce,4);e(ne),e(D1);var ce=o(D1,2),de=t(ce),ue=t(de),ze=t(ue),Ae=t(ze,!0);e(ze),e(ue);var me=o(ue,2);le(me),e(de);var qe=o(de,2),Oe=t(qe),Ke=t(Oe),xt=t(Ke),Ye=o(xt),jt=t(Ye,!0);e(Ye),e(Ke),e(Oe);var Te=o(Oe,2);le(Te),e(qe),e(ce),e(Y1),e(e1);var yt=o(e1,2);{var zt=m=>{var p=b3(),v=t(p);t3(v,{get warnings(){return b().warnings}}),e(p),k(m,p)};v1(yt,m=>{s().totalFlourInputG>0&&m(zt)})}var Ie=o(yt,2),st=t(Ie),Ze=t(st),Rt=t(Ze,!0);e(Ze),e(st);var lt=o(st,2),Je=t(lt),Xe=t(Je),it=t(Xe),_t=t(it,!0);e(it);var ct=o(it,2);e(Xe);var Ee=o(Xe,2);te(Ee,21,()=>I,he,(m,p)=>{const v=m1(()=>V[r(p)]);var h=g3(),w=t(h);cr(w,()=>r(v),(t1,K)=>{K(t1,{class:"w-full h-auto max-h-full"})});var A=o(w,2),Q=t(A,!0);e(A),e(h),L(()=>{p1(h,1,`btn rounded-xl border-2 flex-col h-auto py-3 px-2 gap-1.5
								${s().crumbGoal===r(p)?"btn-secondary border-secondary text-secondary-content":"btn-ghost border-base-300"}`),l(Q,r(i).crumbGoalNames[r(p)])}),H("click",h,()=>r1("crumbGoal",r(p))),k(m,h)}),e(Ee);var kt=o(Ee,2),wt=t(kt,!0);e(kt),e(Je);var dt=o(Je,2),Fe=t(dt),_e=t(Fe),$e=t(_e,!0);e(_e);var Be=o(_e,2);e(Fe);var Ge=o(Fe,2);te(Ge,20,()=>["Predictability","FlavorDevelopment"],he,(m,p)=>{var v=f3(),h=t(v,!0);e(v),L(()=>{p1(v,1,`btn btn-sm rounded-xl border-2 h-auto py-2.5 px-3
							${s().fermentationPhilosophy===p?"btn-secondary border-secondary text-secondary-content":"btn-ghost border-base-300"}`),l(h,p==="Predictability"?r(i).philosophyPredictability:r(i).philosophyFlavorDev)}),H("click",v,()=>r1("fermentationPhilosophy",p)),k(m,v)}),e(Ge);var He=o(Ge,2),ut=t(He,!0);e(He),e(dt);var Pe=o(dt,2),mt=t(Pe),pt=t(mt),ea=t(pt,!0);e(pt);var b2=o(pt,2);e(mt);var Dt=o(mt,2);te(Dt,20,()=>["Room","ColdRetard"],he,(m,p)=>{var v=h3(),h=t(v,!0);e(v),L(()=>{p1(v,1,`btn btn-sm rounded-xl border-2 h-auto py-2.5 px-3
								${s().proofMethod===p?"btn-secondary border-secondary text-secondary-content":"btn-ghost border-base-300"}`),l(h,p==="Room"?r(i).roomTemp:r(i).coldRetard)}),H("click",v,()=>r1("proofMethod",p)),k(m,v)}),e(Dt);var ta=o(Dt,2);{var aa=m=>{var p=M3(),v=t(p),h=t(v),w=t(h);e(h),e(v);var A=o(v,2);le(A),e(p),L(()=>{l(w,`${r(i).fridgeTemp??""} (°${s().tempUnit??""})`),U(A,"min",r(B1)),U(A,"max",r(T1)),ae(A,r(s1))}),H("input",A,w1),k(m,p)};v1(ta,m=>{s().proofMethod==="ColdRetard"&&m(aa)})}e(Pe);var g2=o(Pe,2),Lt=t(g2),ra=t(Lt,!0);e(Lt);var Nt=o(Lt,2);te(Nt,20,()=>["relative","clock"],he,(m,p)=>{var v=x3(),h=t(v,!0);e(v),L(()=>{p1(v,1,`btn btn-sm rounded-xl border-2 h-auto py-2.5 px-3
								${s().scheduleMode===p?"btn-secondary border-secondary text-secondary-content":"btn-ghost border-base-300"}`),l(h,p==="relative"?r(i).relative:r(i).clock)}),H("click",v,()=>r1("scheduleMode",p)),k(m,v)}),e(Nt);var na=o(Nt,2);{var oa=m=>{var p=y3(),v=t(p),h=t(v),w=t(h,!0);e(h),e(v);var A=o(v,2);le(A),e(p),L(()=>{l(w,r(i).startTime),ae(A,s().startTime??"08:00")}),H("input",A,Q=>r1("startTime",Q.target.value||null)),k(m,p)};v1(na,m=>{s().scheduleMode==="clock"&&m(oa)})}e(g2),e(lt),e(Ie);var f2=o(Ie,2),Ot=t(f2),h2=t(Ot),sa=t(h2,!0);e(h2),e(Ot);var M2=o(Ot,2),It=t(M2),Et=t(It),$t=t(Et),la=t($t,!0);e($t);var x2=o($t,2),Gt=t(x2),ia=t(Gt);{var ca=m=>{var p=Me();L(v=>l(p,v),[()=>r(i).saltAutoLabel(r(N).toFixed(2),String(r(Y)))]),k(m,p)},da=m=>{var p=Me();L(()=>l(p,r(i).saltManual)),k(m,p)};v1(ia,m=>{s().saltAutoCalc?m(ca):m(da,-1)})}e(Gt);var Qe=o(Gt,2);le(Qe);var y2=o(Qe,2),ua=t(y2,!0);e(y2),e(x2),e(Et);var ma=o(Et,2);{var pa=m=>{var p=z3(),v=se(p),h=t(v);le(h),e(v);var w=o(v,2),A=t(w,!0);e(w),L(()=>{ae(h,s().saltPct),l(A,r(i).saltBakersPct)}),H("input",h,Q=>r1("saltPct",parseFloat(Q.target.value)||2)),k(m,p)};v1(ma,m=>{s().saltAutoCalc||m(pa)})}e(It);var Wt=o(It,2),Ut=t(Wt),Vt=t(Ut),va=t(Vt,!0);e(Vt);var z2=o(Vt,2),qt=t(z2),ba=t(qt,!0);e(qt);var et=o(qt,2);le(et);var _2=o(et,2),ga=t(_2,!0);e(_2),e(z2),e(Ut);var fa=o(Ut,2);{var ha=m=>{var p=_3(),v=t(p);le(v),e(p),L(()=>ae(v,s().starterHydrationPct)),H("input",v,h=>r1("starterHydrationPct",parseFloat(h.target.value)||100)),k(m,p)};v1(fa,m=>{s().starterHydrationAutoCalc||m(ha)})}e(Wt);var k2=o(Wt,2),Kt=t(k2),Yt=t(Kt),Zt=t(Yt),Ma=t(Zt,!0);e(Zt);var w2=o(Zt,2);e(Yt);var T2=o(Yt,2),Tt=t(T2),xa=t(Tt,!0);e(Tt);var tt=o(Tt,2);le(tt);var Jt=o(tt,2),ya=t(Jt,!0);e(Jt),e(T2),e(Kt);var za=o(Kt,2);{var _a=m=>{var p=k3(),v=t(p),h=t(v),w=t(h,!0);e(h);var A=o(h,2),Q=t(A);e(A),e(v);var t1=o(v,2);U(t1,"max",K1);var K=o(t1,2),z1=t(K);z1.textContent="20 min";var f1=o(z1,2);f1.textContent="60 min",e(K),e(p),L(()=>{l(w,r(i).duration),l(Q,`${s().autolyseMins??""} min`),ae(t1,r(I1)),U(t1,"aria-label",r(i).ariaLabels.autolyseDurationProgress)}),k(m,p)};v1(za,m=>{s().autolyseOn&&m(_a)})}e(k2),e(M2),e(f2),e(d1);var F2=o(d1,2);{var ka=m=>{var p=w3(),v=t(p),h=o(v,2),w=t(h),A=t(w),Q=t(A,!0);e(A);var t1=o(A,2);e(w);var K=o(w,2),z1=t(K),f1=t(z1),C1=t(f1,!0);e(f1);var H1=o(f1,2),pe=t(H1,!0);e(H1),e(z1);var U1=o(z1,2),a1=t(U1),V1=t(a1,!0);e(a1);var Q1=o(a1,2),ve=t(Q1,!0);e(Q1),e(U1),e(K);var Z1=o(K,2),ee=t(Z1),We=t(ee,!0);e(ee),e(Z1),e(h),ht(h,be=>P1?.(be)),e(p),L(()=>{U(v,"aria-label",r(i).ariaLabels.closeFermentationPhilosophyModal),l(Q,r(i).philosophyModalTitle),U(t1,"aria-label",r(i).ariaLabels.closeButton),l(C1,r(i).philosophyPredictability),l(pe,r(i).philosophyModalPredictabilityBody),l(V1,r(i).philosophyFlavorDev),l(ve,r(i).philosophyModalFlavorDevBody),l(We,r(i).done)}),H("click",v,()=>E(g,!1)),H("click",t1,()=>E(g,!1)),H("click",ee,()=>E(g,!1)),k(m,p)};v1(F2,m=>{r(g)&&m(ka)})}var S2=o(F2,2);{var wa=m=>{var p=S3(),v=t(p),h=o(v,2),w=t(h),A=t(w),Q=t(A,!0);e(A);var t1=o(A,2);e(w);var K=o(w,2),z1=t(K),f1=t(z1,!0);e(z1);var C1=o(z1,2),H1=t(C1),pe=t(H1,!0);e(H1);var U1=o(H1,2);te(U1,21,()=>r(i).autolyseModalUseItems,he,(be,vt)=>{var ke=T3(),Ue=t(ke,!0);e(ke),L(()=>l(Ue,r(vt))),k(be,ke)}),e(U1),e(C1);var a1=o(C1,2),V1=t(a1),Q1=t(V1,!0);e(V1);var ve=o(V1,2);te(ve,21,()=>r(i).autolyseModalAvoidItems,he,(be,vt)=>{var ke=F3(),Ue=t(ke,!0);e(ke),L(()=>l(Ue,r(vt))),k(be,ke)}),e(ve),e(a1),e(K);var Z1=o(K,2),ee=t(Z1),We=t(ee,!0);e(ee),e(Z1),e(h),ht(h,be=>P1?.(be)),e(p),L(()=>{U(v,"aria-label",r(i).ariaLabels.closeAutolyseModal),l(Q,r(i).autolyseModalTitle),U(t1,"aria-label",r(i).ariaLabels.closeButton),l(f1,r(i).autolyseModalIntro),l(pe,r(i).autolyseModalUseTitle),l(Q1,r(i).autolyseModalAvoidTitle),l(We,r(i).done)}),H("click",v,()=>E(S,!1)),H("click",t1,()=>E(S,!1)),H("click",ee,()=>E(S,!1)),k(m,p)};v1(S2,m=>{r(S)&&m(wa)})}var C2=o(S2,2);{var Ta=m=>{var p=C3(),v=t(p),h=o(v,2),w=t(h),A=t(w),Q=t(A,!0);e(A);var t1=o(A,2);e(w);var K=o(w,2),z1=t(K),f1=t(z1),C1=t(f1,!0);e(f1);var H1=o(f1,2),pe=t(H1,!0);e(H1),e(z1);var U1=o(z1,2),a1=t(U1),V1=t(a1,!0);e(a1);var Q1=o(a1,2),ve=t(Q1,!0);e(Q1),e(U1),e(K);var Z1=o(K,2),ee=t(Z1),We=t(ee,!0);e(ee),e(Z1),e(h),ht(h,be=>P1?.(be)),e(p),L(()=>{U(v,"aria-label",r(i).ariaLabels.closeProofMethodModal),l(Q,r(i).proofMethodModalTitle),U(t1,"aria-label",r(i).ariaLabels.closeProofMethodModal),l(C1,r(i).roomTemp),l(pe,r(i).proofMethodRoomBody),l(V1,r(i).coldRetard),l(ve,r(i).proofMethodColdRetardBody),l(We,r(i).done)}),H("click",v,()=>E(y,!1)),H("click",t1,()=>E(y,!1)),H("click",ee,()=>E(y,!1)),k(m,p)};v1(C2,m=>{r(y)&&m(Ta)})}var Fa=o(C2,2);{var Sa=m=>{var p=A3(),v=t(p),h=o(v,2),w=t(h),A=t(w),Q=t(A,!0);e(A);var t1=o(A,2);e(w);var K=o(w,2),z1=t(K),f1=t(z1),C1=t(f1,!0);e(f1);var H1=o(f1,2),pe=t(H1,!0);e(H1),e(z1);var U1=o(z1,2),a1=t(U1),V1=t(a1,!0);e(a1);var Q1=o(a1,2),ve=t(Q1,!0);e(Q1),e(U1);var Z1=o(U1,2),ee=t(Z1),We=t(ee,!0);e(ee);var be=o(ee,2),vt=t(be,!0);e(be),e(Z1),e(K);var ke=o(K,2),Ue=t(ke),Ca=t(Ue,!0);e(Ue),e(ke),e(h),ht(h,Aa=>P1?.(Aa)),e(p),L(()=>{U(v,"aria-label",r(i).ariaLabels.closeCrumbGoalModal),l(Q,r(i).crumbModalTitle),U(t1,"aria-label",r(i).ariaLabels.closeButton),l(C1,r(i).crumbGoalNames.Tight),l(pe,r(i).crumbModalTightBody),l(V1,r(i).crumbGoalNames.Balanced),l(ve,r(i).crumbModalBalancedBody),l(We,r(i).crumbGoalNames.Open),l(vt,r(i).crumbModalOpenBody),l(Ca,r(i).done)}),H("click",v,()=>E(F,!1)),H("click",t1,()=>E(F,!1)),H("click",Ue,()=>E(F,!1)),k(m,p)};v1(Fa,m=>{r(F)&&m(Sa)})}L(()=>{l(O1,r(i).parameters),ae(J,s().totalFlourInputG),l(W,r(i).totalFlour),l(G1,r(i).flourSelection),l(Se,r(i).temperatures),U(ne,"aria-label",r(i).ariaLabels.toggleTempUnit),p1(Ce,1,Ve(s().tempUnit==="C"?"text-secondary font-semibold":"text-base-content/50")),p1(ye,1,Ve(s().tempUnit==="F"?"text-secondary font-semibold":"text-base-content/50")),l(Ae,r(i).kitchenTemp),U(me,"min",r(_1)),U(me,"max",r(k1)),ae(me,r(Z)),l(xt,`${r(i).doughTemp??""} `),l(jt,r(i).optional),U(Te,"min",r(_1)),U(Te,"max",r(k1)),ae(Te,r(q)),U(Te,"placeholder",r(i).leaveBlankAmbient),l(Rt,r(i).bakingProfile),l(_t,r(i).crumbGoal),U(ct,"aria-label",r(i).ariaLabels.learnCrumbGoal),l(wt,r(i).crumbDescriptions[s().crumbGoal]),l($e,r(i).fermentationPhilosophyLabel),U(Be,"aria-label",r(i).ariaLabels.learnFermentationPhilosophy),l(ut,s().fermentationPhilosophy==="Predictability"?r(i).philosophyPredictabilityDesc:r(i).philosophyFlavorDevDesc),l(ea,r(i).proofMethod),U(b2,"aria-label",r(i).ariaLabels.learnProofMethod),l(ra,r(i).scheduleMode),l(sa,r(i).fineTuning),l(la,r(i).salt),a2(Qe,!s().saltAutoCalc),U(Qe,"aria-checked",!s().saltAutoCalc),U(Qe,"aria-label",r(i).ariaLabels.overrideSalt),l(ua,r(i).saltOverride),l(va,r(i).starterHydration),l(ba,s().starterHydrationAutoCalc?r(i).starterHydrationDefaultLabel:r(i).starterHydrationManual),a2(et,!s().starterHydrationAutoCalc),U(et,"aria-checked",!s().starterHydrationAutoCalc),U(et,"aria-label",r(i).ariaLabels.overrideStarterHydration),l(ga,r(i).starterHydrationOverride),l(Ma,r(i).autolyse),U(w2,"aria-label",r(i).ariaLabels.learnAutolyse),p1(Tt,1,Ve(s().autolyseOn?"text-xs text-base-content/40":"text-xs text-base-content/70 font-semibold")),l(xa,r(i).off),a2(tt,s().autolyseOn),U(tt,"aria-checked",s().autolyseOn),U(tt,"aria-label",r(i).ariaLabels.toggleAutolyseAuto),p1(Jt,1,Ve(s().autolyseOn?"text-xs text-base-content/70 font-semibold":"text-xs text-base-content/40")),l(ya,r(i).auto)}),H("input",J,x1),H("click",ne,o1),H("input",me,b1),H("input",Te,D),H("click",ct,()=>E(F,!0)),H("click",Be,()=>E(g,!0)),H("click",b2,()=>E(y,!0)),H("change",Qe,()=>r1("saltAutoCalc",!s().saltAutoCalc)),H("change",et,()=>r1("starterHydrationAutoCalc",!s().starterHydrationAutoCalc)),H("click",w2,()=>E(S,!0)),H("change",tt,h1),k(a,E1),De(),d()}nt(["input","click","change"]);var P3=$('<tr class="bg-base-200/30"><td class="py-1.5 text-base-content/70 text-xs pl-4"> </td><td class="py-1.5 text-right tabular-nums text-base-content/70 text-xs"> </td><td class="py-1.5 text-right tabular-nums text-base-content/50 text-xs"> </td></tr>'),j3=$('<div class="px-5 pb-4"><table class="w-full text-sm"><thead><tr class="border-b border-base-200"><th class="text-left py-2 text-xs font-semibold text-base-content/50 uppercase tracking-wide"> </th><th class="text-right py-2 text-xs font-semibold text-base-content/50 uppercase tracking-wide"> </th><th class="text-right py-2 text-xs font-semibold text-base-content/50 uppercase tracking-wide"> </th></tr></thead><tbody class="divide-y divide-base-200"><tr><td class="py-2.5 text-base-content font-medium"> </td><td class="py-2.5 text-right tabular-nums text-base-content font-semibold"> </td><td class="py-2.5 text-right tabular-nums text-base-content/70">100%</td></tr><!><tr><td class="py-2.5 text-base-content font-medium"> </td><td class="py-2.5 text-right tabular-nums text-base-content font-semibold"> </td><td class="py-2.5 text-right tabular-nums text-base-content/70"> </td></tr><tr><td class="py-2.5 text-base-content font-medium"> </td><td class="py-2.5 text-right tabular-nums text-base-content font-semibold"> </td><td class="py-2.5 text-right tabular-nums text-base-content/70"> </td></tr><tr><td class="py-2.5 text-base-content font-medium"> </td><td class="py-2.5 text-right tabular-nums text-base-content font-semibold"> </td><td class="py-2.5 text-right tabular-nums text-base-content/70"> <span class="text-[10px] text-base-content/40 block leading-tight"> </span></td></tr></tbody><tfoot><tr class="border-t-2 border-secondary/30 bg-secondary/10"><td class="py-3 font-bold text-secondary"> </td><td class="py-3 text-right tabular-nums font-bold text-secondary"> </td><td class="py-3 text-right"></td></tr></tfoot></table></div>'),R3=$('<div class="modal modal-open"><button type="button" class="modal-backdrop"></button> <div class="modal-box w-full max-w-sm p-0 overflow-hidden" role="dialog" aria-modal="true" aria-labelledby="formula-modal-title"><div class="flex items-center justify-between px-5 py-4 border-b border-base-200"><h2 id="formula-modal-title" class="text-base font-semibold text-base-content"> </h2> <button type="button" class="btn btn-ghost btn-sm btn-circle"><svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12"></path></svg></button></div> <div class="px-5 py-4 space-y-4"><div><p class="text-xs font-semibold text-secondary uppercase tracking-wide mb-1"> </p> <p class="text-sm text-base-content/70 leading-relaxed"> </p></div> <div class="border-t border-base-200 pt-4"><p class="text-xs font-semibold text-secondary uppercase tracking-wide mb-1"> </p> <p class="text-sm text-base-content/70 leading-relaxed"> </p></div></div> <div class="px-5 pb-5"><button type="button" class="btn btn-primary w-full"> </button></div></div></div>'),D3=$('<div class="card bg-base-100 shadow-sm ring-1 ring-base-300/70 overflow-hidden"><div class="flex items-center justify-between px-5 pt-5 pb-3"><div><div class="flex items-center gap-1.5"><h2 class="text-base font-semibold text-base-content uppercase tracking-wide"> </h2> <button type="button" class="btn btn-ghost btn-xs btn-circle flex-shrink-0"><svg xmlns="http://www.w3.org/2000/svg" class="w-[1.14rem] h-[1.14rem]" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true"><path fill-rule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7-4a1 1 0 11-2 0 1 1 0 012 0zM9 9a1 1 0 000 2v3a1 1 0 001 1h1a1 1 0 100-2v-3a1 1 0 00-1-1H9z" clip-rule="evenodd"></path></svg></button></div> <p class="text-xs text-base-content/50 mt-0.5"> </p></div> <div class="badge badge-secondary badge-lg tabular-nums font-bold gap-1"> </div></div> <div class="px-5 pb-4"><p class="text-xs font-semibold text-base-content/70 uppercase tracking-wide mb-3"> </p> <div class="grid grid-cols-2 gap-3"><div class="rounded-xl bg-base-200/80 ring-1 ring-base-300/60 px-3 py-3 text-center"><div class="text-2xl font-bold tabular-nums text-base-content"> </div> <div class="text-xs text-base-content/60 mt-1 font-medium"> </div></div> <div class="rounded-xl bg-base-200/80 ring-1 ring-base-300/60 px-3 py-3 text-center"><div class="text-2xl font-bold tabular-nums text-base-content"> </div> <div class="text-xs text-base-content/60 mt-1 font-medium"> </div></div> <div class="rounded-xl bg-accent/10 ring-1 ring-accent/20 px-3 py-3 text-center"><div class="text-2xl font-bold tabular-nums text-accent"> </div> <div class="text-xs text-accent/70 mt-1 font-medium"> </div></div> <div class="rounded-xl bg-base-200/80 ring-1 ring-base-300/60 px-3 py-3 text-center"><div class="text-2xl font-bold tabular-nums text-base-content"> </div> <div class="text-xs text-base-content/60 mt-1 font-medium"> </div></div></div> <p class="text-xs text-base-content/50 mt-2.5 italic"> </p></div> <div class="border-t border-base-200"><button type="button" class="w-full flex items-center justify-between px-5 py-3 text-left hover:bg-base-200/50 transition-colors"><span class="text-xs font-semibold text-base-content/70 uppercase tracking-wide"> </span> <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor"><path fill-rule="evenodd" d="M5.23 7.21a.75.75 0 011.06.02L10 11.168l3.71-3.938a.75.75 0 111.08 1.04l-4.25 4.5a.75.75 0 01-1.08 0l-4.25-4.5a.75.75 0 01.02-1.06z" clip-rule="evenodd"></path></svg></button> <!></div></div> <!>',1);function L3(a,n){Re(n,!0);const c=()=>re(xe,"$lang",b),s=()=>re(d2,"$showFullFormula",b),[b,f]=Le(),d=m1(()=>Ne[c()]);function i(J,X){return X<=0?"—":`${(J/X*100).toFixed(1)}%`}function g(J){return Math.round(J).toString()}function S(J,X){const W=Math.round(J),i1=Math.round(X);if(W<=0||i1<=0)return"—";let c1=W,M1=i1;for(;M1;)[c1,M1]=[M1,c1%M1];return`${W/c1}:${i1/c1}`}let y=oe(!1);const F='a[href],button:not([disabled]),input:not([disabled]),select:not([disabled]),textarea:not([disabled]),[tabindex]:not([tabindex="-1"])';function I(J,X){const W=Array.from(J.querySelectorAll(F));W.length&&W[0].focus();function i1(c1){if(c1.key==="Escape"){E(y,!1);return}if(c1.key!=="Tab")return;const M1=W[0],F1=W[W.length-1];c1.shiftKey?document.activeElement===M1&&(c1.preventDefault(),F1.focus()):document.activeElement===F1&&(c1.preventDefault(),M1.focus())}return J.addEventListener("keydown",i1),{destroy(){J.removeEventListener("keydown",i1)}}}function V(J){return I(J)}var P=D3(),_=se(P),u=t(_),j=t(u),G=t(j),R=t(G),O=t(R,!0);e(R);var M=o(R,2);e(G);var T=o(G,2),z=t(T,!0);e(T),e(j);var N=o(j,2),Y=t(N);e(N),e(u);var Z=o(u,2),q=t(Z),s1=t(q,!0);e(q);var y1=o(q,2),r1=t(y1),o1=t(r1),x1=t(o1);e(o1);var b1=o(o1,2),D=t(b1,!0);e(b1),e(r1);var h1=o(r1,2),w1=t(h1),L1=t(w1);e(w1);var A1=o(w1,2),P1=t(A1,!0);e(A1),e(h1);var _1=o(h1,2),k1=t(_1),B1=t(k1);e(k1);var T1=o(k1,2),J1=t(T1,!0);e(T1),e(_1);var $1=o(_1,2),K1=t($1),I1=t(K1);e(K1);var E1=o(K1,2),d1=t(E1,!0);e(E1),e($1),e(y1);var g1=o(y1,2),N1=t(g1,!0);e(g1),e(Z);var O1=o(Z,2),e1=t(O1),B=t(e1),x=t(B,!0);e(B);var C=o(B,2);e(e1);var l1=o(e1,2);{var u1=J=>{var X=j3(),W=t(X),i1=t(W),c1=t(i1),M1=t(c1),F1=t(M1,!0);e(M1);var G1=o(M1),S1=t(G1,!0);e(G1);var R1=o(G1),W1=t(R1,!0);e(R1),e(c1),e(i1);var Y1=o(i1),D1=t(Y1),X1=t(D1),Se=t(X1,!0);e(X1);var ne=o(X1),Ce=t(ne);e(ne),rt(),e(D1);var ye=o(D1);te(ye,17,()=>n.flourBlend,Fe=>Fe.type,(Fe,_e)=>{var $e=P3(),Be=t($e),Ge=t(Be);e(Be);var He=o(Be),ut=t(He);e(He);var Pe=o(He),mt=t(Pe);e(Pe),e($e),L(pt=>{l(Ge,`— ${r(d).flourTypes[r(_e).type]??r(_e).type??""}`),l(ut,`${pt??""}g`),l(mt,`${r(_e).pct??""}%`)},[()=>g(n.formula.totalFlourG*r(_e).pct/100)]),k(Fe,$e)});var ce=o(ye),de=t(ce),ue=t(de,!0);e(de);var ze=o(de),Ae=t(ze);e(ze);var me=o(ze),qe=t(me);e(me),e(ce);var Oe=o(ce),Ke=t(Oe),xt=t(Ke,!0);e(Ke);var Ye=o(Ke),jt=t(Ye);e(Ye);var Te=o(Ye),yt=t(Te,!0);e(Te),e(Oe);var zt=o(Oe),Ie=t(zt),st=t(Ie,!0);e(Ie);var Ze=o(Ie),Rt=t(Ze);e(Ze);var lt=o(Ze),Je=t(lt),Xe=o(Je),it=t(Xe,!0);e(Xe),e(lt),e(zt),e(Y1);var _t=o(Y1),ct=t(_t),Ee=t(ct),kt=t(Ee,!0);e(Ee);var wt=o(Ee),dt=t(wt);e(wt),rt(),e(ct),e(_t),e(W),e(X),L((Fe,_e,$e,Be,Ge,He,ut,Pe)=>{l(F1,r(d).ingredient),l(S1,r(d).grams),l(W1,r(d).bakersPct),l(Se,r(d).totalFlourRow),l(Ce,`${Fe??""}g`),l(ue,r(d).water),l(Ae,`${_e??""}g`),l(qe,`${$e??""}%`),l(xt,r(d).saltRow),l(jt,`${Be??""}g`),l(yt,Ge),l(st,r(d).starter),l(Rt,`${He??""}g`),l(Je,`${ut??""} `),l(it,r(d).preFermentedFlour),l(kt,r(d).totalDough),l(dt,`${Pe??""}g`)},[()=>g(n.formula.totalFlourG),()=>g(n.formula.totalWaterG),()=>n.formula.finalHydrationPct.toFixed(1),()=>g(n.formula.saltG),()=>i(n.formula.saltG,n.formula.totalFlourG),()=>g(n.formula.starterTotalG),()=>i(n.formula.starterFlourG,n.formula.totalFlourG),()=>g(n.formula.totalDoughWeightG)]),k(J,X)};v1(l1,J=>{s()&&J(u1)})}e(O1),e(_);var j1=o(_,2);{var n1=J=>{var X=R3(),W=t(X),i1=o(W,2),c1=t(i1),M1=t(c1),F1=t(M1,!0);e(M1);var G1=o(M1,2);e(c1);var S1=o(c1,2),R1=t(S1),W1=t(R1),Y1=t(W1,!0);e(W1);var D1=o(W1,2),X1=t(D1,!0);e(D1),e(R1);var Se=o(R1,2),ne=t(Se),Ce=t(ne,!0);e(ne);var ye=o(ne,2),ce=t(ye,!0);e(ye),e(Se),e(S1);var de=o(S1,2),ue=t(de),ze=t(ue,!0);e(ue),e(de),e(i1),ht(i1,Ae=>V?.(Ae)),e(X),L(()=>{U(W,"aria-label",r(d).ariaLabels.closeFormulaModal),l(F1,r(d).formulaInfoTitle),U(G1,"aria-label",r(d).ariaLabels.closeFormulaModal),l(Y1,r(d).mixAdditions),l(X1,r(d).formulaInfoMixBody),l(Ce,r(d).fullFormula),l(ce,r(d).formulaInfoFormulaBody),l(ze,r(d).done)}),H("click",W,()=>E(y,!1)),H("click",G1,()=>E(y,!1)),H("click",ue,()=>E(y,!1)),k(J,X)};v1(j1,J=>{r(y)&&J(n1)})}L((J,X,W,i1,c1,M1)=>{l(O,r(d).formula),U(M,"aria-label",r(d).ariaLabels.learnFormula),l(z,r(d).bakersPctSubtitle),l(Y,`${J??""}g`),l(s1,r(d).mixAdditions),l(x1,`${X??""}g`),l(D,r(d).mixFlour),l(L1,`${W??""}g`),l(P1,r(d).mixWater),l(B1,`${i1??""}g`),l(J1,r(d).starter),l(I1,`${c1??""}g`),l(d1,r(d).saltRow),l(N1,M1),l(x,r(d).fullFormula),p1(C,0,`w-4 h-4 text-base-content/40 transition-transform ${s()?"rotate-180":""}`)},[()=>g(n.formula.totalDoughWeightG),()=>g(n.formula.mixFlourG),()=>g(n.formula.mixWaterG),()=>g(n.formula.starterTotalG),()=>g(n.formula.saltG),()=>r(d).starterContains(g(n.formula.starterFlourG),g(n.formula.starterWaterG),S(n.formula.starterFlourG,n.formula.starterWaterG))]),H("click",M,()=>E(y,!0)),H("click",e1,()=>d2.update(J=>!J)),k(a,P),De(),f()}nt(["click"]);var N3=$('<div class="flex justify-between items-center mb-2"><span class="text-sm font-semibold text-base-content"> </span> <span class="text-sm tabular-nums font-bold text-info"> </span></div> <div class="relative h-3"><progress class="progress progress-info w-full absolute inset-0 opacity-50" max="100"></progress> <progress class="progress progress-info w-full absolute inset-0" max="100"></progress></div>',1),O3=$('<div class="flex justify-between items-center mb-2"><span class="text-sm font-semibold text-base-content"> </span> <span class="text-sm tabular-nums font-bold text-secondary"> </span></div> <div class="relative h-3"><progress class="progress progress-secondary w-full absolute inset-0 opacity-50" value="100" max="100"></progress> <progress class="progress progress-secondary w-full absolute inset-0" max="100"></progress></div> <p class="text-xs text-base-content/70 mt-1"> </p>',1),I3=$('<div class="modal modal-open"><button type="button" class="modal-backdrop"></button> <div class="modal-box w-full max-w-md p-0 overflow-hidden" role="dialog" aria-modal="true" aria-labelledby="timing-bars-modal-title"><div class="flex items-center justify-between px-5 py-4 border-b border-base-200"><h2 id="timing-bars-modal-title" class="text-base font-semibold text-base-content"> </h2> <button type="button" class="btn btn-ghost btn-sm btn-circle"><svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12"></path></svg></button></div> <div class="px-5 py-4 space-y-4"><p class="text-sm text-base-content/70 leading-relaxed"> </p> <div><p class="text-xs font-semibold text-secondary uppercase tracking-wide mb-1"> </p> <p class="text-sm text-base-content/70 leading-relaxed"> </p></div> <div class="border-t border-base-200 pt-4"><p class="text-xs font-semibold text-secondary uppercase tracking-wide mb-1"> </p> <p class="text-sm text-base-content/70 leading-relaxed"> </p></div></div> <div class="px-5 pb-5"><button type="button" class="btn btn-primary w-full"> </button></div></div></div>'),E3=$('<div class="card bg-base-100 shadow-sm ring-1 ring-base-300/70"><div class="card-body gap-5 p-5"><div class="flex items-center gap-1.5"><h2 class="text-base font-semibold text-base-content uppercase tracking-wide"> </h2> <button type="button" class="btn btn-ghost btn-xs btn-circle flex-shrink-0"><svg xmlns="http://www.w3.org/2000/svg" class="w-[1.14rem] h-[1.14rem]" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true"><path fill-rule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7-4a1 1 0 11-2 0 1 1 0 012 0zM9 9a1 1 0 000 2v3a1 1 0 001 1h1a1 1 0 100-2v-3a1 1 0 00-1-1H9z" clip-rule="evenodd"></path></svg></button></div> <div class="flex flex-wrap gap-2"><span> </span> <span> </span> <span class="badge badge-soft badge-accent badge-md font-medium"> </span></div> <div><div class="flex justify-between items-center mb-2"><span class="text-sm font-semibold text-base-content"> </span> <span class="text-sm tabular-nums font-bold text-secondary"> </span></div> <div class="relative h-3"><progress class="progress progress-warning w-full absolute inset-0" max="100"></progress> <progress class="progress progress-secondary w-full absolute inset-0 opacity-80" max="100"></progress></div> <div class="flex justify-between text-xs text-base-content/50 mt-1"><span> </span> <span> </span></div> <p class="text-xs text-base-content/70 mt-1"> </p></div> <div><!></div> <div class="rounded-xl bg-secondary/10 ring-1 ring-secondary/20 px-4 py-3 text-sm"><span class="text-base-content/70"> </span> <span class="font-bold text-base-content ml-1"> </span></div> <p class="text-xs text-base-content/50 text-center"> </p></div></div> <!>',1);function $3(a,n){Re(n,!0);const c=()=>re(xe,"$lang",b),s=()=>re(ge,"$inputs",b),[b,f]=Le(),d=85,i=95,g=m1(()=>Ne[c()]);let S=oe(!1);const y=12;function F(X){return Math.min(100,X/y*100)}const I={Cold:"badge-info",VeryCold:"badge-info",Standard:"badge-success",Warm:"badge-warning",Hot:"badge-error"},V={Low:"badge-warning",Medium:"badge-success",High:"badge-info",VeryHigh:"badge-error"},P=m1(()=>F(n.timing.bulkMax)),_=m1(()=>F(n.timing.bulkMin)),u=m1(()=>F(n.timing.proofMax)),j=m1(()=>F(n.timing.proofMin)),G=m1(()=>F(n.timing.coldRetardMin));var R=E3(),O=se(R),M=t(O),T=t(M),z=t(T),N=t(z,!0);e(z);var Y=o(z,2);e(T);var Z=o(T,2),q=t(Z),s1=t(q);e(q);var y1=o(q,2),r1=t(y1);e(y1);var o1=o(y1,2),x1=t(o1);e(o1),e(Z);var b1=o(Z,2),D=t(b1),h1=t(D),w1=t(h1,!0);e(h1);var L1=o(h1,2),A1=t(L1);e(L1),e(D);var P1=o(D,2),_1=t(P1),k1=o(_1,2);e(P1);var B1=o(P1,2),T1=t(B1),J1=t(T1,!0);e(T1);var $1=o(T1,2),K1=t($1,!0);e($1),e(B1);var I1=o(B1,2),E1=t(I1,!0);e(I1),e(b1);var d1=o(b1,2),g1=t(d1);{var N1=X=>{var W=N3(),i1=se(W),c1=t(i1),M1=t(c1,!0);e(c1);var F1=o(c1,2),G1=t(F1);e(F1),e(i1);var S1=o(i1,2),R1=t(S1),W1=o(R1,2);e(S1),L((Y1,D1)=>{l(M1,r(g).roomProof),l(G1,`${Y1??""} – ${D1??""}`),ae(R1,r(u)),ae(W1,r(j))},[()=>fe(n.timing.proofMin*60),()=>fe(n.timing.proofMax*60)]),k(X,W)},O1=X=>{var W=O3(),i1=se(W),c1=t(i1),M1=t(c1,!0);e(c1);var F1=o(c1,2),G1=t(F1);e(F1),e(i1);var S1=o(i1,2),R1=o(t(S1),2);e(S1);var W1=o(S1,2),Y1=t(W1,!0);e(W1),L(()=>{l(M1,r(g).coldRetardProof),l(G1,`${n.timing.coldRetardMin??""}h – ${n.timing.coldRetardMax??""}h`),ae(R1,r(G)),l(Y1,r(g).bakeColdNote)}),k(X,W)};v1(g1,X=>{n.proofMethod==="Room"?X(N1):X(O1,-1)})}e(d1);var e1=o(d1,2),B=t(e1),x=t(B,!0);e(B);var C=o(B,2),l1=t(C);e(C),e(e1);var u1=o(e1,2),j1=t(u1,!0);e(u1),e(M),e(O);var n1=o(O,2);{var J=X=>{var W=I3(),i1=t(W),c1=o(i1,2),M1=t(c1),F1=t(M1),G1=t(F1,!0);e(F1);var S1=o(F1,2);e(M1);var R1=o(M1,2),W1=t(R1),Y1=t(W1,!0);e(W1);var D1=o(W1,2),X1=t(D1),Se=t(X1,!0);e(X1);var ne=o(X1,2),Ce=t(ne,!0);e(ne),e(D1);var ye=o(D1,2),ce=t(ye),de=t(ce,!0);e(ce);var ue=o(ce,2),ze=t(ue,!0);e(ue),e(ye),e(R1);var Ae=o(R1,2),me=t(Ae),qe=t(me,!0);e(me),e(Ae),e(c1),e(W),L(()=>{U(i1,"aria-label",r(g).ariaLabels.closeTimingBarModal),l(G1,r(g).timingBarsModalTitle),U(S1,"aria-label",r(g).ariaLabels.closeButton),l(Y1,r(g).timingBarsModalIntro),l(Se,r(g).timingBarsBulkTitle),l(Ce,r(g).timingBarsBulkBody),l(de,r(g).timingBarsColdTitle),l(ze,r(g).timingBarsColdBody),l(qe,r(g).done)}),H("click",i1,()=>E(S,!1)),H("click",S1,()=>E(S,!1)),H("click",me,()=>E(S,!1)),k(X,W)};v1(n1,X=>{r(S)&&X(J)})}L((X,W,i1,c1,M1,F1,G1,S1)=>{l(N,r(g).timing),U(Y,"aria-label",r(g).ariaLabels.learnTimingBars),p1(q,1,`badge badge-soft ${I[n.formula.tempBand]??"badge-ghost"??""} badge-md font-medium`),l(s1,`${r(g).tempBands[n.formula.tempBand]??""} (${X??""})`),p1(y1,1,`badge badge-soft ${V[n.formula.hydrationBand]??"badge-ghost"??""} badge-md font-medium`),l(r1,`${r(g).hydrationBands[n.formula.hydrationBand]??""} ${r(g).hydration??""} (${W??""}%)`),l(x1,`${i1??""}% ${r(g).inoculation??""}`),l(w1,r(g).bulkFermentation),l(A1,`${c1??""} – ${M1??""}`),ae(_1,r(P)),ae(k1,r(_)),l(J1,r(g).fastest),l(K1,r(g).slowest),l(E1,F1),l(x,r(g).totalActiveTime),l(l1,`${G1??""} –
				${S1??""}`),l(j1,r(g).timingDisclaimer)},[()=>s().tempUnit==="F"?(n.formula.effectiveTempC*9/5+32).toFixed(1)+"°F":n.formula.effectiveTempC.toFixed(1)+"°C",()=>n.formula.finalHydrationPct.toFixed(1),()=>n.formula.inoculationPct.toFixed(1),()=>fe(n.timing.bulkMin*60),()=>fe(n.timing.bulkMax*60),()=>r(g).foldSchedule(n.timing.foldCount,n.timing.foldIntervalMins),()=>fe((n.timing.bulkMin+(n.proofMethod==="Room"?n.timing.proofMin:n.timing.coldRetardMin))*60+d),()=>fe((n.timing.bulkMax+(n.proofMethod==="Room"?n.timing.proofMax:n.timing.coldRetardMax))*60+i)]),H("click",Y,()=>E(S,!0)),k(a,R),De(),f()}nt(["click"]);var G3=$("<div> </div>"),W3=$("<div> </div>"),U3=$("<p> </p>"),V3=$('<li class="relative flex gap-3 pb-3 cursor-pointer select-none group pl-11" role="checkbox" tabindex="0"><div class="absolute top-0 bottom-0 w-px left-4 bg-secondary/20"></div> <div><span class="-rotate-45"><!></span></div> <div><div class="flex items-start justify-between gap-2"><span> </span> <div class="text-right shrink-0"><!></div></div> <!></div></li>'),q3=$('<div class="absolute bottom-0 w-px left-4 top-8 bg-secondary/20"></div>'),K3=$("<div> </div>"),Y3=$("<div> </div> <!>",1),Z3=$("<div> </div>"),J3=$("<p> </p>"),X3=$("<button><!></button>"),Q3=$('<div class="flex flex-wrap items-center gap-2 mt-2"></div>'),en=$('<li class="relative flex gap-4 pb-5 cursor-pointer select-none group" role="checkbox" tabindex="0"><!> <div><!></div> <div><div class="flex items-start justify-between gap-2"><span> </span> <div class="text-right shrink-0"><!></div></div> <!> <!></div></li>'),tn=$('<div class="shadow-sm card bg-base-100 ring-1 ring-base-300/70"><div class="p-5 card-body"><h2 class="mb-1 text-base font-semibold tracking-wide uppercase text-base-content"> </h2> <p class="mb-3 text-xs italic text-base-content/60"> </p> <ol class="relative space-y-0"></ol></div></div>');function an(a,n){Re(n,!0);const c=()=>re(xe,"$lang",s),[s,b]=Le(),f=m1(()=>Ne[c()]);let d=oe(P2(new Set)),i=oe(P2(new Map)),g=oe("");Ct(()=>{const M=JSON.stringify(n.steps.map(T=>T.label+"|"+T.durationMins+"|"+T.rangeMinMins));M!==r(g)&&(E(g,M,!0),E(d,new Set,!0),E(i,new Map,!0))});function S(M){const T=new Set(r(d));T.has(M)?T.delete(M):T.add(M),E(d,T,!0)}function y(M,T){const z=new Map(r(i)),N=new Set(z.get(M)??[]);N.has(T)?N.delete(T):N.add(T),z.set(M,N),E(i,z,!0);const Y=n.steps[M]?.setCount??0;if(Y>0&&N.size===Y){const Z=new Set(r(d));Z.add(M),E(d,Z,!0)}}function F(M,T){return r(i).get(M)?.has(T)??!1}const I=m1(()=>{let M=0;if(n.scheduleMode!=="clock"||!n.startTime)return n.steps.map(z=>{const N=z.isSubStep?-1:M++;return{step:z,clockTime:null,endClockTime:null,topLevelIndex:N}});let T=0;return n.steps.map(z=>{const N=z.isSubStep?-1:M++,Y=N2(n.startTime,T),Z=z.durationMins??(z.rangeMinMins!=null?z.rangeMinMins:0);T+=Z;const q=N2(n.startTime,T);return{step:z,clockTime:Y,endClockTime:q,topLevelIndex:N}})});function V(M){return M.durationMins!==null&&M.durationMins!==void 0?fe(M.durationMins):M.rangeMinMins!==void 0&&M.rangeMaxMins!==void 0?`${fe(M.rangeMinMins)} – ${fe(M.rangeMaxMins)}`:""}var P=tn(),_=t(P),u=t(_),j=t(u,!0);e(u);var G=o(u,2),R=t(G,!0);e(G);var O=o(G,2);te(O,21,()=>r(I),he,(M,T,z)=>{let N=()=>r(T).step,Y=()=>r(T).clockTime,Z=()=>r(T).endClockTime,q=()=>r(T).topLevelIndex;var s1=u2(),y1=se(s1);{var r1=x1=>{var b1=V3(),D=o(t(b1),2),h1=t(D),w1=t(h1);{var L1=d1=>{var g1=Me("✓");k(d1,g1)},A1=m1(()=>r(d).has(z));v1(w1,d1=>{r(A1)&&d1(L1)})}e(h1),e(D);var P1=o(D,2),_1=t(P1),k1=t(_1),B1=t(k1,!0);e(k1);var T1=o(k1,2),J1=t(T1);{var $1=d1=>{var g1=G3(),N1=t(g1,!0);e(g1),L(O1=>{p1(g1,1,`text-xs tabular-nums ${O1??""}`),l(N1,Y())},[()=>r(d).has(z)?"text-base-content/40 line-through":"text-secondary/70"]),k(d1,g1)},K1=d1=>{var g1=W3(),N1=t(g1,!0);e(g1),L((O1,e1)=>{p1(g1,1,`text-xs tabular-nums ${O1??""}`),l(N1,e1)},[()=>r(d).has(z)?"text-base-content/40 line-through":"text-secondary/70",()=>V(N())]),k(d1,g1)};v1(J1,d1=>{n.scheduleMode==="clock"&&Y()?d1($1):d1(K1,-1)})}e(T1),e(_1);var I1=o(_1,2);{var E1=d1=>{var g1=U3(),N1=t(g1,!0);e(g1),L(O1=>{p1(g1,1,`text-[11px] mt-0.5 leading-snug ${O1??""}`),l(N1,N().notes)},[()=>r(d).has(z)?"text-base-content/25 line-through":"text-base-content/55"]),k(d1,g1)};v1(I1,d1=>{N().notes&&d1(E1)})}e(P1),e(b1),L((d1,g1,N1,O1)=>{U(b1,"aria-checked",d1),p1(D,1,`shrink-0 w-5 h-5 rounded-sm rotate-45 text-[9px] font-bold flex items-center justify-center z-10 transition-colors mt-0.5
							${g1??""}`),p1(P1,1,`flex-1 min-w-0 transition-opacity ${N1??""}`),p1(k1,1,`text-xs font-medium leading-tight transition-colors
									${O1??""}`),l(B1,N().label)},[()=>r(d).has(z),()=>r(d).has(z)?"bg-success/15 text-success":"bg-secondary/10 text-secondary/70 group-hover:bg-secondary/20",()=>r(d).has(z)?"opacity-50":"",()=>r(d).has(z)?"text-base-content/40 line-through":"text-base-content/80"]),H("click",b1,()=>S(z)),H("keydown",b1,d1=>{(d1.key==="Enter"||d1.key===" ")&&(d1.preventDefault(),S(z))}),k(x1,b1)},o1=x1=>{var b1=en(),D=t(b1);{var h1=B=>{var x=q3();k(B,x)};v1(D,B=>{z<r(I).length-1&&B(h1)})}var w1=o(D,2),L1=t(w1);{var A1=B=>{var x=Me("✓");k(B,x)},P1=m1(()=>r(d).has(z)),_1=B=>{var x=Me();L(()=>l(x,q()+1)),k(B,x)};v1(L1,B=>{r(P1)?B(A1):B(_1,-1)})}e(w1);var k1=o(w1,2),B1=t(k1),T1=t(B1),J1=t(T1,!0);e(T1);var $1=o(T1,2),K1=t($1);{var I1=B=>{var x=Y3(),C=se(x),l1=t(C,!0);e(C);var u1=o(C,2);{var j1=n1=>{var J=K3(),X=t(J);e(J),L(W=>{p1(J,1,`text-xs text-base-content/50 tabular-nums ${W??""}`),l(X,`→ ${Z()??""}`)},[()=>r(d).has(z)?"line-through":""]),k(n1,J)};v1(u1,n1=>{Z()&&Z()!==Y()&&n1(j1)})}L(n1=>{p1(C,1,`text-xs font-bold tabular-nums ${n1??""}`),l(l1,Y())},[()=>r(d).has(z)?"text-base-content/50 line-through":"text-secondary"]),k(B,x)},E1=B=>{var x=Z3(),C=t(x,!0);e(x),L((l1,u1)=>{p1(x,1,`text-xs font-bold tabular-nums ${l1??""}`),l(C,u1)},[()=>r(d).has(z)?"text-base-content/50 line-through":"text-secondary",()=>V(N())]),k(B,x)};v1(K1,B=>{n.scheduleMode==="clock"&&Y()?B(I1):B(E1,-1)})}e($1),e(B1);var d1=o(B1,2);{var g1=B=>{var x=J3(),C=t(x,!0);e(x),L(l1=>{p1(x,1,`text-xs mt-1 leading-snug ${l1??""}`),l(C,N().notes)},[()=>r(d).has(z)?"text-base-content/30 line-through":"text-base-content/70"]),k(B,x)};v1(d1,B=>{N().notes&&B(g1)})}var N1=o(d1,2);{var O1=B=>{var x=Q3();te(x,21,()=>Array.from({length:N().setCount},(C,l1)=>l1),he,(C,l1)=>{var u1=X3(),j1=t(u1);{var n1=W=>{var i1=Me("✓");k(W,i1)},J=m1(()=>F(z,r(l1))),X=W=>{var i1=Me();L(()=>l(i1,r(l1)+1)),k(W,i1)};v1(j1,W=>{r(J)?W(n1):W(X,-1)})}e(u1),L(W=>p1(u1,1,`w-7 h-7 rounded-full font-bold text-xs flex items-center justify-center transition-colors ${W??""}`),[()=>F(z,r(l1))?"bg-success/15 text-success":"bg-secondary/15 text-secondary hover:bg-secondary/25"]),H("click",u1,W=>{W.stopPropagation(),y(z,r(l1))}),k(C,u1)}),e(x),k(B,x)},e1=m1(()=>N().setCount&&!r(d).has(z));v1(N1,B=>{r(e1)&&B(O1)})}e(k1),e(b1),L((B,x,C,l1)=>{U(b1,"aria-checked",B),p1(w1,1,`shrink-0 w-8 h-8 rounded-full font-bold text-xs flex items-center justify-center z-10 transition-colors
							${x??""}`),p1(k1,1,`flex-1 min-w-0 transition-opacity ${C??""}`),p1(T1,1,`text-sm font-semibold leading-tight transition-colors
									${l1??""}`),l(J1,N().label)},[()=>r(d).has(z),()=>r(d).has(z)?"bg-success/15 text-success":"bg-secondary/15 text-secondary group-hover:bg-secondary/25",()=>r(d).has(z)?"opacity-50":"",()=>r(d).has(z)?"text-base-content/50 line-through":"text-base-content"]),H("click",b1,()=>S(z)),H("keydown",b1,B=>{(B.key==="Enter"||B.key===" ")&&(B.preventDefault(),S(z))}),k(x1,b1)};v1(y1,x1=>{N().isSubStep?x1(r1):x1(o1,-1)})}k(M,s1)}),e(O),e(_),e(P),L(()=>{l(j,r(f).schedule),l(R,r(f).scheduleComplete)}),k(a,P),De(),b()}nt(["click","keydown"]);var rn=$('<div class="card bg-base-100 shadow-sm ring-1 ring-base-300/70"><div class="card-body p-5"><h2 class="text-base font-semibold text-base-content uppercase tracking-wide mb-3"> </h2> <div class="text-sm text-base-content space-y-2"><p><span class="font-semibold text-secondary"> </span> </p> <p><span class="font-semibold text-warning"> </span> </p> <p><span class="font-semibold text-error"> </span> </p></div> <div class="mt-4 pt-4 border-t border-base-200 text-xs text-base-content/70 space-y-1"><p><strong> </strong> </p> <p><strong> </strong> </p> <p><strong> </strong> </p></div></div></div>');function nn(a,n){Re(n,!0);const c=()=>re(xe,"$lang",s),[s,b]=Le(),f=m1(()=>Ne[c()]),d=m1(()=>r(f).guidance[n.crumbGoal]),i=m1(()=>r(f).crumbGoalNames[n.crumbGoal]);var g=rn(),S=t(g),y=t(S),F=t(y,!0);e(y);var I=o(y,2),V=t(I),P=t(V),_=t(P,!0);e(P);var u=o(P);e(V);var j=o(V,2),G=t(j),R=t(G,!0);e(G);var O=o(G);e(j);var M=o(j,2),T=t(M),z=t(T,!0);e(T);var N=o(T);e(M),e(I);var Y=o(I,2),Z=t(Y),q=t(Z),s1=t(q,!0);e(q);var y1=o(q);e(Z);var r1=o(Z,2),o1=t(r1),x1=t(o1,!0);e(o1);var b1=o(o1);e(r1);var D=o(r1,2),h1=t(D),w1=t(h1,!0);e(h1);var L1=o(h1);e(D),e(Y),e(S),e(g),L(A1=>{l(F,r(f).readingYourCrumb),l(_,A1),l(u,` ${r(d).description??""}`),l(R,r(f).underFermented),l(O,` ${r(d).underFermented??""}`),l(z,r(f).overFermented),l(N,` ${r(d).overFermented??""}`),l(s1,r(f).floatTest),l(y1,` ${r(f).floatTestDesc??""}`),l(x1,r(f).pokeTest),l(b1,` ${r(f).pokeTestDesc??""}`),l(w1,r(f).jiggleTest),l(L1,` ${r(f).jiggleTestDesc??""}`)},[()=>r(f).target(r(i))]),k(a,g),De(),b()}var on=$('<div class="flex justify-between items-center py-2 border-b border-base-200"><dt class="text-sm text-base-content/70"> </dt> <dd class="text-sm font-semibold text-base-content tabular-nums"> </dd></div>'),sn=$('<button type="button" class="fixed inset-0 z-40 bg-neutral/40 backdrop-blur-sm"></button> <div class="fixed bottom-0 left-0 right-0 z-50 max-h-[70vh] overflow-y-auto rounded-t-2xl bg-base-100 shadow-xl ring-1 ring-base-300/80" role="dialog" aria-modal="true"><div class="sticky top-0 flex items-center justify-between px-5 py-4 bg-base-100/95 backdrop-blur border-b border-base-200"><h2 class="text-base font-semibold text-base-content"> </h2> <button type="button" class="btn btn-ghost btn-sm btn-circle"><svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12"></path></svg></button></div> <div class="px-5 py-4"><p class="text-sm text-base-content/70 mb-4"> </p> <dl class="space-y-2"></dl></div> <div class="px-5 pb-6"><button type="button" class="btn btn-primary w-full"> </button></div></div>',1);function ln(a,n){Re(n,!0);const c=()=>re(xe,"$lang",b),s=()=>re(c2,"$assumptionsOpen",b),[b,f]=Le(),d=m1(()=>Ne[c()]);function i(){c2.set(!1)}var g=u2(),S=se(g);{var y=F=>{var I=sn(),V=se(I),P=o(V,2),_=t(P),u=t(_),j=t(u,!0);e(u);var G=o(u,2);e(_);var R=o(_,2),O=t(R),M=t(O,!0);e(O);var T=o(O,2);te(T,21,()=>Object.entries(n.assumptions),he,(Z,q)=>{var s1=m1(()=>lr(r(q),2));let y1=()=>r(s1)[0],r1=()=>r(s1)[1];var o1=on(),x1=t(o1),b1=t(x1,!0);e(x1);var D=o(x1,2),h1=t(D,!0);e(D),e(o1),L(()=>{l(b1,y1()),l(h1,r1())}),k(Z,o1)}),e(T),e(R);var z=o(R,2),N=t(z),Y=t(N,!0);e(N),e(z),e(P),L(()=>{U(V,"aria-label",r(d).ariaLabels.closeAssumptionsDrawer),U(P,"aria-label",r(d).calculationAssumptions),l(j,r(d).calculationAssumptions),U(G,"aria-label",r(d).ariaLabels.closeButton),l(M,r(d).assumptionsDesc),l(Y,r(d).done)}),H("click",V,i),H("click",G,i),H("click",N,i),k(F,I)};v1(S,F=>{s()&&F(y)})}k(a,g),De(),f()}nt(["click"]);var cn=$('<div class="install-cta-row border-b border-neutral-content/15 bg-neutral/70 svelte-1uha8ag"><div class="max-w-2xl mx-auto px-4 py-2 flex justify-end"><button type="button"> </button></div></div>'),dn=$("<!> <!> <!> <!>",1),un=$('<div class="card bg-base-100/95 shadow-sm ring-1 ring-base-300/70"><div class="card-body items-center text-center"><div class="text-4xl mb-3" aria-hidden="true">⚖️</div> <p class="text-base-content/70 font-medium"> </p> <p class="text-base-content/50 text-sm mt-1"> </p></div></div>'),mn=$('<dialog class="modal modal-open" aria-modal="true" aria-labelledby="install-help-title"><div class="modal-box max-w-lg"><h3 id="install-help-title" class="text-lg font-semibold"> </h3> <p class="mt-2 text-sm text-base-content/80"> </p> <ul class="mt-3 list-disc space-y-2 pl-5 text-sm leading-relaxed text-base-content/90"><li> </li> <li> </li> <li> </li></ul> <div class="modal-action"><button type="button" class="btn btn-primary btn-sm rounded-full"> </button></div></div> <form method="dialog" class="modal-backdrop"><button type="button"> </button></form></dialog>'),pn=$('<div class="min-h-screen bg-gradient-to-b from-base-200 via-base-200 to-base-300/40"><header class="bg-neutral/95 text-neutral-content border-b border-primary/25 shadow-sm backdrop-blur supports-[backdrop-filter]:bg-neutral/90 sticky top-0 z-30"><!> <div class="max-w-2xl mx-auto px-4 py-4 flex flex-wrap items-center justify-between gap-y-3"><div class="flex items-center gap-3 min-w-0"><span class="flex h-9 w-9 shrink-0 items-center justify-center rounded-xl bg-primary/20 text-xl text-primary ring-1 ring-primary/35" aria-hidden="true">🍞</span> <div><h1 class="text-base font-bold text-neutral-content leading-tight">DoughCulator</h1> <p class="text-xs text-neutral-content/70 leading-tight"> </p></div></div> <div class="flex items-center flex-wrap justify-end gap-2"><label class="swap swap-rotate inline-grid h-9 w-9 place-items-center rounded-full border border-transparent bg-transparent text-neutral-content/75 transition-colors duration-200 hover:border-neutral-content/35 hover:bg-neutral-content/10 hover:text-neutral-content focus-within:border-primary/45 focus-within:ring-2 focus-within:ring-primary/55 focus-within:ring-offset-2 focus-within:ring-offset-neutral/95"><input type="checkbox" class="sr-only appearance-none"/> <svg class="swap-on h-5 w-5 fill-current" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M5.64,17l-.71.71a1,1,0,0,0,0,1.41,1,1,0,0,0,1.41,0l.71-.71A1,1,0,0,0,5.64,17ZM5,12a1,1,0,0,0-1-1H3a1,1,0,0,0,0,2H4A1,1,0,0,0,5,12Zm7-7a1,1,0,0,0,1-1V3a1,1,0,0,0-2,0V4A1,1,0,0,0,12,5ZM5.64,7.05a1,1,0,0,0,.7.29,1,1,0,0,0,.71-.29,1,1,0,0,0,0-1.41l-.71-.71A1,1,0,0,0,4.93,6.34Zm12,.29a1,1,0,0,0,.7-.29l.71-.71a1,1,0,1,0-1.41-1.41L17,5.64a1,1,0,0,0,0,1.41A1,1,0,0,0,17.66,7.34ZM21,11H20a1,1,0,0,0,0,2h1a1,1,0,0,0,0-2Zm-9,8a1,1,0,0,0-1,1v1a1,1,0,0,0,2,0V20A1,1,0,0,0,12,19ZM18.36,17A1,1,0,0,0,17,18.36l.71.71a1,1,0,0,0,1.41,0,1,1,0,0,0,0-1.41ZM12,6.5A5.5,5.5,0,1,0,17.5,12,5.51,5.51,0,0,0,12,6.5Zm0,9A3.5,3.5,0,1,1,15.5,12,3.5,3.5,0,0,1,12,15.5Z"></path></svg> <svg class="swap-off h-5 w-5 fill-current" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M21.64,13a1,1,0,0,0-1.05-.14,8.05,8.05,0,0,1-3.37.73A8.15,8.15,0,0,1,9.08,5.49a8.59,8.59,0,0,1,.25-2A1,1,0,0,0,8,2.36,10.14,10.14,0,1,0,22,14.05,1,1,0,0,0,21.64,13Zm-9.5,6.69A8.14,8.14,0,0,1,7.08,5.22v.27A10.15,10.15,0,0,0,17.22,15.63a9.79,9.79,0,0,0,2.1-.22A8.11,8.11,0,0,1,12.14,19.73Z"></path></svg></label> <div class="join border border-neutral-content/25 rounded-full bg-neutral-content/5 p-0.5"><button type="button">EN</button> <button type="button">ES</button> <button type="button">SV</button></div> <button type="button" class="btn btn-outline btn-sm rounded-full border-neutral-content/25 text-neutral-content/80 hover:border-neutral-content/40 hover:bg-neutral-content/10 hover:text-neutral-content"> </button> <button type="button"> </button></div></div></header> <main class="max-w-2xl mx-auto px-4 py-6 space-y-4"><!> <!></main> <footer class="max-w-2xl mx-auto px-4 py-8 text-center text-xs text-base-content/60"><p> </p> <p class="mt-1"> </p> <div class="mt-6 flex justify-center"><a href="https://www.buymeacoffee.com/alestryperez" target="_blank" rel="noopener noreferrer"><img src="https://cdn.buymeacoffee.com/buttons/v2/default-yellow.png" alt="Buy Me A Coffee" style="height: 60px !important; width: 217px !important;" loading="lazy"/></a></div></footer> <!></div> <!>',1);function xn(a,n){Re(n,!0);const c=()=>re(xe,"$lang",f),s=()=>re(Y2,"$result",f),b=()=>re(ge,"$inputs",f),[f,d]=Le(),i=m1(()=>Ne[c()]);let g=oe(!1),S=oe(null),y=oe(!1),F=oe("idle");function I(){const x=s().formula,C=s().schedule,l1=s().assumptions,u1=C.map((n1,J)=>{let X="";return n1.durationMins!==null&&n1.durationMins!==void 0?X=fe(n1.durationMins):n1.rangeMinMins!==void 0&&n1.rangeMaxMins!==void 0&&(X=`${fe(n1.rangeMinMins)} – ${fe(n1.rangeMaxMins)}`),`${J+1}. ${n1.label}${X?" ("+X+")":""}${n1.notes?" — "+n1.notes:""}`}),j1=Object.entries(l1).map(([n1,J])=>`${n1}: ${J}`);return[r(i).copyTitle,r(i).copyDivider,`${r(i).totalFlourRow}: ${Math.round(x.totalFlourG)}g (${b().flourBlend.map(n1=>`${r(i).flourTypes[n1.type]??n1.type}: ${Math.round(x.totalFlourG*n1.pct/100)}g`).join(", ")})`,`${r(i).water}: ${Math.round(x.totalWaterG)}g (${x.finalHydrationPct.toFixed(1)}%)`,`${r(i).saltRow}: ${Math.round(x.saltG)}g`,`${r(i).starter}: ${Math.round(x.starterTotalG)}g`,"",r(i).copyScheduleHeader,r(i).copyScheduleDivider,...u1,"",r(i).copyAssumptionsHeader,r(i).copyAssumptionsDivider,...j1,"",r(i).copyFooter].join(`
`)}async function V(){const x=I();try{if(!navigator.clipboard?.writeText)throw new Error("Clipboard API unavailable");await navigator.clipboard.writeText(x),E(g,!0),setTimeout(()=>E(g,!1),2500)}catch{const C=document.createElement("textarea");C.value=x,C.setAttribute("readonly",""),C.style.position="fixed",C.style.opacity="0",C.style.pointerEvents="none",document.body.appendChild(C),C.focus(),C.select();try{document.execCommand("copy")&&(E(g,!0),setTimeout(()=>E(g,!1),2500))}finally{document.body.removeChild(C)}}}function P(){c2.set(!0)}function _(x){xe.set(x)}function u(){if(typeof window>"u")return!1;const x=navigator;return window.matchMedia("(display-mode: standalone)").matches||x.standalone===!0}async function j(){if(u()){E(F,"installed");return}if(!r(S)){E(y,!0);return}await r(S).prompt();const{outcome:x}=await r(S).userChoice;E(F,x,!0),E(S,null),E(y,!1)}function G(){E(y,!1)}const R=m1(()=>b().totalFlourInputG);let O=oe(!1);Ct(()=>{if(u()){E(F,"installed"),E(S,null);return}const x=l1=>{const u1=l1;u1.preventDefault(),E(S,u1,!0),E(F,"idle")},C=()=>{E(F,"installed"),E(S,null),E(y,!1)};return window.addEventListener("beforeinstallprompt",x),window.addEventListener("appinstalled",C),()=>{window.removeEventListener("beforeinstallprompt",x),window.removeEventListener("appinstalled",C)}}),Ct(()=>{E(O,localStorage.getItem("theme")==="dark")}),Ct(()=>{const x=r(O)?"dark":"bumblebee";document.documentElement.setAttribute("data-theme",x),localStorage.setItem("theme",x)});var M=pn();dr("1uha8ag",x=>{G2(()=>{ir.title="DoughCulator"})});var T=se(M),z=t(T),N=t(z);{var Y=x=>{var C=cn(),l1=t(C),u1=t(l1),j1=t(u1,!0);e(u1),e(l1),e(C),L(()=>{p1(u1,1,`btn btn-xs sm:btn-sm rounded-full shadow-sm ${r(S)?"btn-primary":"btn-outline border-neutral-content/30 text-neutral-content hover:border-neutral-content/45 hover:bg-neutral-content/10 hover:text-neutral-content"}`),l(j1,r(i).saveToHomeScreen)}),H("click",u1,j),k(x,C)};v1(N,x=>{r(F)!=="installed"&&x(Y)})}var Z=o(N,2),q=t(Z),s1=o(t(q),2),y1=o(t(s1),2),r1=t(y1,!0);e(y1),e(s1),e(q);var o1=o(q,2),x1=t(o1),b1=t(x1);le(b1),rt(4),e(x1);var D=o(x1,2),h1=t(D),w1=o(h1,2),L1=o(w1,2);e(D);var A1=o(D,2),P1=t(A1,!0);e(A1);var _1=o(A1,2),k1=t(_1,!0);e(_1),e(o1),e(Z),e(z);var B1=o(z,2),T1=t(B1);H3(T1,{});var J1=o(T1,2);{var $1=x=>{var C=dn(),l1=se(C);L3(l1,{get formula(){return s().formula},get flourBlend(){return b().flourBlend}});var u1=o(l1,2);$3(u1,{get timing(){return s().timing},get formula(){return s().formula},get proofMethod(){return b().proofMethod}});var j1=o(u1,2);{let J=m1(()=>b().scheduleMode==="clock"?b().startTime??"08:00":null);an(j1,{get steps(){return s().schedule},get scheduleMode(){return b().scheduleMode},get startTime(){return r(J)}})}var n1=o(j1,2);nn(n1,{get crumbGoal(){return b().crumbGoal}}),k(x,C)},K1=x=>{var C=un(),l1=t(C),u1=o(t(l1),2),j1=t(u1,!0);e(u1);var n1=o(u1,2),J=t(n1,!0);e(n1),e(l1),e(C),L(()=>{l(j1,r(i).emptyStateTitle),l(J,r(i).emptyStateSubtitle)}),k(x,C)};v1(J1,x=>{r(R)>0?x($1):x(K1,-1)})}e(B1);var I1=o(B1,2),E1=t(I1),d1=t(E1,!0);e(E1);var g1=o(E1,2),N1=t(g1,!0);e(g1),rt(2),e(I1);var O1=o(I1,2);{var e1=x=>{var C=mn(),l1=t(C),u1=t(l1),j1=t(u1,!0);e(u1);var n1=o(u1,2),J=t(n1,!0);e(n1);var X=o(n1,2),W=t(X),i1=t(W,!0);e(W);var c1=o(W,2),M1=t(c1,!0);e(c1);var F1=o(c1,2),G1=t(F1,!0);e(F1),e(X);var S1=o(X,2),R1=t(S1),W1=t(R1,!0);e(R1),e(S1),e(l1);var Y1=o(l1,2),D1=t(Y1),X1=t(D1,!0);e(D1),e(Y1),e(C),L(()=>{l(j1,r(i).installHelpTitle),l(J,r(i).installHelpIntro),l(i1,r(i).installHelpIOS),l(M1,r(i).installHelpAndroid),l(G1,r(i).installHelpDesktop),l(W1,r(i).close),U(D1,"aria-label",r(i).close),l(X1,r(i).close)}),H("click",R1,G),H("click",D1,G),k(x,C)};v1(O1,x=>{r(y)&&x(e1)})}e(T);var B=o(T,2);ln(B,{get assumptions(){return s().assumptions}}),L(()=>{l(r1,r(i).appSubtitle),U(x1,"aria-label",r(i).ariaLabels.toggleDarkMode),U(D,"aria-label",r(i).ariaLabels.selectLanguage),p1(h1,1,`btn btn-xs join-item rounded-l-full border-0 ${c()==="en"?"btn-primary":"btn-ghost text-neutral-content/70 hover:text-neutral-content hover:bg-neutral-content/10"}`),p1(w1,1,`btn btn-xs join-item border-0 ${c()==="es"?"btn-primary":"btn-ghost text-neutral-content/70 hover:text-neutral-content hover:bg-neutral-content/10"}`),p1(L1,1,`btn btn-xs join-item rounded-r-full border-0 ${c()==="sv"?"btn-primary":"btn-ghost text-neutral-content/70 hover:text-neutral-content hover:bg-neutral-content/10"}`),l(P1,r(i).assumptions),_1.disabled=r(R)<=0,p1(_1,1,`btn btn-sm rounded-full shadow-sm ${r(g)?"btn-success":r(R)>0?"btn-primary":"btn-disabled"}`),l(k1,r(g)?r(i).copied:r(i).copyRecipe),l(d1,r(i).footerLine1),l(N1,r(i).footerLine2)}),_r(b1,()=>r(O),x=>E(O,x)),H("click",h1,()=>_("en")),H("click",w1,()=>_("es")),H("click",L1,()=>_("sv")),H("click",A1,P),H("click",_1,V),k(a,M),De(),d()}nt(["click"]);export{xn as component};
