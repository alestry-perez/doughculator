...
m74 -27 c18 -7 22 -34 5 -34 -17 0 -49 20 -49 30 0 11 21 13 44 4z"></path></g></g></svg>`);function e3(a,n){let c=mt(n,"class",3,"");var s=Qr();N(()=>p1(s,0,We(c()))),k(a,s)}var t3=B2('<circle cx="100" cy="100" fill="none" stroke-width="18" stroke-linecap="butt" transform="rotate(-90 100 100)" class="transition-all duration-300"></circle>'),a3=O('<span class="flex items-center gap-1 text-xs text-base-content/50 tabular-nums"><span class="inline-block w-2 h-2 rounded-full flex-shrink-0"></span> </span>'),r3=O('<div class="flex flex-wrap justify-center gap-x-3 gap-y-0.5 mt-1"></div>'),n3=O('<button type="button"> </button>'),o3=O('<div class="flex items-center gap-2"><span class="inline-block w-3 h-3 rounded-full flex-shrink-0"></span> <span class="text-xs text-base-content/70 flex-1 min-w-0 truncate"> </span> <div class="flex items-center gap-2 flex-1"><input type="range" min="0" max="100" step="1" class="range range-sm range-secondary flex-1"/> <input type="number" min="0" max="100" step="1" class="input input-xs w-14 text-right tabular-nums"/> <span class="text-xs text-base-content/70">%</span></div></div>'),s3=O('<button type="button" class="btn btn-xs btn-ghost text-secondary border border-secondary/30"> </button>'),l3=O('<div class="mt-3 space-y-2"></div> <div class="flex items-center justify-between mt-2"><span class="text-xs text-base-content/50"> <span> </span></span> <!></div>',1),i3=O('<div class="px-5 pb-3"><!></div>'),c3=O('<button type="button"><!> <span class="text-xs font-bold"> </span></button>'),d3=O('<button type="button"> </button>'),u3=O('<button type="button"> </button>'),m3=O('<div class="form-control mt-3 pl-4 border-l-2 border-secondary/20"><label for="fridge-temp" class="label"><span class="label-text text-xs font-semibold text-base-content/70 uppercase tracking-wide"> </span></label> <input id="fridge-temp" type="number" step="0.5" class="input border-0 border-b-2 border-base-300 rounded-none focus:border-secondary focus:outline-none bg-transparent w-full"/></div>'),p3=O('<button type="button"> </button>'),v3=O('<div class="form-control mt-3 pl-4 border-l-2 border-secondary/20"><label for="start-time" class="label"><span class="label-text text-xs font-semibold text-base-content/70 uppercase tracking-wide"> </span></label> <input id="start-time" type="time" class="input border-0 border-b-2 border-base-300 rounded-none focus:border-secondary focus:outline-none bg-transparent w-full"/></div>'),g3=O('<div class="form-control"><input id="salt-pct" type="number" min="1" max="3" step="0.1" class="input border-0 border-b-2 border-base-300 rounded-none focus:border-secondary focus:outline-none bg-transparent w-full" placeholder="2.0"/></div> <p class="text-xs text-base-content/50 mt-1"> </p>',1),f3=O('<div class="form-control"><input id="starter-hyd" type="number" min="50" max="200" step="5" class="input border-0 border-b-2 border-base-300 rounded-none focus:border-secondary focus:outline-none bg-transparent w-full"/></div>'),b3=O('<div><div class="flex justify-between text-xs text-base-content/70 mb-1"><span> </span> <span class="font-semibold text-base-content"> </span></div> <progress class="progress progress-secondary progress-sm w-full"></progress> <div class="flex justify-between text-xs text-base-content/50 mt-0.5"><span></span> <span></span></div></div>'),h3=O('<div class="modal modal-open"><button type="button" class="modal-backdrop"></button> <div class="modal-box w-full max-w-sm p-0 overflow-hidden" role="dialog" aria-modal="true" aria-labelledby="philosophy-modal-title"><div class="flex items-center justify-between px-5 py-4 border-b border-base-200"><h2 id="philosophy-modal-title" class="text-base font-semibold text-base-content"> </h2> <button type="button" class="btn btn-ghost btn-sm btn-circle"><svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12"></path></svg></button></div> <div class="px-5 py-4 space-y-4"><div><p class="text-xs font-semibold text-secondary uppercase tracking-wide mb-1"> </p> <p class="text-sm text-base-content/70 leading-relaxed"> </p></div> <div class="border-t border-base-200 pt-4"><p class="text-xs font-semibold text-secondary uppercase tracking-wide mb-1"> </p> <p class="text-sm text-base-content/70 leading-relaxed"> </p></div></div> <div class="px-5 pb-5"><button type="button" class="btn btn-primary w-full"> </button></div></div></div>'),M3=O("<li> </li>"),x3=O("<li> </li>"),z3=O('<div class="modal modal-open"><button type="button" class="modal-backdrop"></button> <div class="modal-box w-full max-w-md p-0 overflow-hidden" role="dialog" aria-modal="true" aria-labelledby="autolyse-modal-title"><div class="flex items-center justify-between px-5 py-4 border-b border-base-200"><h2 id="autolyse-modal-title" class="text-base font-semibold text-base-content"> </h2> <button type="button" class="btn btn-ghost btn-sm btn-circle"><svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12"></path></svg></button></div> <div class="px-5 py-4 space-y-4"><p class="text-sm text-base-content/70 leading-relaxed"> </p> <div><p class="text-xs font-semibold text-success uppercase tracking-wide mb-1"> </p> <ul class="list-disc pl-5 space-y-1 text-sm text-base-content/70 leading-relaxed"></ul></div> <div class="border-t border-base-200 pt-4"><p class="text-xs font-semibold text-warning uppercase tracking-wide mb-1"> </p> <ul class="list-disc pl-5 space-y-1 text-sm text-base-content/70 leading-relaxed"></ul></div></div> <div class="px-5 pb-5"><button type="button" class="btn btn-primary w-full"> </button></div></div></div>'),y3=O('<div class="modal modal-open"><button type="button" class="modal-backdrop"></button> <div class="modal-box w-full max-w-sm p-0 overflow-hidden" role="dialog" aria-modal="true" aria-labelledby="proof-method-modal-title"><div class="flex items-center justify-between px-5 py-4 border-b border-base-200"><h2 id="proof-method-modal-title" class="text-base font-semibold text-base-content"> </h2> <button type="button" class="btn btn-ghost btn-sm btn-circle"><svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12"></path></svg></button></div> <div class="px-5 py-4 space-y-4"><div><p class="text-xs font-semibold text-secondary uppercase tracking-wide mb-1"> </p> <p class="text-sm text-base-content/70 leading-relaxed"> </p></div> <div class="border-t border-base-200 pt-4"><p class="text-xs font-semibold text-secondary uppercase tracking-wide mb-1"> </p> <p class="text-sm text-base-content/70 leading-relaxed"> </p></div></div> <div class="px-5 pb-5"><button type="button" class="btn btn-primary w-full"> </button></div></div></div>'),_3=O('<div class="card bg-base-100 shadow-sm ring-1 ring-base-300/70 overflow-hidden"><div class="px-5 pt-5 pb-3"><h2 class="text-base font-semibold text-base-content uppercase tracking-wide"> </h2></div> <div class="px-5 pb-5 space-y-5"><div class="flex flex-col items-center"><div class="relative w-44 h-44"><svg viewBox="0 0 200 200" class="w-full h-full"><circle cx="100" cy="100" fill="none" class="stroke-base-300/30" stroke-width="18"></circle><!></svg> <div class="absolute inset-0 flex flex-col items-center justify-center pointer-events-none"><div class="flex items-baseline pointer-events-auto"><input id="total-flour" type="number" min="0" step="50" class="w-28 bg-transparent border-none text-center text-3xl font-bold text-base-content focus:outline-none tabular-nums [appearance:textfield] [&amp;::-webkit-outer-spin-button]:appearance-none [&amp;::-webkit-inner-spin-button]:appearance-none" placeholder="500"/> <span class="text-lg font-bold text-base-content/70 -ml-1">g</span></div> <span class="text-xs text-base-content/50"> </span></div></div> <!></div> <div><span class="text-xs font-semibold text-base-content/70 uppercase tracking-wide"> </span> <div class="grid grid-cols-3 gap-2 mt-2"></div> <!></div> <div><div class="flex items-center justify-between mb-2"><span class="text-xs font-semibold text-base-content/70 uppercase tracking-wide"> </span> <button type="button" class="btn btn-ghost btn-xs rounded-full border border-base-300 bg-base-100"><span>°C</span> <span class="text-base-content/30">/</span> <span>°F</span></button></div> <div class="grid grid-cols-2 gap-3"><div class="form-control"><label for="ambient-temp" class="label py-1"><span class="label-text text-xs text-base-content/70"> </span></label> <input id="ambient-temp" type="number" step="0.5" class="input border-0 border-b-2 border-base-300 rounded-none focus:border-secondary focus:outline-none bg-transparent w-full"/></div> <div class="form-control"><label for="dough-temp" class="label py-1"><span class="label-text text-xs text-base-content/70"> <span class="text-base-content/40"> </span></span></label> <input id="dough-temp" type="number" step="0.5" class="input border-0 border-b-2 border-base-300 rounded-none focus:border-secondary focus:outline-none bg-transparent w-full placeholder:text-base-content/30"/></div></div></div></div> <!> <div class="border-t border-base-200"><div class="px-5 py-3"><span class="text-xs font-semibold text-base-content/70 uppercase tracking-wide"> </span></div> <div class="px-5 pb-5 space-y-5"><div><p class="text-xs font-semibold text-base-content/70 uppercase tracking-wide mb-2"> </p> <div class="grid grid-cols-3 gap-2"></div> <p class="text-xs text-base-content/70 mt-2 leading-snug"> </p></div> <div><div class="flex items-center gap-1.5 mb-2"><p class="text-xs font-semibold text-base-content/70 uppercase tracking-wide"> </p> <button type="button" class="btn btn-ghost btn-xs btn-circle flex-shrink-0"><svg xmlns="http://www.w3.org/2000/svg" class="w-[1.14rem] h-[1.14rem]" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true"><path fill-rule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7-4a1 1 0 11-2 0 1 1 0 012 0zM9 9a1 1 0 000 2v3a1 1 0 001 1h1a1 1 0 100-2v-3a1 1 0 00-1-1H9z" clip-rule="evenodd"></path></svg></button></div> <div class="grid grid-cols-2 gap-2"></div> <p class="text-xs text-base-content/70 mt-2 leading-snug"> </p></div> <div><div class="flex items-center gap-1.5 mb-2"><p class="text-xs font-semibold text-base-content/70 uppercase tracking-wide"> </p> <button type="button" class="btn btn-ghost btn-xs btn-circle flex-shrink-0"><svg xmlns="http://www.w3.org/2000/svg" class="w-[1.14rem] h-[1.14rem]" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true"><path fill-rule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7-4a1 1 0 11-2 0 1 1 0 012 0zM9 9a1 1 0 000 2v3a1 1 0 001 1h1a1 1 0 100-2v-3a1 1 0 00-1-1H9z" clip-rule="evenodd"></path></svg></button></div> <div class="grid grid-cols-2 gap-2"></div> <!></div> <div><p class="text-xs font-semibold text-base-content/70 uppercase tracking-wide mb-2"> </p> <div class="grid grid-cols-2 gap-2"></div> <!></div></div></div> <div class="border-t border-base-200"><div class="px-5 py-3"><span class="text-xs font-semibold text-base-content/70 uppercase tracking-wide"> </span></div> <div class="px-5 pb-5 space-y-4"><div><div class="flex items-center justify-between mb-1.5"><span class="text-xs font-semibold text-base-content/70 uppercase tracking-wide"> </span> <div class="flex items-center gap-2"><span class="text-xs text-base-content/50"><!></span> <input type="checkbox" class="toggle toggle-secondary toggle-sm" role="switch"/> <span class="text-xs text-base-content/70"> </span></div></div> <!></div> <div><div class="flex items-center justify-between mb-1.5"><span class="text-xs font-semibold text-base-content/70 uppercase tracking-wide"> </span> <div class="flex items-center gap-2"><span class="text-xs text-base-content/50"> </span> <input type="checkbox" class="toggle toggle-secondary toggle-sm" role="switch"/> <span class="text-xs text-base-content/70"> </span></div></div> <!></div> <div><div class="flex items-center justify-between mb-1.5"><div class="flex items-center gap-1.5"><span class="text-xs font-semibold text-base-content/70 uppercase tracking-wide"> </span> <button type="button" class="btn btn-ghost btn-xs btn-circle flex-shrink-0"><svg xmlns="http://www.w3.org/2000/svg" class="w-[1.14rem] h-[1.14rem]" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true"><path fill-rule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7-4a1 1 0 11-2 0 1 1 0 012 0zM9 9a1 1 0 000 2v3a1 1 0 001 1h1a1 1 0 100-2v-3a1 1 0 00-1-1H9z" clip-rule="evenodd"></path></svg></button></div> <div class="flex items-center gap-2"><span> </span> <input type="checkbox" class="toggle toggle-secondary toggle-sm" role="switch"/> <span> </span></div></div> <!></div></div></div></div> <!> <!> <!>',1);function k3(a,n){He(n,!0);const c=()=>J1(Me,"$lang",b),s=()=>J1(ue,"$inputs",b),v=()=>J1(Vt,"$result",b),[b,d]=Re(),i=m1(()=>je[c()]);let g=se(!1),F=se(!1),z=se(!1);const C=["Tight","Balanced","Open"],$={Tight:Zr,Balanced:Xr,Open:e3};let G=m1(()=>s().flourBlend.reduce((m,p)=>m+p.pct,0)),P=m1(()=>Math.round(r(G))===100);function _(m){return s().flourBlend.some(p=>p.type===m)}function u(m){ue.update(p=>{if(p.flourBlend.find(h=>h.type===m)){if(p.flourBlend.length<=1)return p;const h=p.flourBlend.filter(s1=>s1.type!==m),T=h.reduce((s1,X)=>s1+X.pct,0);let R;if(T>0){const s1=100/T;R=h.map(X=>({...X,pct:Math.round(X.pct*s1)}))}else{const s1=Math.floor(100/h.length);R=h.map((X,_1)=>({...X,pct:_1===0?s1+(100-s1*h.length):s1}))}const e1=R.reduce((s1,X)=>s1+X.pct,0);return e1!==100&&R.length>0&&(R[0]={...R[0],pct:R[0].pct+(100-e1)}),{...p,flourBlend:R}}else{const h=p.flourBlend.length+1,T=Math.round(100/h),R=(100-T)/100,e1=p.flourBlend.map(X=>({...X,pct:Math.round(X.pct*R)}));e1.push({type:m,pct:T});const s1=e1.reduce((X,_1)=>X+_1.pct,0);return s1!==100&&e1.length>0&&(e1[0]={...e1[0],pct:e1[0].pct+(100-s1)}),{...p,flourBlend:e1}}})}function B(m,p){const f=Math.max(0,Math.min(100,parseFloat(p)||0));ue.update(h=>{const T=h.flourBlend.filter(X=>X.type!==m),R=T.reduce((X,_1)=>X+_1.pct,0),e1=100-f;let s1;if(T.length===0)s1=h.flourBlend.map(X=>({...X,pct:100}));else if(R===0){const X=Math.floor(e1/T.length),_1=e1-X*T.length;s1=h.flourBlend.map((z1,P1)=>{if(z1.type===m)return{...z1,pct:f};const W1=T.indexOf(z1);return{...z1,pct:X+(W1===0?_1:0)}})}else{const X=e1/R,_1=T.map(d1=>({...d1,pct:d1.pct*X})),z1=_1.map(d1=>({...d1,pct:Math.floor(d1.pct)})),P1=z1.reduce((d1,q1)=>d1+q1.pct,0);let W1=e1-P1;const ze=_1.map((d1,q1)=>({i:q1,frac:d1.pct-Math.floor(d1.pct)})).sort((d1,q1)=>q1.frac-d1.frac);for(let d1=0;d1<W1;d1++)z1[ze[d1].i].pct+=1;const Q1=new Map(z1.map(d1=>[d1.type,d1.pct]));s1=h.flourBlend.map(d1=>d1.type===m?{...d1,pct:f}:{...d1,pct:Q1.get(d1.type)??d1.pct})}return{...h,flourBlend:s1}})}function E(){ue.update(m=>{const p=m.flourBlend.reduce((R,e1)=>R+e1.pct,0);if(p===0||p===100)return m;const f=100/p,h=m.flourBlend.map(R=>({...R,pct:Math.round(R.pct*f)})),T=h.reduce((R,e1)=>R+e1.pct,0);return T!==100&&h.length>0&&(h[0]={...h[0],pct:h[0].pct+(100-T)}),{...m,flourBlend:h}})}const A={BreadFlour:"#F59E0B",AllPurpose:"#60A5FA",WholeWheat:"#92400E",Rye:"#059669",Spelt:"#7C3AED",Einkorn:"#F43F5E"},I=80,M=2*Math.PI*I;let w=m1(()=>{let m=0;return s().flourBlend.map(p=>{const f=p.pct/100*M,h={type:p.type,color:A[p.type],dasharray:`${f} ${M-f}`,dashoffset:-m};return m+=f,h})}),y=m1(()=>v().formula.autoSaltPct),D=m1(()=>Math.round(v().formula.saltG)),K=m1(()=>s().tempUnit==="F"?Math.round(rt(s().ambientTempC)):s().ambientTempC),q=m1(()=>s().doughTempC===null?"":s().tempUnit==="F"?Math.round(rt(s().doughTempC)):s().doughTempC),V=m1(()=>s().tempUnit==="F"?Math.round(rt(s().fridgeTempC)):s().fridgeTempC);function t1(m,p){const f=s().tempUnit==="F"?Rr(p):p;ue.update(h=>{const T={...h,[m]:f};return h.autolyseOn&&(m==="ambientTempC"||m==="doughTempC")?{...T,autolyseMins:f2(T.ambientTempC,T.doughTempC)}:T})}function l1(m,p){ue.update(f=>({...f,[m]:p}))}function M1(){ue.update(m=>({...m,tempUnit:m.tempUnit==="C"?"F":"C"}))}function r1(m){const p=Math.max(0,parseFloat(m.target.value)||0);l1("totalFlourInputG",p)}function x1(m){const p=m.target;let f=parseFloat(p.value);isNaN(f)||(f=Math.min(r(y1),Math.max(r(R1),f)),t1("ambientTempC",f))}function v1(m){const f=m.target.value;if(f==="")ue.update(h=>{const T={...h,doughTempC:null};return h.autolyseOn?{...T,autolyseMins:f2(T.ambientTempC,T.doughTempC)}:T});else{let h=parseFloat(f);isNaN(h)||(h=Math.min(r(y1),Math.max(r(R1),h)),t1("doughTempC",h))}}function j(){ue.update(m=>m.autolyseOn?{...m,autolyseOn:!1}:{...m,autolyseOn:!0,autolyseMins:f2(m.ambientTempC,m.doughTempC)})}function f1(m){let p=parseFloat(m.target.value);isNaN(p)||(p=Math.min(r(S1),Math.max(r(w1),p)),t1("fridgeTempC",p))}const k1='a[href],button:not([disabled]),input:not([disabled]),select:not([disabled]),textarea:not([disabled]),[tabindex]:not([tabindex="-1"])';function L1(m,p){const f=Array.from(m.querySelectorAll(k1));f.length&&f[0].focus();function h(T){if(T.key==="Escape"){U(g,!1),U(F,!1),U(z,!1);return}if(T.key!=="Tab")return;const R=f[0],e1=f[f.length-1];T.shiftKey?document.activeElement===R&&(T.preventDefault(),e1.focus()):document.activeElement===e1&&(T.preventDefault(),R.focus())}return m.addEventListener("keydown",h),{destroy(){m.removeEventListener("keydown",h)}}}function T1(m){return L1(m)}const R1=m1(()=>s().tempUnit==="F"?32:0),y1=m1(()=>s().tempUnit==="F"?120:50),w1=m1(()=>s().tempUnit==="F"?28:-2),S1=m1(()=>s().tempUnit==="F"?50:10),F1=20,N1=60-F1,K1=m1(()=>Math.max(0,Math.min(N1,s().autolyseMins-F1)));var I1=_3(),$1=te(I1),u1=t($1),b1=t(u1),E1=t(b1,!0);e(b1),e(u1);var A1=o(u1,2),Q=t(A1),H=t(Q),x=t(H),S=t(x);Y(S,"r",I);var i1=o(S);Y1(i1,17,()=>r(w),m=>m.type,(m,p)=>{var f=t3();Y(f,"r",I),N(()=>{Y(f,"stroke",r(p).color),Y(f,"stroke-dasharray",r(p).dasharray),Y(f,"stroke-dashoffset",r(p).dashoffset)}),k(m,f)}),e(x);var c1=o(x,2),B1=t(c1),a1=t(B1);ne(a1),a2(2),e(B1);var Z=o(B1,2),J=t(Z,!0);e(Z),e(c1),e(H);var W=o(H,2);{var o1=m=>{var p=r3();Y1(p,5,()=>s().flourBlend,f=>f.type,(f,h)=>{var T=a3(),R=t(T),e1=o(R);e(T),N(s1=>{Ht(R,`background-color: ${A[r(h).type]??""}`),l(e1,` ${r(i).flourTypes[r(h).type]??""}: ${s1??""}g`)},[()=>Math.round(s().totalFlourInputG*r(h).pct/100)]),k(f,T)}),e(p),k(m,p)};g1(W,m=>{s().flourBlend.length>1&&m(o1)})}e(Q);var n1=o(Q,2),h1=t(n1),C1=t(h1,!0);e(h1);var O1=o(h1,2);Y1(O1,21,()=>kr,be,(m,p)=>{var f=n3(),h=t(f,!0);e(f),N(T=>{p1(f,1,`btn btn-sm rounded-xl border-2 h-auto py-2 px-1 text-xs
							${T??""}`),l(h,r(i).flourTypes[r(p)])},[()=>_(r(p))?"btn-secondary border-secondary text-secondary-content":"btn-ghost border-base-300"]),L("click",f,()=>u(r(p))),k(m,f)}),e(O1);var H1=o(O1,2);{var j1=m=>{var p=l3(),f=te(p);Y1(f,5,()=>s().flourBlend,z1=>z1.type,(z1,P1)=>{var W1=o3(),ze=t(W1),Q1=o(ze,2),d1=t(Q1,!0);e(Q1);var q1=o(Q1,2),de=t(q1);ne(de);var ye=o(de,2);ne(ye),a2(2),e(q1),e(W1),N(ee=>{Ht(ze,`background-color: ${A[r(P1).type]??""}`),l(d1,r(i).flourTypes[r(P1).type]),Z1(de,r(P1).pct),Z1(ye,ee)},[()=>Math.round(r(P1).pct)]),L("input",de,ee=>B(r(P1).type,ee.target.value)),L("change",ye,ee=>B(r(P1).type,ee.target.value)),k(z1,W1)}),e(f);var h=o(f,2),T=t(h),R=t(T),e1=o(R),s1=t(e1);e(e1),e(T);var X=o(T,2);{var _1=z1=>{var P1=s3(),W1=t(P1,!0);e(P1),N(()=>l(W1,r(i).blendNormalize)),L("click",P1,E),k(z1,P1)};g1(X,z1=>{r(P)||z1(_1)})}e(h),N(z1=>{l(R,`${r(i).blendTotal??""}: `),p1(e1,1,`font-semibold tabular-nums ${r(P)?"text-success":"text-error"}`),l(s1,`${z1??""}%`)},[()=>Math.round(r(G))]),k(m,p)};g1(H1,m=>{s().flourBlend.length>1&&m(j1)})}e(n1);var G1=o(n1,2),U1=t(G1),D1=t(U1),ae=t(D1,!0);e(D1);var pe=o(D1,2),le=t(pe),De=o(le,4);e(pe),e(U1);var ve=o(U1,2),re=t(ve),ie=t(re),ge=t(ie),ke=t(ge,!0);e(ge),e(ie);var ce=o(ie,2);ne(ce),e(re);var we=o(re,2),Le=t(we),Ue=t(Le),Ve=t(Ue),b2=o(Ve),o2=t(b2,!0);e(b2),e(Ue),e(Le);var Se=o(Le,2);ne(Se),e(we),e(ve),e(G1),e(A1);var s2=o(A1,2);{var H2=m=>{var p=i3(),f=t(p);qr(f,{get warnings(){return v().warnings}}),e(p),k(m,p)};g1(s2,m=>{s().totalFlourInputG>0&&m(H2)})}var Ke=o(s2,2),Ne=t(Ke),h2=t(Ne),l2=t(h2,!0);e(h2),e(Ne);var M2=o(Ne,2),qe=t(M2),Ye=t(qe),x2=t(Ye,!0);e(Ye);var i2=o(Ye,2);Y1(i2,21,()=>C,be,(m,p)=>{const f=m1(()=>$[r(p)]);var h=c3(),T=t(h);ar(T,()=>r(f),(s1,X)=>{X(s1,{class:"w-[147px] h-[105px]"})});var R=o(T,2),e1=t(R,!0);e(R),e(h),N(()=>{p1(h,1,`btn rounded-xl border-2 flex-col h-auto py-3 px-2 gap-1.5
								${s().crumbGoal===r(p)?"btn-secondary border-secondary text-secondary-content":"btn-ghost border-base-300"}`),l(e1,r(i).crumbGoalNames[r(p)])}),L("click",h,()=>l1("crumbGoal",r(p))),k(m,h)}),e(i2);var c2=o(i2,2),z2=t(c2,!0);e(c2),e(qe);var Ie=o(qe,2),d2=t(Ie),Ze=t(d2),P2=t(Ze,!0);e(Ze);var Ce=o(Ze,2);e(d2);var xe=o(d2,2);Y1(xe,20,()=>["Predictability","FlavorDevelopment"],be,(m,p)=>{var f=d3(),h=t(f,!0);e(f),N(()=>{p1(f,1,`btn btn-sm rounded-xl border-2 h-auto py-2.5 px-3
							${s().fermentationPhilosophy===p?"btn-secondary border-secondary text-secondary-content":"btn-ghost border-base-300"}`),l(h,p==="Predictability"?r(i).philosophyPredictability:r(i).philosophyFlavorDev)}),L("click",f,()=>l1("fermentationPhilosophy",p)),k(m,f)}),e(xe);var Ae=o(xe,2),$e=t(Ae,!0);e(Ae),e(Ie);var Oe=o(Ie,2),Te=t(Oe),Ee=t(Te),Je=t(Ee,!0);e(Ee);var y2=o(Ee,2);e(Te);var u2=o(Te,2);Y1(u2,20,()=>["Room","ColdRetard"],be,(m,p)=>{var f=u3(),h=t(f,!0);e(f),N(()=>{p1(f,1,`btn btn-sm rounded-xl border-2 h-auto py-2.5 px-3
								${s().proofMethod===p?"btn-secondary border-secondary text-secondary-content":"btn-ghost border-base-300"}`),l(h,p==="Room"?r(i).roomTemp:r(i).coldRetard)}),L("click",f,()=>l1("proofMethod",p)),k(m,f)}),e(u2);var Jt=o(u2,2);{var Xt=m=>{var p=m3(),f=t(p),h=t(f),T=t(h);e(h),e(f);var R=o(f,2);ne(R),e(p),N(()=>{l(T,`${r(i).fridgeTemp??""} (°${s().tempUnit??""})`),Y(R,"min",r(w1)),Y(R,"max",r(S1)),Z1(R,r(V))}),L("input",R,f1),k(m,p)};g1(Jt,m=>{s().proofMethod==="ColdRetard"&&m(Xt)})}e(Oe);var vt=o(Oe,2),R2=t(vt),Qt=t(R2,!0);e(R2);var j2=o(R2,2);Y1(j2,20,()=>["relative","clock"],be,(m,p)=>{var f=p3(),h=t(f,!0);e(f),N(()=>{p1(f,1,`btn btn-sm rounded-xl border-2 h-auto py-2.5 px-3
								${s().scheduleMode===p?"btn-secondary border-secondary text-secondary-content":"btn-ghost border-base-300"}`),l(h,p==="relative"?r(i).relative:r(i).clock)}),L("click",f,()=>l1("scheduleMode",p)),k(m,f)}),e(j2);var ea=o(j2,2);{var ta=m=>{var p=v3(),f=t(p),h=t(f),T=t(h,!0);e(h),e(f);var R=o(f,2);ne(R),e(p),N(()=>{l(T,r(i).startTime),Z1(R,s().startTime??"08:00")}),L("input",R,e1=>l1("startTime",e1.target.value||null)),k(m,p)};g1(ea,m=>{s().scheduleMode==="clock"&&m(ta)})}e(vt),e(M2),e(Ke);var gt=o(Ke,2),D2=t(gt),ft=t(D2),aa=t(ft,!0);e(ft),e(D2);var bt=o(D2,2),L2=t(bt),N2=t(L2),I2=t(N2),ra=t(I2,!0);e(I2);var ht=o(I2,2),$2=t(ht),na=t($2);{var oa=m=>{var p=he();N(f=>l(p,f),[()=>r(i).saltAutoLabel(r(y).toFixed(2),String(r(D)))]),k(m,p)},sa=m=>{var p=he();N(()=>l(p,r(i).saltManual)),k(m,p)};g1(na,m=>{s().saltAutoCalc?m(oa):m(sa,-1)})}e($2);var Xe=o($2,2);ne(Xe);var Mt=o(Xe,2),la=t(Mt,!0);e(Mt),e(ht),e(N2);var ia=o(N2,2);{var ca=m=>{var p=g3(),f=te(p),h=t(f);ne(h),e(f);var T=o(f,2),R=t(T,!0);e(T),N(()=>{Z1(h,s().saltPct),l(R,r(i).saltBakersPct)}),L("input",h,e1=>l1("saltPct",parseFloat(e1.target.value)||2)),k(m,p)};g1(ia,m=>{s().saltAutoCalc||m(ca)})}e(L2);var O2=o(L2,2),E2=t(O2),G2=t(E2),da=t(G2,!0);e(G2);var xt=o(G2,2),W2=t(xt),ua=t(W2,!0);e(W2);var Qe=o(W2,2);ne(Qe);var zt=o(Qe,2),ma=t(zt,!0);e(zt),e(xt),e(E2);var pa=o(E2,2);{var va=m=>{var p=f3(),f=t(p);ne(f),e(p),N(()=>Z1(f,s().starterHydrationPct)),L("input",f,h=>l1("starterHydrationPct",parseFloat(h.target.value)||100)),k(m,p)};g1(pa,m=>{s().starterHydrationAutoCalc||m(va)})}e(O2);var yt=o(O2,2),U2=t(yt),V2=t(U2),K2=t(V2),ga=t(K2,!0);e(K2);var _t=o(K2,2);e(V2);var kt=o(V2,2),_2=t(kt),fa=t(_2,!0);e(_2);var e2=o(_2,2);ne(e2);var q2=o(e2,2),ba=t(q2,!0);e(q2),e(kt),e(U2);var ha=o(U2,2);{var Ma=m=>{var p=b3(),f=t(p),h=t(f),T=t(h,!0);e(h);var R=o(h,2),e1=t(R);e(R),e(f);var s1=o(f,2);Y(s1,"max",N1);var X=o(s1,2),_1=t(X);_1.textContent="20 min";var z1=o(_1,2);z1.textContent="60 min",e(X),e(p),N(()=>{l(T,r(i).duration),l(e1,`${s().autolyseMins??""} min`),Z1(s1,r(K1)),Y(s1,"aria-label",r(i).ariaLabels.autolyseDurationProgress)}),k(m,p)};g1(ha,m=>{s().autolyseOn&&m(Ma)})}e(yt),e(bt),e(gt),e($1);var wt=o($1,2);{var xa=m=>{var p=h3(),f=t(p),h=o(f,2),T=t(h),R=t(T),e1=t(R,!0);e(R);var s1=o(R,2);e(T);var X=o(T,2),_1=t(X),z1=t(_1),P1=t(z1,!0);e(z1);var W1=o(z1,2),ze=t(W1,!0);e(W1),e(_1);var Q1=o(_1,2),d1=t(Q1),q1=t(d1,!0);e(d1);var de=o(d1,2),ye=t(de,!0);e(de),e(Q1),e(X);var ee=o(X,2),fe=t(ee),m2=t(fe,!0);e(fe),e(ee),e(h),F2(h,Fe=>T1?.(Fe)),e(p),N(()=>{Y(f,"aria-label",r(i).ariaLabels.closeFermentationPhilosophyModal),l(e1,r(i).philosophyModalTitle),Y(s1,"aria-label",r(i).ariaLabels.closeButton),l(P1,r(i).philosophyPredictability),l(ze,r(i).philosophyModalPredictabilityBody),l(q1,r(i).philosophyFlavorDev),l(ye,r(i).philosophyModalFlavorDevBody),l(m2,r(i).done)}),L("click",f,()=>U(g,!1)),L("click",s1,()=>U(g,!1)),L("click",fe,()=>U(g,!1)),k(m,p)};g1(wt,m=>{r(g)&&m(xa)})}var Tt=o(wt,2);{var za=m=>{var p=z3(),f=t(p),h=o(f,2),T=t(h),R=t(T),e1=t(R,!0);e(R);var s1=o(R,2);e(T);var X=o(T,2),_1=t(X),z1=t(_1,!0);e(_1);var P1=o(_1,2),W1=t(P1),ze=t(W1,!0);e(W1);var Q1=o(W1,2);Y1(Q1,21,()=>r(i).autolyseModalUseItems,be,(Fe,Y2)=>{var Ge=M3(),Z2=t(Ge,!0);e(Ge),N(()=>l(Z2,r(Y2))),k(Fe,Ge)}),e(Q1),e(P1);var d1=o(P1,2),q1=t(d1),de=t(q1,!0);e(q1);var ye=o(q1,2);Y1(ye,21,()=>r(i).autolyseModalAvoidItems,be,(Fe,Y2)=>{var Ge=x3(),Z2=t(Ge,!0);e(Ge),N(()=>l(Z2,r(Y2))),k(Fe,Ge)}),e(ye),e(d1),e(X);var ee=o(X,2),fe=t(ee),m2=t(fe,!0);e(fe),e(ee),e(h),F2(h,Fe=>T1?.(Fe)),e(p),N(()=>{Y(f,"aria-label",r(i).ariaLabels.closeAutolyseModal),l(e1,r(i).autolyseModalTitle),Y(s1,"aria-label",r(i).ariaLabels.closeButton),l(z1,r(i).autolyseModalIntro),l(ze,r(i).autolyseModalUseTitle),l(de,r(i).autolyseModalAvoidTitle),l(m2,r(i).done)}),L("click",f,()=>U(F,!1)),L("click",s1,()=>U(F,!1)),L("click",fe,()=>U(F,!1)),k(m,p)};g1(Tt,m=>{r(F)&&m(za)})}var ya=o(Tt,2);{var _a=m=>{var p=y3(),f=t(p),h=o(f,2),T=t(h),R=t(T),e1=t(R,!0);e(R);var s1=o(R,2);e(T);var X=o(T,2),_1=t(X),z1=t(_1),P1=t(z1,!0);e(z1);var W1=o(z1,2),ze=t(W1,!0);e(W1),e(_1);var Q1=o(_1,2),d1=t(Q1),q1=t(d1,!0);e(d1);var de=o(d1,2),ye=t(de,!0);e(de),e(Q1),e(X);var ee=o(X,2),fe=t(ee),m2=t(fe,!0);e(fe),e(ee),e(h),F2(h,Fe=>T1?.(Fe)),e(p),N(()=>{Y(f,"aria-label",r(i).ariaLabels.closeProofMethodModal),l(e1,r(i).proofMethodModalTitle),Y(s1,"aria-label",r(i).ariaLabels.closeProofMethodModal),l(P1,r(i).roomTemp),l(ze,r(i).proofMethodRoomBody),l(q1,r(i).coldRetard),l(ye,r(i).proofMethodColdRetardBody),l(m2,r(i).done)}),L("click",f,()=>U(z,!1)),L("click",s1,()=>U(z,!1)),L("click",fe,()=>U(z,!1)),k(m,p)};g1(ya,m=>{r(z)&&m(_a)})}N(()=>{l(E1,r(i).parameters),Z1(a1,s().totalFlourInputG),l(J,r(i).totalFlour),l(C1,r(i).flourSelection),l(ae,r(i).temperatures),Y(pe,"aria-label",r(i).ariaLabels.toggleTempUnit),p1(le,1,We(s().tempUnit==="C"?"text-secondary font-semibold":"text-base-content/50")),p1(De,1,We(s().tempUnit==="F"?"text-secondary font-semibold":"text-base-content/50")),l(ke,r(i).kitchenTemp),Y(ce,"min",r(R1)),Y(ce,"max",r(y1)),Z1(ce,r(K)),l(Ve,`${r(i).doughTemp??""} `),l(o2,r(i).optional),Y(Se,"min",r(R1)),Y(Se,"max",r(y1)),Z1(Se,r(q)),Y(Se,"placeholder",r(i).leaveBlankAmbient),l(l2,r(i).bakingProfile),l(x2,r(i).crumbGoal),l(z2,r(i).crumbDescriptions[s().crumbGoal]),l(P2,r(i).fermentationPhilosophyLabel),Y(Ce,"aria-label",r(i).ariaLabels.learnFermentationPhilosophy),l($e,s().fermentationPhilosophy==="Predictability"?r(i).philosophyPredictabilityDesc:r(i).philosophyFlavorDevDesc),l(Je,r(i).proofMethod),Y(y2,"aria-label",r(i).ariaLabels.learnProofMethod),l(Qt,r(i).scheduleMode),l(aa,r(i).fineTuning),l(ra,r(i).salt),tt(Xe,!s().saltAutoCalc),Y(Xe,"aria-checked",!s().saltAutoCalc),Y(Xe,"aria-label",r(i).ariaLabels.overrideSalt),l(la,r(i).saltOverride),l(da,r(i).starterHydration),l(ua,s().starterHydrationAutoCalc?r(i).starterHydrationDefaultLabel:r(i).starterHydrationManual),tt(Qe,!s().starterHydrationAutoCalc),Y(Qe,"aria-checked",!s().starterHydrationAutoCalc),Y(Qe,"aria-label",r(i).ariaLabels.overrideStarterHydration),l(ma,r(i).starterHydrationOverride),l(ga,r(i).autolyse),Y(_t,"aria-label",r(i).ariaLabels.learnAutolyse),p1(_2,1,We(s().autolyseOn?"text-xs text-base-content/40":"text-xs text-base-content/70 font-semibold")),l(fa,r(i).off),tt(e2,s().autolyseOn),Y(e2,"aria-checked",s().autolyseOn),Y(e2,"aria-label",r(i).ariaLabels.toggleAutolyseAuto),p1(q2,1,We(s().autolyseOn?"text-xs text-base-content/70 font-semibold":"text-xs text-base-content/40")),l(ba,r(i).auto)}),L("input",a1,r1),L("click",pe,M1),L("input",ce,x1),L("input",Se,v1),L("click",Ce,()=>U(g,!0)),L("click",y2,()=>U(z,!0)),L("change",Xe,()=>l1("saltAutoCalc",!s().saltAutoCalc)),L("change",Qe,()=>l1("starterHydrationAutoCalc",!s().starterHydrationAutoCalc)),L("click",_t,()=>U(F,!0)),L("change",e2,j),k(a,I1),Pe(),d()}r2(["input","click","change"]);var w3=O('<tr class="bg-base-200/30"><td class="py-1.5 text-base-content/70 text-xs pl-4"> </td><td class="py-1.5 text-right tabular-nums text-base-content/70 text-xs"> </td><td class="py-1.5 text-right tabular-nums text-base-content/50 text-xs"> </td></tr>'),T3=O('<div class="px-5 pb-4"><table class="w-full text-sm"><thead><tr class="border-b border-base-200"><th class="text-left py-2 text-xs font-semibold text-base-content/50 uppercase tracking-wide"> </th><th class="text-right py-2 text-xs font-semibold text-base-content/50 uppercase tracking-wide"> </th><th class="text-right py-2 text-xs font-semibold text-base-content/50 uppercase tracking-wide"> </th></tr></thead><tbody class="divide-y divide-base-200"><tr><td class="py-2.5 text-base-content font-medium"> </td><td class="py-2.5 text-right tabular-nums text-base-content font-semibold"> </td><td class="py-2.5 text-right tabular-nums text-base-content/70">100%</td></tr><!><tr><td class="py-2.5 text-base-content font-medium"> </td><td class="py-2.5 text-right tabular-nums text-base-content font-semibold"> </td><td class="py-2.5 text-right tabular-nums text-base-content/70"> </td></tr><tr><td class="py-2.5 text-base-content font-medium"> </td><td class="py-2.5 text-right tabular-nums text-base-content font-semibold"> </td><td class="py-2.5 text-right tabular-nums text-base-content/70"> </td></tr><tr><td class="py-2.5 text-base-content font-medium"> </td><td class="py-2.5 text-right tabular-nums text-base-content font-semibold"> </td><td class="py-2.5 text-right tabular-nums text-base-content/70"> <span class="text-[10px] text-base-content/40 block leading-tight"> </span></td></tr></tbody><tfoot><tr class="border-t-2 border-secondary/30 bg-secondary/10"><td class="py-3 font-bold text-secondary"> </td><td class="py-3 text-right tabular-nums font-bold text-secondary"> </td><td class="py-3 text-right"></td></tr></tfoot></table></div>'),F3=O('<div class="modal modal-open"><button type="button" class="modal-backdrop"></button> <div class="modal-box w-full max-w-sm p-0 overflow-hidden" role="dialog" aria-modal="true" aria-labelledby="formula-modal-title"><div class="flex items-center justify-between px-5 py-4 border-b border-base-200"><h2 id="formula-modal-title" class="text-base font-semibold text-base-content"> </h2> <button type="button" class="btn btn-ghost btn-sm btn-circle"><svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12"></path></svg></button></div> <div class="px-5 py-4 space-y-4"><div><p class="text-xs font-semibold text-secondary uppercase tracking-wide mb-1"> </p> <p class="text-sm text-base-content/70 leading-relaxed"> </p></div> <div class="border-t border-base-200 pt-4"><p class="text-xs font-semibold text-secondary uppercase tracking-wide mb-1"> </p> <p class="text-sm text-base-content/70 leading-relaxed"> </p></div></div> <div class="px-5 pb-5"><button type="button" class="btn btn-primary w-full"> </button></div></div></div>'),S3=O('<div class="card bg-base-100 shadow-sm ring-1 ring-base-300/70 overflow-hidden"><div class="flex items-center justify-between px-5 pt-5 pb-3"><div><div class="flex items-center gap-1.5"><h2 class="text-base font-semibold text-base-content uppercase tracking-wide"> </h2> <button type="button" class="btn btn-ghost btn-xs btn-circle flex-shrink-0"><svg xmlns="http://www.w3.org/2000/svg" class="w-[1.14rem] h-[1.14rem]" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true"><path fill-rule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7-4a1 1 0 11-2 0 1 1 0 012 0zM9 9a1 1 0 000 2v3a1 1 0 001 1h1a1 1 0 100-2v-3a1 1 0 00-1-1H9z" clip-rule="evenodd"></path></svg></button></div> <p class="text-xs text-base-content/50 mt-0.5"> </p></div> <div class="badge badge-secondary badge-lg tabular-nums font-bold gap-1"> </div></div> <div class="px-5 pb-4"><p class="text-xs font-semibold text-base-content/70 uppercase tracking-wide mb-3"> </p> <div class="grid grid-cols-2 gap-3"><div class="rounded-xl bg-base-200/80 ring-1 ring-base-300/60 px-3 py-3 text-center"><div class="text-2xl font-bold tabular-nums text-base-content"> </div> <div class="text-xs text-base-content/60 mt-1 font-medium"> </div></div> <div class="rounded-xl bg-base-200/80 ring-1 ring-base-300/60 px-3 py-3 text-center"><div class="text-2xl font-bold tabular-nums text-base-content"> </div> <div class="text-xs text-base-content/60 mt-1 font-medium"> </div></div> <div class="rounded-xl bg-accent/10 ring-1 ring-accent/20 px-3 py-3 text-center"><div class="text-2xl font-bold tabular-nums text-accent"> </div> <div class="text-xs text-accent/70 mt-1 font-medium"> </div></div> <div class="rounded-xl bg-base-200/80 ring-1 ring-base-300/60 px-3 py-3 text-center"><div class="text-2xl font-bold tabular-nums text-base-content"> </div> <div class="text-xs text-base-content/60 mt-1 font-medium"> </div></div></div> <p class="text-xs text-base-content/50 mt-2.5 italic"> </p></div> <div class="border-t border-base-200"><button type="button" class="w-full flex items-center justify-between px-5 py-3 text-left hover:bg-base-200/50 transition-colors"><span class="text-xs font-semibold text-base-content/70 uppercase tracking-wide"> </span> <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor"><path fill-rule="evenodd" d="M5.23 7.21a.75.75 0 011.06.02L10 11.168l3.71-3.938a.75.75 0 111.08 1.04l-4.25 4.5a.75.75 0 01-1.08 0l-4.25-4.5a.75.75 0 01.02-1.06z" clip-rule="evenodd"></path></svg></button> <!></div></div> <!>',1);function C3(a,n){He(n,!0);const c=()=>J1(Me,"$lang",v),s=()=>J1(ct,"$showFullFormula",v),[v,b]=Re(),d=m1(()=>je[c()]);function i(Z,J){return J<=0?"—":`${(Z/J*100).toFixed(1)}%`}function g(Z){return Math.round(Z).toString()}function F(Z,J){const W=Math.round(Z),o1=Math.round(J);if(W<=0||o1<=0)return"—";let n1=W,h1=o1;for(;h1;)[n1,h1]=[h1,n1%h1];return`${W/n1}:${o1/n1}`}let z=se(!1);const C='a[href],button:not([disabled]),input:not([disabled]),select:not([disabled]),textarea:not([disabled]),[tabindex]:not([tabindex="-1"])';function $(Z,J){const W=Array.from(Z.querySelectorAll(C));W.length&&W[0].focus();function o1(n1){if(n1.key==="Escape"){U(z,!1);return}if(n1.key!=="Tab")return;const h1=W[0],C1=W[W.length-1];n1.shiftKey?document.activeElement===h1&&(n1.preventDefault(),C1.focus()):document.activeElement===C1&&(n1.preventDefault(),h1.focus())}return Z.addEventListener("keydown",o1),{destroy(){Z.removeEventListener("keydown",o1)}}}function G(Z){return $(Z)}var P=S3(),_=te(P),u=t(_),B=t(u),E=t(B),A=t(E),I=t(A,!0);e(A);var M=o(A,2);e(E);var w=o(E,2),y=t(w,!0);e(w),e(B);var D=o(B,2),K=t(D);e(D),e(u);var q=o(u,2),V=t(q),t1=t(V,!0);e(V);var l1=o(V,2),M1=t(l1),r1=t(M1),x1=t(r1);e(r1);var v1=o(r1,2),j=t(v1,!0);e(v1),e(M1);var f1=o(M1,2),k1=t(f1),L1=t(k1);e(k1);var T1=o(k1,2),R1=t(T1,!0);e(T1),e(f1);var y1=o(f1,2),w1=t(y1),S1=t(w1);e(w1);var F1=o(w1,2),X1=t(F1,!0);e(F1),e(y1);var N1=o(y1,2),K1=t(N1),I1=t(K1);e(K1);var $1=o(K1,2),u1=t($1,!0);e($1),e(N1),e(l1);var b1=o(l1,2),E1=t(b1,!0);e(b1),e(q);var A1=o(q,2),Q=t(A1),H=t(Q),x=t(H,!0);e(H);var S=o(H,2);e(Q);var i1=o(Q,2);{var c1=Z=>{var J=T3(),W=t(J),o1=t(W),n1=t(o1),h1=t(n1),C1=t(h1,!0);e(h1);var O1=o(h1),H1=t(O1,!0);e(O1);var j1=o(O1),G1=t(j1,!0);e(j1),e(n1),e(o1);var U1=o(o1),D1=t(U1),ae=t(D1),pe=t(ae,!0);e(ae);var le=o(ae),De=t(le);e(le),a2(),e(D1);var ve=o(D1);Y1(ve,17,()=>n.flourBlend,Ce=>Ce.type,(Ce,xe)=>{var Ae=w3(),$e=t(Ae),Oe=t($e);e($e);var Te=o($e),Ee=t(Te);e(Te);var Je=o(Te),y2=t(Je);e(Je),e(Ae),N(u2=>{l(Oe,`— ${r(d).flourTypes[r(xe).type]??r(xe).type??""}`),l(Ee,`${u2??""}g`),l(y2,`${r(xe).pct??""}%`)},[()=>g(n.formula.totalFlourG*r(xe).pct/100)]),k(Ce,Ae)});var re=o(ve),ie=t(re),ge=t(ie,!0);e(ie);var ke=o(ie),ce=t(ke);e(ke);var we=o(ke),Le=t(we);e(we),e(re);var Ue=o(re),Ve=t(Ue),b2=t(Ve,!0);e(Ve);var o2=o(Ve),Se=t(o2);e(o2);var s2=o(o2),H2=t(s2,!0);e(s2),e(Ue);var Ke=o(Ue),Ne=t(Ke),h2=t(Ne,!0);e(Ne);var l2=o(Ne),M2=t(l2);e(l2);var qe=o(l2),Ye=t(qe),x2=o(Ye),i2=t(x2,!0);e(x2),e(qe),e(Ke),e(U1);var c2=o(U1),z2=t(c2),Ie=t(z2),d2=t(Ie,!0);e(Ie);var Ze=o(Ie),P2=t(Ze);e(Ze),a2(),e(z2),e(c2),e(W),e(J),N((Ce,xe,Ae,$e,Oe,Te,Ee,Je)=>{l(C1,r(d).ingredient),l(H1,r(d).grams),l(G1,r(d).bakersPct),l(pe,r(d).totalFlourRow),l(De,`${Ce??""}g`),l(ge,r(d).water),l(ce,`${xe??""}g`),l(Le,`${Ae??""}%`),l(b2,r(d).saltRow),l(Se,`${$e??""}g`),l(H2,Oe),l(h2,r(d).starter),l(M2,`${Te??""}g`),l(Ye,`${Ee??""} `),l(i2,r(d).preFermentedFlour),l(d2,r(d).totalDough),l(P2,`${Je??""}g`)},[()=>g(n.formula.totalFlourG),()=>g(n.formula.totalWaterG),()=>n.formula.finalHydrationPct.toFixed(1),()=>g(n.formula.saltG),()=>i(n.formula.saltG,n.formula.totalFlourG),()=>g(n.formula.starterTotalG),()=>i(n.formula.starterFlourG,n.formula.totalFlourG),()=>g(n.formula.totalDoughWeightG)]),k(Z,J)};g1(i1,Z=>{s()&&Z(c1)})}e(A1),e(_);var B1=o(_,2);{var a1=Z=>{var J=F3(),W=t(J),o1=o(W,2),n1=t(o1),h1=t(n1),C1=t(h1,!0);e(h1);var O1=o(h1,2);e(n1);var H1=o(n1,2),j1=t(H1),G1=t(j1),U1=t(G1,!0);e(G1);var D1=o(G1,2),ae=t(D1,!0);e(D1),e(j1);var pe=o(j1,2),le=t(pe),De=t(le,!0);e(le);var ve=o(le,2),re=t(ve,!0);e(ve),e(pe),e(H1);var ie=o(H1,2),ge=t(ie),ke=t(ge,!0);e(ge),e(ie),e(o1),F2(o1,ce=>G?.(ce)),e(J),N(()=>{Y(W,"aria-label",r(d).ariaLabels.closeFormulaModal),l(C1,r(d).formulaInfoTitle),Y(O1,"aria-label",r(d).ariaLabels.closeFormulaModal),l(U1,r(d).mixAdditions),l(ae,r(d).formulaInfoMixBody),l(De,r(d).fullFormula),l(re,r(d).formulaInfoFormulaBody),l(ke,r(d).done)}),L("click",W,()=>U(z,!1)),L("click",O1,()=>U(z,!1)),L("click",ge,()=>U(z,!1)),k(Z,J)};g1(B1,Z=>{r(z)&&Z(a1)})}N((Z,J,W,o1,n1,h1)=>{l(I,r(d).formula),Y(M,"aria-label",r(d).ariaLabels.learnFormula),l(y,r(d).bakersPctSubtitle),l(K,`${Z??""}g`),l(t1,r(d).mixAdditions),l(x1,`${J??""}g`),l(j,r(d).mixFlour),l(L1,`${W??""}g`),l(R1,r(d).mixWater),l(S1,`${o1??""}g`),l(X1,r(d).starter),l(I1,`${n1??""}g`),l(u1,r(d).saltRow),l(E1,h1),l(x,r(d).fullFormula),p1(S,0,`w-4 h-4 text-base-content/40 transition-transform ${s()?"rotate-180":""}`)},[()=>g(n.formula.totalDoughWeightG),()=>g(n.formula.mixFlourG),()=>g(n.formula.mixWaterG),()=>g(n.formula.starterTotalG),()=>g(n.formula.saltG),()=>r(d).starterContains(g(n.formula.starterFlourG),g(n.formula.starterWaterG),F(n.formula.starterFlourG,n.formula.starterWaterG))]),L("click",M,()=>U(z,!0)),L("click",Q,()=>ct.update(Z=>!Z)),k(a,P),Pe(),b()}r2(["click"]);var A3=O('<div class="flex justify-between items-center mb-2"><span class="text-sm font-semibold text-base-content"> </span> <span class="text-sm tabular-nums font-bold text-info"> </span></div> <div class="relative h-3"><progress class="progress progress-info w-full absolute inset-0 opacity-50" max="100"></progress> <progress class="progress progress-info w-full absolute inset-0" max="100"></progress></div>',1),B3=O('<div class="flex justify-between items-center mb-2"><span class="text-sm font-semibold text-base-content"> </span> <span class="text-sm tabular-nums font-bold text-secondary"> </span></div> <div class="relative h-3"><progress class="progress progress-secondary w-full absolute inset-0 opacity-50" value="100" max="100"></progress> <progress class="progress progress-secondary w-full absolute inset-0" max="100"></progress></div> <p class="text-xs text-base-content/70 mt-1"> </p>',1),H3=O('<div class="modal modal-open"><button type="button" class="modal-backdrop"></button> <div class="modal-box w-full max-w-md p-0 overflow-hidden" role="dialog" aria-modal="true" aria-labelledby="timing-bars-modal-title"><div class="flex items-center justify-between px-5 py-4 border-b border-base-200"><h2 id="timing-bars-modal-title" class="text-base font-semibold text-base-content"> </h2> <button type="button" class="btn btn-ghost btn-sm btn-circle"><svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12"></path></svg></button></div> <div class="px-5 py-4 space-y-4"><p class="text-sm text-base-content/70 leading-relaxed"> </p> <div><p class="text-xs font-semibold text-secondary uppercase tracking-wide mb-1"> </p> <p class="text-sm text-base-content/70 leading-relaxed"> </p></div> <div class="border-t border-base-200 pt-4"><p class="text-xs font-semibold text-secondary uppercase tracking-wide mb-1"> </p> <p class="text-sm text-base-content/70 leading-relaxed"> </p></div></div> <div class="px-5 pb-5"><button type="button" class="btn btn-primary w-full"> </button></div></div></div>'),P3=O('<div class="card bg-base-100 shadow-sm ring-1 ring-base-300/70"><div class="card-body gap-5 p-5"><div class="flex items-center gap-1.5"><h2 class="text-base font-semibold text-base-content uppercase tracking-wide"> </h2> <button type="button" class="btn btn-ghost btn-xs btn-circle flex-shrink-0"><svg xmlns="http://www.w3.org/2000/svg" class="w-[1.14rem] h-[1.14rem]" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true"><path fill-rule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7-4a1 1 0 11-2 0 1 1 0 012 0zM9 9a1 1 0 000 2v3a1 1 0 001 1h1a1 1 0 100-2v-3a1 1 0 00-1-1H9z" clip-rule="evenodd"></path></svg></button></div> <div class="flex flex-wrap gap-2"><span> </span> <span> </span> <span class="badge badge-soft badge-accent badge-md font-medium"> </span></div> <div><div class="flex justify-between items-center mb-2"><span class="text-sm font-semibold text-base-content"> </span> <span class="text-sm tabular-nums font-bold text-secondary"> </span></div> <div class="relative h-3"><progress class="progress progress-warning w-full absolute inset-0" max="100"></progress> <progress class="progress progress-secondary w-full absolute inset-0 opacity-80" max="100"></progress></div> <div class="flex justify-between text-xs text-base-content/50 mt-1"><span> </span> <span> </span></div> <p class="text-xs text-base-content/70 mt-1"> </p></div> <div><!></div> <div class="rounded-xl bg-secondary/10 ring-1 ring-secondary/20 px-4 py-3 text-sm"><span class="text-base-content/70"> </span> <span class="font-bold text-base-content ml-1"> </span></div> <p class="text-xs text-base-content/50 text-center"> </p></div></div> <!>',1);function R3(a,n){He(n,!0);const c=()=>J1(Me,"$lang",v),s=()=>J1(ue,"$inputs",v),[v,b]=Re(),d=85,i=95,g=m1(()=>je[c()]);let F=se(!1);const z=12;function C(J){return Math.min(100,J/z*100)}const $={Cold:"badge-info",VeryCold:"badge-info",Standard:"badge-success",Warm:"badge-warning",Hot:"badge-error"},G={Low:"badge-warning",Medium:"badge-success",High:"badge-info",VeryHigh:"badge-error"},P=m1(()=>C(n.timing.bulkMax)),_=m1(()=>C(n.timing.bulkMin)),u=m1(()=>C(n.timing.proofMax)),B=m1(()=>C(n.timing.proofMin)),E=m1(()=>C(n.timing.coldRetardMin));var A=P3(),I=te(A),M=t(I),w=t(M),y=t(w),D=t(y,!0);e(y);var K=o(y,2);e(w);var q=o(w,2),V=t(q),t1=t(V);e(V);var l1=o(V,2),M1=t(l1);e(l1);var r1=o(l1,2),x1=t(r1);e(r1),e(q);var v1=o(q,2),j=t(v1),f1=t(j),k1=t(f1,!0);e(f1);var L1=o(f1,2),T1=t(L1);e(L1),e(j);var R1=o(j,2),y1=t(R1),w1=o(y1,2);e(R1);var S1=o(R1,2),F1=t(S1),X1=t(F1,!0);e(F1);var N1=o(F1,2),K1=t(N1,!0);e(N1),e(S1);var I1=o(S1,2),$1=t(I1,!0);e(I1),e(v1);var u1=o(v1,2),b1=t(u1);{var E1=J=>{var W=A3(),o1=te(W),n1=t(o1),h1=t(n1,!0);e(n1);var C1=o(n1,2),O1=t(C1);e(C1),e(o1);var H1=o(o1,2),j1=t(H1),G1=o(j1,2);e(H1),N((U1,D1)=>{l(h1,r(g).roomProof),l(O1,`${U1??""} – ${D1??""}`),Z1(j1,r(u)),Z1(G1,r(B))},[()=>me(n.timing.proofMin*60),()=>me(n.timing.proofMax*60)]),k(J,W)},A1=J=>{var W=B3(),o1=te(W),n1=t(o1),h1=t(n1,!0);e(n1);var C1=o(n1,2),O1=t(C1);e(C1),e(o1);var H1=o(o1,2),j1=o(t(H1),2);e(H1);var G1=o(H1,2),U1=t(G1,!0);e(G1),N(()=>{l(h1,r(g).coldRetardProof),l(O1,`${n.timing.coldRetardMin??""}h – ${n.timing.coldRetardMax??""}h`),Z1(j1,r(E)),l(U1,r(g).bakeColdNote)}),k(J,W)};g1(b1,J=>{n.proofMethod==="Room"?J(E1):J(A1,-1)})}e(u1);var Q=o(u1,2),H=t(Q),x=t(H,!0);e(H);var S=o(H,2),i1=t(S);e(S),e(Q);var c1=o(Q,2),B1=t(c1,!0);e(c1),e(M),e(I);var a1=o(I,2);{var Z=J=>{var W=H3(),o1=t(W),n1=o(o1,2),h1=t(n1),C1=t(h1),O1=t(C1,!0);e(C1);var H1=o(C1,2);e(h1);var j1=o(h1,2),G1=t(j1),U1=t(G1,!0);e(G1);var D1=o(G1,2),ae=t(D1),pe=t(ae,!0);e(ae);var le=o(ae,2),De=t(le,!0);e(le),e(D1);var ve=o(D1,2),re=t(ve),ie=t(re,!0);e(re);var ge=o(re,2),ke=t(ge,!0);e(ge),e(ve),e(j1);var ce=o(j1,2),we=t(ce),Le=t(we,!0);e(we),e(ce),e(n1),e(W),N(()=>{Y(o1,"aria-label",r(g).ariaLabels.closeTimingBarModal),l(O1,r(g).timingBarsModalTitle),Y(H1,"aria-label",r(g).ariaLabels.closeButton),l(U1,r(g).timingBarsModalIntro),l(pe,r(g).timingBarsBulkTitle),l(De,r(g).timingBarsBulkBody),l(ie,r(g).timingBarsColdTitle),l(ke,r(g).timingBarsColdBody),l(Le,r(g).done)}),L("click",o1,()=>U(F,!1)),L("click",H1,()=>U(F,!1)),L("click",we,()=>U(F,!1)),k(J,W)};g1(a1,J=>{r(F)&&J(Z)})}N((J,W,o1,n1,h1,C1,O1,H1)=>{l(D,r(g).timing),Y(K,"aria-label",r(g).ariaLabels.learnTimingBars),p1(V,1,`badge badge-soft ${$[n.formula.tempBand]??"badge-ghost"??""} badge-md font-medium`),l(t1,`${r(g).tempBands[n.formula.tempBand]??""} (${J??""})`),p1(l1,1,`badge badge-soft ${G[n.formula.hydrationBand]??"badge-ghost"??""} badge-md font-medium`),l(M1,`${r(g).hydrationBands[n.formula.hydrationBand]??""} ${r(g).hydration??""} (${W??""}%)`),l(x1,`${o1??""}% ${r(g).inoculation??""}`),l(k1,r(g).bulkFermentation),l(T1,`${n1??""} – ${h1??""}`),Z1(y1,r(P)),Z1(w1,r(_)),l(X1,r(g).fastest),l(K1,r(g).slowest),l($1,C1),l(x,r(g).totalActiveTime),l(i1,`${O1??""} –
				${H1??""}`),l(B1,r(g).timingDisclaimer)},[()=>s().tempUnit==="F"?(n.formula.effectiveTempC*9/5+32).toFixed(1)+"°F":n.formula.effectiveTempC.toFixed(1)+"°C",()=>n.formula.finalHydrationPct.toFixed(1),()=>n.formula.inoculationPct.toFixed(1),()=>me(n.timing.bulkMin*60),()=>me(n.timing.bulkMax*60),()=>r(g).foldSchedule(n.timing.foldCount,n.timing.foldIntervalMins),()=>me((n.timing.bulkMin+(n.proofMethod==="Room"?n.timing.proofMin:n.timing.coldRetardMin))*60+d),()=>me((n.timing.bulkMax+(n.proofMethod==="Room"?n.timing.proofMax:n.timing.coldRetardMax))*60+i)]),L("click",K,()=>U(F,!0)),k(a,A),Pe(),b()}r2(["click"]);var j3=O("<div> </div>"),D3=O("<div> </div>"),L3=O("<p> </p>"),N3=O('<li class="relative flex gap-3 pb-3 cursor-pointer select-none group pl-11" role="checkbox" tabindex="0"><div class="absolute top-0 bottom-0 w-px left-4 bg-secondary/20"></div> <div><span class="-rotate-45"><!></span></div> <div><div class="flex items-start justify-between gap-2"><span> </span> <div class="text-right shrink-0"><!></div></div> <!></div></li>'),I3=O('<div class="absolute bottom-0 w-px left-4 top-8 bg-secondary/20"></div>'),$3=O("<div> </div>"),O3=O("<div> </div> <!>",1),E3=O("<div> </div>"),G3=O("<p> </p>"),W3=O("<button><!></button>"),U3=O('<div class="flex flex-wrap items-center gap-2 mt-2"></div>'),V3=O('<li class="relative flex gap-4 pb-5 cursor-pointer select-none group" role="checkbox" tabindex="0"><!> <div><!></div> <div><div class="flex items-start justify-between gap-2"><span> </span> <div class="text-right shrink-0"><!></div></div> <!> <!></div></li>'),K3=O('<div class="shadow-sm card bg-base-100 ring-1 ring-base-300/70"><div class="p-5 card-body"><h2 class="mb-1 text-base font-semibold tracking-wide uppercase text-base-content"> </h2> <p class="mb-3 text-xs italic text-base-content/60"> </p> <ol class="relative space-y-0"></ol></div></div>');function q3(a,n){He(n,!0);const c=()=>J1(Me,"$lang",s),[s,v]=Re(),b=m1(()=>je[c()]);let d=se(At(new Set)),i=se(At(new Map)),g=se("");T2(()=>{const M=JSON.stringify(n.steps.map(w=>w.label+"|"+w.durationMins+"|"+w.rangeMinMins));M!==r(g)&&(U(g,M,!0),U(d,new Set,!0),U(i,new Map,!0))});function F(M){const w=new Set(r(d));w.has(M)?w.delete(M):w.add(M),U(d,w,!0)}function z(M,w){const y=new Map(r(i)),D=new Set(y.get(M)??[]);D.has(w)?D.delete(w):D.add(w),y.set(M,D),U(i,y,!0);const K=n.steps[M]?.setCount??0;if(K>0&&D.size===K){const q=new Set(r(d));q.add(M),U(d,q,!0)}}function C(M,w){return r(i).get(M)?.has(w)??!1}const $=m1(()=>{let M=0;if(n.scheduleMode!=="clock"||!n.startTime)return n.steps.map(y=>{const D=y.isSubStep?-1:M++;return{step:y,clockTime:null,endClockTime:null,topLevelIndex:D}});let w=0;return n.steps.map(y=>{const D=y.isSubStep?-1:M++,K=jt(n.startTime,w),q=y.durationMins??(y.rangeMinMins!=null?y.rangeMinMins:0);w+=q;const V=jt(n.startTime,w);return{step:y,clockTime:K,endClockTime:V,topLevelIndex:D}})});function G(M){return M.durationMins!==null&&M.durationMins!==void 0?me(M.durationMins):M.rangeMinMins!==void 0&&M.rangeMaxMins!==void 0?`${me(M.rangeMinMins)} – ${me(M.rangeMaxMins)}`:""}var P=K3(),_=t(P),u=t(_),B=t(u,!0);e(u);var E=o(u,2),A=t(E,!0);e(E);var I=o(E,2);Y1(I,21,()=>r($),be,(M,w,y)=>{let D=()=>r(w).step,K=()=>r(w).clockTime,q=()=>r(w).endClockTime,V=()=>r(w).topLevelIndex;var t1=dt(),l1=te(t1);{var M1=x1=>{var v1=N3(),j=o(t(v1),2),f1=t(j),k1=t(f1);{var L1=u1=>{var b1=he("✓");k(u1,b1)},T1=m1(()=>r(d).has(y));g1(k1,u1=>{r(T1)&&u1(L1)})}e(f1),e(j);var R1=o(j,2),y1=t(R1),w1=t(y1),S1=t(w1,!0);e(w1);var F1=o(w1,2),X1=t(F1);{var N1=u1=>{var b1=j3(),E1=t(b1,!0);e(b1),N(A1=>{p1(b1,1,`text-xs tabular-nums ${A1??""}`),l(E1,K())},[()=>r(d).has(y)?"text-base-content/40 line-through":"text-secondary/70"]),k(u1,b1)},K1=u1=>{var b1=D3(),E1=t(b1,!0);e(b1),N((A1,Q)=>{p1(b1,1,`text-xs tabular-nums ${A1??""}`),l(E1,Q)},[()=>r(d).has(y)?"text-base-content/40 line-through":"text-secondary/70",()=>G(D())]),k(u1,b1)};g1(X1,u1=>{n.scheduleMode==="clock"&&K()?u1(N1):u1(K1,-1)})}e(F1),e(y1);var I1=o(y1,2);{var $1=u1=>{var b1=L3(),E1=t(b1,!0);e(b1),N(A1=>{p1(b1,1,`text-[11px] mt-0.5 leading-snug ${A1??""}`),l(E1,D().notes)},[()=>r(d).has(y)?"text-base-content/25 line-through":"text-base-content/55"]),k(u1,b1)};g1(I1,u1=>{D().notes&&u1($1)})}e(R1),e(v1),N((u1,b1,E1,A1)=>{Y(v1,"aria-checked",u1),p1(j,1,`shrink-0 w-5 h-5 rounded-sm rotate-45 text-[9px] font-bold flex items-center justify-center z-10 transition-colors mt-0.5
							${b1??""}`),p1(R1,1,`flex-1 min-w-0 transition-opacity ${E1??""}`),p1(w1,1,`text-xs font-medium leading-tight transition-colors
									${A1??""}`),l(S1,D().label)},[()=>r(d).has(y),()=>r(d).has(y)?"bg-success/15 text-success":"bg-secondary/10 text-secondary/70 group-hover:bg-secondary/20",()=>r(d).has(y)?"opacity-50":"",()=>r(d).has(y)?"text-base-content/40 line-through":"text-base-content/80"]),L("click",v1,()=>F(y)),L("keydown",v1,u1=>{(u1.key==="Enter"||u1.key===" ")&&(u1.preventDefault(),F(y))}),k(x1,v1)},r1=x1=>{var v1=V3(),j=t(v1);{var f1=H=>{var x=I3();k(H,x)};g1(j,H=>{y<r($).length-1&&H(f1)})}var k1=o(j,2),L1=t(k1);{var T1=H=>{var x=he("✓");k(H,x)},R1=m1(()=>r(d).has(y)),y1=H=>{var x=he();N(()=>l(x,V()+1)),k(H,x)};g1(L1,H=>{r(R1)?H(T1):H(y1,-1)})}e(k1);var w1=o(k1,2),S1=t(w1),F1=t(S1),X1=t(F1,!0);e(F1);var N1=o(F1,2),K1=t(N1);{var I1=H=>{var x=O3(),S=te(x),i1=t(S,!0);e(S);var c1=o(S,2);{var B1=a1=>{var Z=$3(),J=t(Z);e(Z),N(W=>{p1(Z,1,`text-xs text-base-content/50 tabular-nums ${W??""}`),l(J,`→ ${q()??""}`)},[()=>r(d).has(y)?"line-through":""]),k(a1,Z)};g1(c1,a1=>{q()&&q()!==K()&&a1(B1)})}N(a1=>{p1(S,1,`text-xs font-bold tabular-nums ${a1??""}`),l(i1,K())},[()=>r(d).has(y)?"text-base-content/50 line-through":"text-secondary"]),k(H,x)},$1=H=>{var x=E3(),S=t(x,!0);e(x),N((i1,c1)=>{p1(x,1,`text-xs font-bold tabular-nums ${i1??""}`),l(S,c1)},[()=>r(d).has(y)?"text-base-content/50 line-through":"text-secondary",()=>G(D())]),k(H,x)};g1(K1,H=>{n.scheduleMode==="clock"&&K()?H(I1):H($1,-1)})}e(N1),e(S1);var u1=o(S1,2);{var b1=H=>{var x=G3(),S=t(x,!0);e(x),N(i1=>{p1(x,1,`text-xs mt-1 leading-snug ${i1??""}`),l(S,D().notes)},[()=>r(d).has(y)?"text-base-content/30 line-through":"text-base-content/70"]),k(H,x)};g1(u1,H=>{D().notes&&H(b1)})}var E1=o(u1,2);{var A1=H=>{var x=U3();Y1(x,21,()=>Array.from({length:D().setCount},(S,i1)=>i1),be,(S,i1)=>{var c1=W3(),B1=t(c1);{var a1=W=>{var o1=he("✓");k(W,o1)},Z=m1(()=>C(y,r(i1))),J=W=>{var o1=he();N(()=>l(o1,r(i1)+1)),k(W,o1)};g1(B1,W=>{r(Z)?W(a1):W(J,-1)})}e(c1),N(W=>p1(c1,1,`w-7 h-7 rounded-full font-bold text-xs flex items-center justify-center transition-colors ${W??""}`),[()=>C(y,r(i1))?"bg-success/15 text-success":"bg-secondary/15 text-secondary hover:bg-secondary/25"]),L("click",c1,W=>{W.stopPropagation(),z(y,r(i1))}),k(S,c1)}),e(x),k(H,x)},Q=m1(()=>D().setCount&&!r(d).has(y));g1(E1,H=>{r(Q)&&H(A1)})}e(w1),e(v1),N((H,x,S,i1)=>{Y(v1,"aria-checked",H),p1(k1,1,`shrink-0 w-8 h-8 rounded-full font-bold text-xs flex items-center justify-center z-10 transition-colors
							${x??""}`),p1(w1,1,`flex-1 min-w-0 transition-opacity ${S??""}`),p1(F1,1,`text-sm font-semibold leading-tight transition-colors
									${i1??""}`),l(X1,D().label)},[()=>r(d).has(y),()=>r(d).has(y)?"bg-success/15 text-success":"bg-secondary/15 text-secondary group-hover:bg-secondary/25",()=>r(d).has(y)?"opacity-50":"",()=>r(d).has(y)?"text-base-content/50 line-through":"text-base-content"]),L("click",v1,()=>F(y)),L("keydown",v1,H=>{(H.key==="Enter"||H.key===" ")&&(H.preventDefault(),F(y))}),k(x1,v1)};g1(l1,x1=>{D().isSubStep?x1(M1):x1(r1,-1)})}k(M,t1)}),e(I),e(_),e(P),N(()=>{l(B,r(b).schedule),l(A,r(b).scheduleComplete)}),k(a,P),Pe(),v()}r2(["click","keydown"]);var Y3=O('<div class="card bg-base-100 shadow-sm ring-1 ring-base-300/70"><div class="card-body p-5"><h2 class="text-base font-semibold text-base-content uppercase tracking-wide mb-3"> </h2> <div class="text-sm text-base-content space-y-2"><p><span class="font-semibold text-secondary"> </span> </p> <p><span class="font-semibold text-warning"> </span> </p> <p><span class="font-semibold text-error"> </span> </p></div> <div class="mt-4 pt-4 border-t border-base-200 text-xs text-base-content/70 space-y-1"><p><strong> </strong> </p> <p><strong> </strong> </p> <p><strong> </strong> </p></div></div></div>');function Z3(a,n){He(n,!0);const c=()=>J1(Me,"$lang",s),[s,v]=Re(),b=m1(()=>je[c()]),d=m1(()=>r(b).guidance[n.crumbGoal]),i=m1(()=>r(b).crumbGoalNames[n.crumbGoal]);var g=Y3(),F=t(g),z=t(F),C=t(z,!0);e(z);var $=o(z,2),G=t($),P=t(G),_=t(P,!0);e(P);var u=o(P);e(G);var B=o(G,2),E=t(B),A=t(E,!0);e(E);var I=o(E);e(B);var M=o(B,2),w=t(M),y=t(w,!0);e(w);var D=o(w);e(M),e($);var K=o($,2),q=t(K),V=t(q),t1=t(V,!0);e(V);var l1=o(V);e(q);var M1=o(q,2),r1=t(M1),x1=t(r1,!0);e(r1);var v1=o(r1);e(M1);var j=o(M1,2),f1=t(j),k1=t(f1,!0);e(f1);var L1=o(f1);e(j),e(K),e(F),e(g),N(T1=>{l(C,r(b).readingYourCrumb),l(_,T1),l(u,` ${r(d).description??""}`),l(A,r(b).underFermented),l(I,` ${r(d).underFermented??""}`),l(y,r(b).overFermented),l(D,` ${r(d).overFermented??""}`),l(t1,r(b).floatTest),l(l1,` ${r(b).floatTestDesc??""}`),l(x1,r(b).pokeTest),l(v1,` ${r(b).pokeTestDesc??""}`),l(k1,r(b).jiggleTest),l(L1,` ${r(b).jiggleTestDesc??""}`)},[()=>r(b).target(r(i))]),k(a,g),Pe(),v()}var J3=O('<div class="flex justify-between items-center py-2 border-b border-base-200"><dt class="text-sm text-base-content/70"> </dt> <dd class="text-sm font-semibold text-base-content tabular-nums"> </dd></div>'),X3=O('<button type="button" class="fixed inset-0 z-40 bg-neutral/40 backdrop-blur-sm"></button> <div class="fixed bottom-0 left-0 right-0 z-50 max-h-[70vh] overflow-y-auto rounded-t-2xl bg-base-100 shadow-xl ring-1 ring-base-300/80" role="dialog" aria-modal="true"><div class="sticky top-0 flex items-center justify-between px-5 py-4 bg-base-100/95 backdrop-blur border-b border-base-200"><h2 class="text-base font-semibold text-base-content"> </h2> <button type="button" class="btn btn-ghost btn-sm btn-circle"><svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12"></path></svg></button></div> <div class="px-5 py-4"><p class="text-sm text-base-content/70 mb-4"> </p> <dl class="space-y-2"></dl></div> <div class="px-5 pb-6"><button type="button" class="btn btn-primary w-full"> </button></div></div>',1);function Q3(a,n){He(n,!0);const c=()=>J1(Me,"$lang",v),s=()=>J1(it,"$assumptionsOpen",v),[v,b]=Re(),d=m1(()=>je[c()]);function i(){it.set(!1)}var g=dt(),F=te(g);{var z=C=>{var $=X3(),G=te($),P=o(G,2),_=t(P),u=t(_),B=t(u,!0);e(u);var E=o(u,2);e(_);var A=o(_,2),I=t(A),M=t(I,!0);e(I);var w=o(I,2);Y1(w,21,()=>Object.entries(n.assumptions),be,(q,V)=>{var t1=m1(()=>er(r(V),2));let l1=()=>r(t1)[0],M1=()=>r(t1)[1];var r1=J3(),x1=t(r1),v1=t(x1,!0);e(x1);var j=o(x1,2),f1=t(j,!0);e(j),e(r1),N(()=>{l(v1,l1()),l(f1,M1())}),k(q,r1)}),e(w),e(A);var y=o(A,2),D=t(y),K=t(D,!0);e(D),e(y),e(P),N(()=>{Y(G,"aria-label",r(d).ariaLabels.closeAssumptionsDrawer),Y(P,"aria-label",r(d).calculationAssumptions),l(B,r(d).calculationAssumptions),Y(E,"aria-label",r(d).ariaLabels.closeButton),l(M,r(d).assumptionsDesc),l(K,r(d).done)}),L("click",G,i),L("click",E,i),L("click",D,i),k(C,$)};g1(F,C=>{s()&&C(z)})}k(a,g),Pe(),b()}r2(["click"]);var en=O('<div class="install-cta-row border-b border-neutral-content/15 bg-neutral/70 svelte-1uha8ag"><div class="max-w-2xl mx-auto px-4 py-2 flex justify-end"><button type="button"> </button></div></div>'),tn=O("<!> <!> <!> <!>",1),an=O('<div class="card bg-base-100/95 shadow-sm ring-1 ring-base-300/70"><div class="card-body items-center text-center"><div class="text-4xl mb-3" aria-hidden="true">⚖️</div> <p class="text-base-content/70 font-medium"> </p> <p class="text-base-content/50 text-sm mt-1"> </p></div></div>'),rn=O('<dialog class="modal modal-open" aria-modal="true" aria-labelledby="install-help-title"><div class="modal-box max-w-lg"><h3 id="install-help-title" class="text-lg font-semibold"> </h3> <p class="mt-2 text-sm text-base-content/80"> </p> <ul class="mt-3 list-disc space-y-2 pl-5 text-sm leading-relaxed text-base-content/90"><li> </li> <li> </li> <li> </li></ul> <div class="modal-action"><button type="button" class="btn btn-primary btn-sm rounded-full"> </button></div></div> <form method="dialog" class="modal-backdrop"><button type="button"> </button></form></dialog>'),nn=O('<div class="min-h-screen bg-gradient-to-b from-base-200 via-base-200 to-base-300/40"><header class="bg-neutral/95 text-neutral-content border-b border-primary/25 shadow-sm backdrop-blur supports-[backdrop-filter]:bg-neutral/90 sticky top-0 z-30"><!> <div class="max-w-2xl mx-auto px-4 py-4 flex flex-wrap items-center justify-between gap-y-3"><div class="flex items-center gap-3 min-w-0"><span class="flex h-9 w-9 shrink-0 items-center justify-center rounded-xl bg-primary/20 text-xl text-primary ring-1 ring-primary/35" aria-hidden="true">🍞</span> <div><h1 class="text-base font-bold text-neutral-content leading-tight">DoughCulator</h1> <p class="text-xs text-neutral-content/70 leading-tight"> </p></div></div> <div class="flex items-center flex-wrap justify-end gap-2"><label class="swap swap-rotate inline-grid h-9 w-9 place-items-center rounded-full border border-transparent bg-transparent text-neutral-content/75 transition-colors duration-200 hover:border-neutral-content/35 hover:bg-neutral-content/10 hover:text-neutral-content focus-within:border-primary/45 focus-within:ring-2 focus-within:ring-primary/55 focus-within:ring-offset-2 focus-within:ring-offset-neutral/95"><input type="checkbox" class="sr-only appearance-none"/> <svg class="swap-on h-5 w-5 fill-current" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M5.64,17l-.71.71a1,1,0,0,0,0,1.41,1,1,0,0,0,1.41,0l.71-.71A1,1,0,0,0,5.64,17ZM5,12a1,1,0,0,0-1-1H3a1,1,0,0,0,0,2H4A1,1,0,0,0,5,12Zm7-7a1,1,0,0,0,1-1V3a1,1,0,0,0-2,0V4A1,1,0,0,0,12,5ZM5.64,7.05a1,1,0,0,0,.7.29,1,1,0,0,0,.71-.29,1,1,0,0,0,0-1.41l-.71-.71A1,1,0,0,0,4.93,6.34Zm12,.29a1,1,0,0,0,.7-.29l.71-.71a1,1,0,1,0-1.41-1.41L17,5.64a1,1,0,0,0,0,1.41A1,1,0,0,0,17.66,7.34ZM21,11H20a1,1,0,0,0,0,2h1a1,1,0,0,0,0-2Zm-9,8a1,1,0,0,0-1,1v1a1,1,0,0,0,2,0V20A1,1,0,0,0,12,19ZM18.36,17A1,1,0,0,0,17,18.36l.71.71a1,1,0,0,0,1.41,0,1,1,0,0,0,0-1.41ZM12,6.5A5.5,5.5,0,1,0,17.5,12,5.51,5.51,0,0,0,12,6.5Zm0,9A3.5,3.5,0,1,1,15.5,12,3.5,3.5,0,0,1,12,15.5Z"></path></svg> <svg class="swap-off h-5 w-5 fill-current" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M21.64,13a1,1,0,0,0-1.05-.14,8.05,8.05,0,0,1-3.37.73A8.15,8.15,0,0,1,9.08,5.49a8.59,8.59,0,0,1,.25-2A1,1,0,0,0,8,2.36,10.14,10.14,0,1,0,22,14.05,1,1,0,0,0,21.64,13Zm-9.5,6.69A8.14,8.14,0,0,1,7.08,5.22v.27A10.15,10.15,0,0,0,17.22,15.63a9.79,9.79,0,0,0,2.1-.22A8.11,8.11,0,0,1,12.14,19.73Z"></path></svg></label> <div class="join border border-neutral-content/25 rounded-full bg-neutral-content/5 p-0.5"><button type="button">EN</button> <button type="button">ES</button> <button type="button">SV</button></div> <button type="button" class="btn btn-outline btn-sm rounded-full border-neutral-content/25 text-neutral-content/80 hover:border-neutral-content/40 hover:bg-neutral-content/10 hover:text-neutral-content"> </button> <button type="button"> </button></div></div></header> <main class="max-w-2xl mx-auto px-4 py-6 space-y-4"><!> <!></main> <footer class="max-w-2xl mx-auto px-4 py-8 text-center text-xs text-base-content/60"><p> </p> <p class="mt-1"> </p> <div class="mt-6 flex justify-center"><a href="https://www.buymeacoffee.com/alestryperez" target="_blank" rel="noopener noreferrer"><img src="https://cdn.buymeacoffee.com/buttons/v2/default-yellow.png" alt="Buy Me A Coffee" style="height: 60px !important; width: 217px !important;" loading="lazy"/></a></div></footer> <!></div> <!>',1);function mn(a,n){He(n,!0);const c=()=>J1(Me,"$lang",b),s=()=>J1(Vt,"$result",b),v=()=>J1(ue,"$inputs",b),[b,d]=Re(),i=m1(()=>je[c()]);let g=se(!1),F=se(null),z=se(!1),C=se("idle");function $(){const x=s().formula,S=s().schedule,i1=s().assumptions,c1=S.map((a1,Z)=>{let J="";return a1.durationMins!==null&&a1.durationMins!==void 0?J=me(a1.durationMins):a1.rangeMinMins!==void 0&&a1.rangeMaxMins!==void 0&&(J=`${me(a1.rangeMinMins)} – ${me(a1.rangeMaxMins)}`),`${Z+1}. ${a1.label}${J?" ("+J+")":""}${a1.notes?" — "+a1.notes:""}`}),B1=Object.entries(i1).map(([a1,Z])=>`${a1}: ${Z}`);return[r(i).copyTitle,r(i).copyDivider,`${r(i).totalFlourRow}: ${Math.round(x.totalFlourG)}g (${v().flourBlend.map(a1=>`${r(i).flourTypes[a1.type]??a1.type}: ${Math.round(x.totalFlourG*a1.pct/100)}g`).join(", ")})`,`${r(i).water}: ${Math.round(x.totalWaterG)}g (${x.finalHydrationPct.toFixed(1)}%)`,`${r(i).saltRow}: ${Math.round(x.saltG)}g`,`${r(i).starter}: ${Math.round(x.starterTotalG)}g`,"",r(i).copyScheduleHeader,r(i).copyScheduleDivider,...c1,"",r(i).copyAssumptionsHeader,r(i).copyAssumptionsDivider,...B1,"",r(i).copyFooter].join(`
`)}async function G(){const x=$();try{if(!navigator.clipboard?.writeText)throw new Error("Clipboard API unavailable");await navigator.clipboard.writeText(x),U(g,!0),setTimeout(()=>U(g,!1),2500)}catch{const S=document.createElement("textarea");S.value=x,S.setAttribute("readonly",""),S.style.position="fixed",S.style.opacity="0",S.style.pointerEvents="none",document.body.appendChild(S),S.focus(),S.select();try{document.execCommand("copy")&&(U(g,!0),setTimeout(()=>U(g,!1),2500))}finally{document.body.removeChild(S)}}}function P(){it.set(!0)}function _(x){Me.set(x)}function u(){if(typeof window>"u")return!1;const x=navigator;return window.matchMedia("(display-mode: standalone)").matches||x.standalone===!0}async function B(){if(u()){U(C,"installed");return}if(!r(F)){U(z,!0);return}await r(F).prompt();const{outcome:x}=await r(F).userChoice;U(C,x,!0),U(F,null),U(z,!1)}function E(){U(z,!1)}const A=m1(()=>v().totalFlourInputG);let I=se(!1);T2(()=>{if(u()){U(C,"installed"),U(F,null);return}const x=i1=>{const c1=i1;c1.preventDefault(),U(F,c1,!0),U(C,"idle")},S=()=>{U(C,"installed"),U(F,null),U(z,!1)};return window.addEventListener("beforeinstallprompt",x),window.addEventListener("appinstalled",S),()=>{window.removeEventListener("beforeinstallprompt",x),window.removeEventListener("appinstalled",S)}}),T2(()=>{U(I,localStorage.getItem("theme")==="dark")}),T2(()=>{const x=r(I)?"dark":"bumblebee";document.documentElement.setAttribute("data-theme",x),localStorage.setItem("theme",x)});var M=nn();rr("1uha8ag",x=>{$t(()=>{tr.title="DoughCulator"})});var w=te(M),y=t(w),D=t(y);{var K=x=>{var S=en(),i1=t(S),c1=t(i1),B1=t(c1,!0);e(c1),e(i1),e(S),N(()=>{p1(c1,1,`btn btn-xs sm:btn-sm rounded-full shadow-sm ${r(F)?"btn-primary":"btn-outline border-neutral-content/30 text-neutral-content hover:border-neutral-content/45 hover:bg-neutral-content/10 hover:text-neutral-content"}`),l(B1,r(i).saveToHomeScreen)}),L("click",c1,B),k(x,S)};g1(D,x=>{r(C)!=="installed"&&x(K)})}var q=o(D,2),V=t(q),t1=o(t(V),2),l1=o(t(t1),2),M1=t(l1,!0);e(l1),e(t1),e(V);var r1=o(V,2),x1=t(r1),v1=t(x1);ne(v1),a2(4),e(x1);var j=o(x1,2),f1=t(j),k1=o(f1,2),L1=o(k1,2);e(j);var T1=o(j,2),R1=t(T1,!0);e(T1);var y1=o(T1,2),w1=t(y1,!0);e(y1),e(r1),e(q),e(y);var S1=o(y,2),F1=t(S1);k3(F1,{});var X1=o(F1,2);{var N1=x=>{var S=tn(),i1=te(S);C3(i1,{get formula(){return s().formula},get flourBlend(){return v().flourBlend}});var c1=o(i1,2);R3(c1,{get timing(){return s().timing},get formula(){return s().formula},get proofMethod(){return v().proofMethod}});var B1=o(c1,2);{let Z=m1(()=>v().scheduleMode==="clock"?v().startTime??"08:00":null);q3(B1,{get steps(){return s().schedule},get scheduleMode(){return v().scheduleMode},get startTime(){return r(Z)}})}var a1=o(B1,2);Z3(a1,{get crumbGoal(){return v().crumbGoal}}),k(x,S)},K1=x=>{var S=an(),i1=t(S),c1=o(t(i1),2),B1=t(c1,!0);e(c1);var a1=o(c1,2),Z=t(a1,!0);e(a1),e(i1),e(S),N(()=>{l(B1,r(i).emptyStateTitle),l(Z,r(i).emptyStateSubtitle)}),k(x,S)};g1(X1,x=>{r(A)>0?x(N1):x(K1,-1)})}e(S1);var I1=o(S1,2),$1=t(I1),u1=t($1,!0);e($1);var b1=o($1,2),E1=t(b1,!0);e(b1),a2(2),e(I1);var A1=o(I1,2);{var Q=x=>{var S=rn(),i1=t(S),c1=t(i1),B1=t(c1,!0);e(c1);var a1=o(c1,2),Z=t(a1,!0);e(a1);var J=o(a1,2),W=t(J),o1=t(W,!0);e(W);var n1=o(W,2),h1=t(n1,!0);e(n1);var C1=o(n1,2),O1=t(C1,!0);e(C1),e(J);var H1=o(J,2),j1=t(H1),G1=t(j1,!0);e(j1),e(H1),e(i1);var U1=o(i1,2),D1=t(U1),ae=t(D1,!0);e(D1),e(U1),e(S),N(()=>{l(B1,r(i).installHelpTitle),l(Z,r(i).installHelpIntro),l(o1,r(i).installHelpIOS),l(h1,r(i).installHelpAndroid),l(O1,r(i).installHelpDesktop),l(G1,r(i).close),Y(D1,"aria-label",r(i).close),l(ae,r(i).close)}),L("click",j1,E),L("click",D1,E),k(x,S)};g1(A1,x=>{r(z)&&x(Q)})}e(w);var H=o(w,2);Q3(H,{get assumptions(){return s().assumptions}}),N(()=>{l(M1,r(i).appSubtitle),Y(x1,"aria-label",r(i).ariaLabels.toggleDarkMode),Y(j,"aria-label",r(i).ariaLabels.selectLanguage),p1(f1,1,`btn btn-xs join-item rounded-l-full border-0 ${c()==="en"?"btn-primary":"btn-ghost text-neutral-content/70 hover:text-neutral-content hover:bg-neutral-content/10"}`),p1(k1,1,`btn btn-xs join-item border-0 ${c()==="es"?"btn-primary":"btn-ghost text-neutral-content/70 hover:text-neutral-content hover:bg-neutral-content/10"}`),p1(L1,1,`btn btn-xs join-item rounded-r-full border-0 ${c()==="sv"?"btn-primary":"btn-ghost text-neutral-content/70 hover:text-neutral-content hover:bg-neutral-content/10"}`),l(R1,r(i).assumptions),y1.disabled=r(A)<=0,p1(y1,1,`btn btn-sm rounded-full shadow-sm ${r(g)?"btn-success":r(A)>0?"btn-primary":"btn-disabled"}`),l(w1,r(g)?r(i).copied:r(i).copyRecipe),l(u1,r(i).footerLine1),l(E1,r(i).footerLine2)}),fr(v1,()=>r(I),x=>U(I,x)),L("click",f1,()=>_("en")),L("click",k1,()=>_("es")),L("click",L1,()=>_("sv")),L("click",T1,P),L("click",y1,G),k(a,M),Pe(),d()}r2(["click"]);export{mn as component};
