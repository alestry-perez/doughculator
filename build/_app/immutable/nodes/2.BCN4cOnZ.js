...
m74 -27 c18 -7 22 -34 5 -34 -17 0 -49 20 -49 30 0 11 21 13 44 4z"></path></g></g></svg>`);function l3(a,n){let c=g2(n,"class",3,"");var s=s3();R(()=>u1(s,0,We(c()))),_(a,s)}var i3=Rt('<circle cx="100" cy="100" fill="none" stroke-width="18" stroke-linecap="butt" transform="rotate(-90 100 100)" class="transition-all duration-300"></circle>'),c3=N('<span class="flex items-center gap-1 text-xs text-base-content/50 tabular-nums"><span class="inline-block w-2 h-2 rounded-full flex-shrink-0"></span> </span>'),d3=N('<div class="flex flex-wrap justify-center gap-x-3 gap-y-0.5 mt-1"></div>'),u3=N('<button type="button"> </button>'),m3=N('<div class="flex items-center gap-2"><span class="inline-block w-3 h-3 rounded-full flex-shrink-0"></span> <span class="text-xs text-base-content/70 flex-1 min-w-0 truncate"> </span> <div class="flex items-center gap-2 flex-1"><input type="range" min="0" max="100" step="1" class="range range-sm range-secondary flex-1"/> <input type="number" min="0" max="100" step="1" class="input input-xs w-14 text-right tabular-nums"/> <span class="text-xs text-base-content/70">%</span></div></div>'),p3=N('<button type="button" class="btn btn-xs btn-ghost text-secondary border border-secondary/30"> </button>'),v3=N('<div class="mt-3 space-y-2"></div> <div class="flex items-center justify-between mt-2"><span class="text-xs text-base-content/50"> <span> </span></span> <!></div>',1),b3=N('<div class="px-5 pb-3"><!></div>'),g3=N('<button type="button"><!> <span class="text-xs font-bold"> </span></button>'),f3=N('<button type="button"> </button>'),h3=N('<button type="button"> </button>'),M3=N('<div class="form-control mt-3 pl-4 border-l-2 border-secondary/20"><label for="fridge-temp" class="label"><span class="label-text text-xs font-semibold text-base-content/70 uppercase tracking-wide"> </span></label> <input id="fridge-temp" type="number" step="0.5" class="input border-0 border-b-2 border-base-300 rounded-none focus:border-secondary focus:outline-none bg-transparent w-full"/></div>'),x3=N('<button type="button"> </button>'),y3=N('<div class="form-control mt-3 pl-4 border-l-2 border-secondary/20"><label for="start-time" class="label"><span class="label-text text-xs font-semibold text-base-content/70 uppercase tracking-wide"> </span></label> <input id="start-time" type="time" class="input border-0 border-b-2 border-base-300 rounded-none focus:border-secondary focus:outline-none bg-transparent w-full"/></div>'),z3=N('<div class="form-control"><input id="salt-pct" type="number" min="1" max="3" step="0.1" class="input border-0 border-b-2 border-base-300 rounded-none focus:border-secondary focus:outline-none bg-transparent w-full" placeholder="2.0"/></div> <p class="text-xs text-base-content/50 mt-1"> </p>',1),_3=N('<div class="form-control"><input id="starter-hyd" type="number" min="50" max="200" step="5" class="input border-0 border-b-2 border-base-300 rounded-none focus:border-secondary focus:outline-none bg-transparent w-full"/></div>'),k3=N('<div><div class="flex justify-between text-xs text-base-content/70 mb-1"><span> </span> <span class="font-semibold text-base-content"> </span></div> <progress class="progress progress-secondary progress-sm w-full"></progress> <div class="flex justify-between text-xs text-base-content/50 mt-0.5"><span></span> <span></span></div></div>'),w3=N('<div class="modal modal-open"><button type="button" class="modal-backdrop"></button> <div class="modal-box w-full max-w-sm p-0 overflow-hidden" role="dialog" aria-modal="true" aria-labelledby="philosophy-modal-title"><div class="flex items-center justify-between px-5 py-4 border-b border-base-200"><h2 id="philosophy-modal-title" class="text-base font-semibold text-base-content"> </h2> <button type="button" class="btn btn-ghost btn-sm btn-circle"><svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12"></path></svg></button></div> <div class="px-5 py-4 space-y-4"><div><p class="text-xs font-semibold text-secondary uppercase tracking-wide mb-1"> </p> <p class="text-sm text-base-content/70 leading-relaxed"> </p></div> <div class="border-t border-base-200 pt-4"><p class="text-xs font-semibold text-secondary uppercase tracking-wide mb-1"> </p> <p class="text-sm text-base-content/70 leading-relaxed"> </p></div></div> <div class="px-5 pb-5"><button type="button" class="btn btn-primary w-full"> </button></div></div></div>'),T3=N("<li> </li>"),F3=N("<li> </li>"),S3=N('<div class="modal modal-open"><button type="button" class="modal-backdrop"></button> <div class="modal-box w-full max-w-md p-0 overflow-hidden" role="dialog" aria-modal="true" aria-labelledby="autolyse-modal-title"><div class="flex items-center justify-between px-5 py-4 border-b border-base-200"><h2 id="autolyse-modal-title" class="text-base font-semibold text-base-content"> </h2> <button type="button" class="btn btn-ghost btn-sm btn-circle"><svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12"></path></svg></button></div> <div class="px-5 py-4 space-y-4"><p class="text-sm text-base-content/70 leading-relaxed"> </p> <div><p class="text-xs font-semibold text-success uppercase tracking-wide mb-1"> </p> <ul class="list-disc pl-5 space-y-1 text-sm text-base-content/70 leading-relaxed"></ul></div> <div class="border-t border-base-200 pt-4"><p class="text-xs font-semibold text-warning uppercase tracking-wide mb-1"> </p> <ul class="list-disc pl-5 space-y-1 text-sm text-base-content/70 leading-relaxed"></ul></div></div> <div class="px-5 pb-5"><button type="button" class="btn btn-primary w-full"> </button></div></div></div>'),C3=N('<div class="modal modal-open"><button type="button" class="modal-backdrop"></button> <div class="modal-box w-full max-w-sm p-0 overflow-hidden" role="dialog" aria-modal="true" aria-labelledby="proof-method-modal-title"><div class="flex items-center justify-between px-5 py-4 border-b border-base-200"><h2 id="proof-method-modal-title" class="text-base font-semibold text-base-content"> </h2> <button type="button" class="btn btn-ghost btn-sm btn-circle"><svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12"></path></svg></button></div> <div class="px-5 py-4 space-y-4"><div><p class="text-xs font-semibold text-secondary uppercase tracking-wide mb-1"> </p> <p class="text-sm text-base-content/70 leading-relaxed"> </p></div> <div class="border-t border-base-200 pt-4"><p class="text-xs font-semibold text-secondary uppercase tracking-wide mb-1"> </p> <p class="text-sm text-base-content/70 leading-relaxed"> </p></div></div> <div class="px-5 pb-5"><button type="button" class="btn btn-primary w-full"> </button></div></div></div>'),A3=N('<div class="modal modal-open"><button type="button" class="modal-backdrop"></button> <div class="modal-box w-full max-w-sm p-0 overflow-hidden" role="dialog" aria-modal="true" aria-labelledby="crumb-goal-modal-title"><div class="flex items-center justify-between px-5 py-4 border-b border-base-200"><h2 id="crumb-goal-modal-title" class="text-base font-semibold text-base-content"> </h2> <button type="button" class="btn btn-ghost btn-sm btn-circle"><svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12"></path></svg></button></div> <div class="px-5 py-4 space-y-4"><div><p class="text-xs font-semibold text-secondary uppercase tracking-wide mb-1"> </p> <p class="text-sm text-base-content/70 leading-relaxed"> </p></div> <div class="border-t border-base-200 pt-4"><p class="text-xs font-semibold text-secondary uppercase tracking-wide mb-1"> </p> <p class="text-sm text-base-content/70 leading-relaxed"> </p></div> <div class="border-t border-base-200 pt-4"><p class="text-xs font-semibold text-secondary uppercase tracking-wide mb-1"> </p> <p class="text-sm text-base-content/70 leading-relaxed"> </p></div></div> <div class="px-5 pb-5"><button type="button" class="btn btn-primary w-full"> </button></div></div></div>'),B3=N('<div class="card bg-base-100 shadow-sm ring-1 ring-base-300/70 overflow-hidden"><div class="px-5 pt-5 pb-3"><h2 class="text-base font-semibold text-base-content uppercase tracking-wide"> </h2></div> <div class="px-5 pb-5 space-y-5"><div class="flex flex-col items-center"><div class="relative w-44 h-44"><svg viewBox="0 0 200 200" class="w-full h-full"><circle cx="100" cy="100" fill="none" class="stroke-base-300/30" stroke-width="18"></circle><!></svg> <div class="absolute inset-0 flex flex-col items-center justify-center pointer-events-none"><div class="flex items-baseline pointer-events-auto"><input id="total-flour" type="number" min="0" step="50" class="w-28 bg-transparent border-none text-center text-3xl font-bold text-base-content focus:outline-none tabular-nums [appearance:textfield] [&amp;::-webkit-outer-spin-button]:appearance-none [&amp;::-webkit-inner-spin-button]:appearance-none" placeholder="500"/> <span class="text-lg font-bold text-base-content/70 -ml-1">g</span></div> <span class="text-xs text-base-content/50"> </span></div></div> <!></div> <div><span class="text-xs font-semibold text-base-content/70 uppercase tracking-wide"> </span> <div class="grid grid-cols-3 gap-2 mt-2"></div> <!></div> <div><div class="flex items-center justify-between mb-2"><span class="text-xs font-semibold text-base-content/70 uppercase tracking-wide"> </span> <button type="button" class="btn btn-ghost btn-xs rounded-full border border-base-300 bg-base-100"><span>°C</span> <span class="text-base-content/30">/</span> <span>°F</span></button></div> <div class="grid grid-cols-2 gap-3"><div class="form-control"><label for="ambient-temp" class="label py-1"><span class="label-text text-xs text-base-content/70"> </span></label> <input id="ambient-temp" type="number" step="0.5" class="input border-0 border-b-2 border-base-300 rounded-none focus:border-secondary focus:outline-none bg-transparent w-full"/></div> <div class="form-control"><label for="dough-temp" class="label py-1"><span class="label-text text-xs text-base-content/70"> <span class="text-base-content/40"> </span></span></label> <input id="dough-temp" type="number" step="0.5" class="input border-0 border-b-2 border-base-300 rounded-none focus:border-secondary focus:outline-none bg-transparent w-full placeholder:text-base-content/30"/></div></div></div></div> <!> <div class="border-t border-base-200"><div class="px-5 py-3"><span class="text-xs font-semibold text-base-content/70 uppercase tracking-wide"> </span></div> <div class="px-5 pb-5 space-y-5"><div><div class="flex items-center gap-1.5 mb-2"><p class="text-xs font-semibold text-base-content/70 uppercase tracking-wide"> </p> <button type="button" class="btn btn-ghost btn-xs btn-circle flex-shrink-0"><svg xmlns="http://www.w3.org/2000/svg" class="w-[1.14rem] h-[1.14rem]" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true"><path fill-rule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7-4a1 1 0 11-2 0 1 1 0 012 0zM9 9a1 1 0 000 2v3a1 1 0 001 1h1a1 1 0 100-2v-3a1 1 0 00-1-1H9z" clip-rule="evenodd"></path></svg></button></div> <div class="grid grid-cols-3 gap-2"></div> <p class="text-xs text-base-content/70 mt-2 leading-snug"> </p></div> <div><div class="flex items-center gap-1.5 mb-2"><p class="text-xs font-semibold text-base-content/70 uppercase tracking-wide"> </p> <button type="button" class="btn btn-ghost btn-xs btn-circle flex-shrink-0"><svg xmlns="http://www.w3.org/2000/svg" class="w-[1.14rem] h-[1.14rem]" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true"><path fill-rule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7-4a1 1 0 11-2 0 1 1 0 012 0zM9 9a1 1 0 000 2v3a1 1 0 001 1h1a1 1 0 100-2v-3a1 1 0 00-1-1H9z" clip-rule="evenodd"></path></svg></button></div> <div class="grid grid-cols-2 gap-2"></div> <p class="text-xs text-base-content/70 mt-2 leading-snug"> </p></div> <div><div class="flex items-center gap-1.5 mb-2"><p class="text-xs font-semibold text-base-content/70 uppercase tracking-wide"> </p> <button type="button" class="btn btn-ghost btn-xs btn-circle flex-shrink-0"><svg xmlns="http://www.w3.org/2000/svg" class="w-[1.14rem] h-[1.14rem]" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true"><path fill-rule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7-4a1 1 0 11-2 0 1 1 0 012 0zM9 9a1 1 0 000 2v3a1 1 0 001 1h1a1 1 0 100-2v-3a1 1 0 00-1-1H9z" clip-rule="evenodd"></path></svg></button></div> <div class="grid grid-cols-2 gap-2"></div> <!></div> <div><p class="text-xs font-semibold text-base-content/70 uppercase tracking-wide mb-2"> </p> <div class="grid grid-cols-2 gap-2"></div> <!></div></div></div> <div class="border-t border-base-200"><div class="px-5 py-3"><span class="text-xs font-semibold text-base-content/70 uppercase tracking-wide"> </span></div> <div class="px-5 pb-5 space-y-4"><div><div class="flex items-center justify-between mb-1.5"><span class="text-xs font-semibold text-base-content/70 uppercase tracking-wide"> </span> <div class="flex items-center gap-2"><span class="text-xs text-base-content/50"><!></span> <input type="checkbox" class="toggle toggle-secondary toggle-sm" role="switch"/> <span class="text-xs text-base-content/70"> </span></div></div> <!></div> <div><div class="flex items-center justify-between mb-1.5"><span class="text-xs font-semibold text-base-content/70 uppercase tracking-wide"> </span> <div class="flex items-center gap-2"><span class="text-xs text-base-content/50"> </span> <input type="checkbox" class="toggle toggle-secondary toggle-sm" role="switch"/> <span class="text-xs text-base-content/70"> </span></div></div> <!></div> <div><div class="flex items-center justify-between mb-1.5"><div class="flex items-center gap-1.5"><span class="text-xs font-semibold text-base-content/70 uppercase tracking-wide"> </span> <button type="button" class="btn btn-ghost btn-xs btn-circle flex-shrink-0"><svg xmlns="http://www.w3.org/2000/svg" class="w-[1.14rem] h-[1.14rem]" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true"><path fill-rule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7-4a1 1 0 11-2 0 1 1 0 012 0zM9 9a1 1 0 000 2v3a1 1 0 001 1h1a1 1 0 100-2v-3a1 1 0 00-1-1H9z" clip-rule="evenodd"></path></svg></button></div> <div class="flex items-center gap-2"><span> </span> <input type="checkbox" class="toggle toggle-secondary toggle-sm" role="switch"/> <span> </span></div></div> <!></div></div></div></div> <!> <!> <!> <!>',1);function H3(a,n){De(n,!0);const c=()=>oe(ye,"$lang",f),s=()=>oe(be,"$inputs",f),b=()=>oe(J2,"$result",f),[f,d]=$e(),i=m1(()=>Ne[c()]);let g=le(!1),A=le(!1),y=le(!1),S=le(!1);const G=["Tight","Balanced","Open"],J={Tight:r3,Balanced:o3,Open:l3};let D=m1(()=>s().flourBlend.reduce((m,p)=>m+p.pct,0)),k=m1(()=>Math.round(r(D))===100);function u(m){return s().flourBlend.some(p=>p.type===m)}function L(m){be.update(p=>{if(p.flourBlend.find(M=>M.type===m)){if(p.flourBlend.length<=1)return p;const M=p.flourBlend.filter(o1=>o1.type!==m),F=M.reduce((o1,Q)=>o1+Q.pct,0);let B;if(F>0){const o1=100/F;B=M.map(Q=>({...Q,pct:Math.round(Q.pct*o1)}))}else{const o1=Math.floor(100/M.length);B=M.map((Q,_1)=>({...Q,pct:_1===0?o1+(100-o1*M.length):o1}))}const t1=B.reduce((o1,Q)=>o1+Q.pct,0);return t1!==100&&B.length>0&&(B[0]={...B[0],pct:B[0].pct+(100-t1)}),{...p,flourBlend:B}}else{const M=p.flourBlend.length+1,F=Math.round(100/M),B=(100-F)/100,t1=p.flourBlend.map(Q=>({...Q,pct:Math.round(Q.pct*B)}));t1.push({type:m,pct:F});const o1=t1.reduce((Q,_1)=>Q+_1.pct,0);return o1!==100&&t1.length>0&&(t1[0]={...t1[0],pct:t1[0].pct+(100-o1)}),{...p,flourBlend:t1}}})}function U(m,p){const v=Math.max(0,Math.min(100,parseFloat(p)||0));be.update(M=>{const F=M.flourBlend.filter(Q=>Q.type!==m),B=F.reduce((Q,_1)=>Q+_1.pct,0),t1=100-v;let o1;if(F.length===0)o1=M.flourBlend.map(Q=>({...Q,pct:100}));else if(B===0){const Q=Math.floor(t1/F.length),_1=t1-Q*F.length;o1=M.flourBlend.map((f1,j1)=>{if(f1.type===m)return{...f1,pct:v};const D1=F.indexOf(f1);return{...f1,pct:Q+(D1===0?_1:0)}})}else{const Q=t1/B,_1=F.map(s1=>({...s1,pct:s1.pct*Q})),f1=_1.map(s1=>({...s1,pct:Math.floor(s1.pct)})),j1=f1.reduce((s1,V1)=>s1+V1.pct,0);let D1=t1-j1;const me=_1.map((s1,V1)=>({i:V1,frac:s1.pct-Math.floor(s1.pct)})).sort((s1,V1)=>V1.frac-s1.frac);for(let s1=0;s1<D1;s1++)f1[me[s1].i].pct+=1;const U1=new Map(f1.map(s1=>[s1.type,s1.pct]));o1=M.flourBlend.map(s1=>s1.type===m?{...s1,pct:v}:{...s1,pct:U1.get(s1.type)??s1.pct})}return{...M,flourBlend:o1}})}function $(){be.update(m=>{const p=m.flourBlend.reduce((B,t1)=>B+t1.pct,0);if(p===0||p===100)return m;const v=100/p,M=m.flourBlend.map(B=>({...B,pct:Math.round(B.pct*v)})),F=M.reduce((B,t1)=>B+t1.pct,0);return F!==100&&M.length>0&&(M[0]={...M[0],pct:M[0].pct+(100-F)}),{...m,flourBlend:M}})}const I={BreadFlour:"#F59E0B",AllPurpose:"#60A5FA",WholeWheat:"#92400E",Rye:"#059669",Spelt:"#7C3AED",Einkorn:"#F43F5E"},x=80,T=2*Math.PI*x;let z=m1(()=>{let m=0;return s().flourBlend.map(p=>{const v=p.pct/100*T,M={type:p.type,color:I[p.type],dasharray:`${v} ${T-v}`,dashoffset:-m};return m+=v,M})}),H=m1(()=>b().formula.autoSaltPct),j=m1(()=>Math.round(b().formula.saltG)),V=m1(()=>s().tempUnit==="F"?Math.round(l2(s().ambientTempC)):s().ambientTempC),Y=m1(()=>s().doughTempC===null?"":s().tempUnit==="F"?Math.round(l2(s().doughTempC)):s().doughTempC),a1=m1(()=>s().tempUnit==="F"?Math.round(l2(s().fridgeTempC)):s().fridgeTempC);function b1(m,p){const v=s().tempUnit==="F"?Ir(p):p;be.update(M=>{const F={...M,[m]:v};return M.autolyseOn&&(m==="ambientTempC"||m==="doughTempC")?{...F,autolyseMins:xt(F.ambientTempC,F.doughTempC)}:F})}function l1(m,p){be.update(v=>({...v,[m]:p}))}function c1(){be.update(m=>({...m,tempUnit:m.tempUnit==="C"?"F":"C"}))}function x1(m){const p=Math.max(0,parseFloat(m.target.value)||0);l1("totalFlourInputG",p)}function g1(m){const p=m.target;let v=parseFloat(p.value);isNaN(v)||(v=Math.min(r(T1),Math.max(r(k1),v)),b1("ambientTempC",v))}function O(m){const v=m.target.value;if(v==="")be.update(M=>{const F={...M,doughTempC:null};return M.autolyseOn?{...F,autolyseMins:xt(F.ambientTempC,F.doughTempC)}:F});else{let M=parseFloat(v);isNaN(M)||(M=Math.min(r(T1),Math.max(r(k1),M)),b1("doughTempC",M))}}function z1(){be.update(m=>m.autolyseOn?{...m,autolyseOn:!1}:{...m,autolyseOn:!0,autolyseMins:xt(m.ambientTempC,m.doughTempC)})}function B1(m){let p=parseFloat(m.target.value);isNaN(p)||(p=Math.min(r(F1),Math.max(r(C1),p)),b1("fridgeTempC",p))}const R1='a[href],button:not([disabled]),input:not([disabled]),select:not([disabled]),textarea:not([disabled]),[tabindex]:not([tabindex="-1"])';function H1(m,p){const v=Array.from(m.querySelectorAll(R1));v.length&&v[0].focus();function M(F){if(F.key==="Escape"){W(g,!1),W(A,!1),W(y,!1),W(S,!1);return}if(F.key!=="Tab")return;const B=v[0],t1=v[v.length-1];F.shiftKey?document.activeElement===B&&(F.preventDefault(),t1.focus()):document.activeElement===t1&&(F.preventDefault(),B.focus())}return m.addEventListener("keydown",M),{destroy(){m.removeEventListener("keydown",M)}}}function L1(m){return H1(m)}const k1=m1(()=>s().tempUnit==="F"?32:0),T1=m1(()=>s().tempUnit==="F"?120:50),C1=m1(()=>s().tempUnit==="F"?28:-2),F1=m1(()=>s().tempUnit==="F"?50:10),J1=20,X1=60-J1,$1=m1(()=>Math.max(0,Math.min(X1,s().autolyseMins-J1)));var N1=B3(),W1=ne(N1),K1=t(W1),p1=t(K1),h1=t(p1,!0);e(p1),e(K1);var K=o(K1,2),C=t(K),h=t(C),w=t(h),X=t(w);Z(X,"r",x);var e1=o(X);Z1(e1,17,()=>r(z),m=>m.type,(m,p)=>{var v=i3();Z(v,"r",x),R(()=>{Z(v,"stroke",r(p).color),Z(v,"stroke-dasharray",r(p).dasharray),Z(v,"stroke-dashoffset",r(p).dashoffset)}),_(m,v)}),e(w);var A1=o(w,2),q=t(A1),S1=t(q);ce(S1),ot(2),e(q);var y1=o(q,2),E=t(y1,!0);e(y1),e(A1),e(h);var r1=o(h,2);{var i1=m=>{var p=d3();Z1(p,5,()=>s().flourBlend,v=>v.type,(v,M)=>{var F=c3(),B=t(F),t1=o(B);e(F),R(o1=>{L2(B,`background-color: ${I[r(M).type]??""}`),l(t1,` ${r(i).flourTypes[r(M).type]??""}: ${o1??""}g`)},[()=>Math.round(s().totalFlourInputG*r(M).pct/100)]),_(v,F)}),e(p),_(m,p)};d1(r1,m=>{s().flourBlend.length>1&&m(i1)})}e(C);var v1=o(C,2),n1=t(v1),M1=t(n1,!0);e(n1);var w1=o(n1,2);Z1(w1,21,()=>Hr,ge,(m,p)=>{var v=u3(),M=t(v,!0);e(v),R(F=>{u1(v,1,`btn btn-sm rounded-xl border-2 h-auto py-2 px-1 text-xs
							${F??""}`),l(M,r(i).flourTypes[r(p)])},[()=>u(r(p))?"btn-secondary border-secondary text-secondary-content":"btn-ghost border-base-300"]),P("click",v,()=>L(r(p))),_(m,v)}),e(w1);var P1=o(w1,2);{var O1=m=>{var p=v3(),v=ne(p);Z1(v,5,()=>s().flourBlend,f1=>f1.type,(f1,j1)=>{var D1=m3(),me=t(D1),U1=o(me,2),s1=t(U1,!0);e(U1);var V1=o(U1,2),te=t(V1);ce(te);var pe=o(te,2);ce(pe),ot(2),e(V1),e(D1),R(Y1=>{L2(me,`background-color: ${I[r(j1).type]??""}`),l(s1,r(i).flourTypes[r(j1).type]),re(te,r(j1).pct),re(pe,Y1)},[()=>Math.round(r(j1).pct)]),P("input",te,Y1=>U(r(j1).type,Y1.target.value)),P("change",pe,Y1=>U(r(j1).type,Y1.target.value)),_(f1,D1)}),e(v);var M=o(v,2),F=t(M),B=t(F),t1=o(B),o1=t(t1);e(t1),e(F);var Q=o(F,2);{var _1=f1=>{var j1=p3(),D1=t(j1,!0);e(j1),R(()=>l(D1,r(i).blendNormalize)),P("click",j1,$),_(f1,j1)};d1(Q,f1=>{r(k)||f1(_1)})}e(M),R(f1=>{l(B,`${r(i).blendTotal??""}: `),u1(t1,1,`font-semibold tabular-nums ${r(k)?"text-success":"text-error"}`),l(o1,`${f1??""}%`)},[()=>Math.round(r(D))]),_(m,p)};d1(P1,m=>{s().flourBlend.length>1&&m(O1)})}e(v1);var E1=o(v1,2),I1=t(E1),Q1=t(I1),ze=t(Q1,!0);e(Q1);var ie=o(Q1,2),Se=t(ie),he=o(Se,4);e(ie),e(I1);var _e=o(I1,2),Me=t(_e),ue=t(Me),xe=t(ue),ke=t(xe,!0);e(xe),e(ue);var ee=o(ue,2);ce(ee),e(Me);var He=o(Me,2),Ue=t(He),yt=t(Ue),Ve=t(yt),qe=o(Ve),Dt=t(qe,!0);e(qe),e(yt),e(Ue);var we=o(Ue,2);ce(we),e(He),e(_e),e(E1),e(K);var zt=o(K,2);{var _t=m=>{var p=b3(),v=t(p);t3(v,{get warnings(){return b().warnings}}),e(p),_(m,p)};d1(zt,m=>{s().totalFlourInputG>0&&m(_t)})}var it=o(zt,2),Ke=t(it),Ye=t(Ke),Lt=t(Ye,!0);e(Ye),e(Ke);var Ze=o(Ke,2),ct=t(Ze),Je=t(ct),Xe=t(Je),kt=t(Xe,!0);e(Xe);var wt=o(Xe,2);e(Je);var Qe=o(Je,2);Z1(Qe,21,()=>G,ge,(m,p)=>{const v=m1(()=>J[r(p)]);var M=g3(),F=t(M);dr(F,()=>r(v),(o1,Q)=>{Q(o1,{class:"w-full h-auto max-h-full"})});var B=o(F,2),t1=t(B,!0);e(B),e(M),R(()=>{u1(M,1,`btn rounded-xl border-2 flex-col h-auto py-3 px-2 gap-1.5
								${s().crumbGoal===r(p)?"btn-secondary border-secondary text-secondary-content":"btn-ghost border-base-300"}`),l(t1,r(i).crumbGoalNames[r(p)])}),P("click",M,()=>l1("crumbGoal",r(p))),_(m,M)}),e(Qe);var dt=o(Qe,2),ut=t(dt,!0);e(dt),e(ct);var mt=o(ct,2),et=t(mt),pt=t(et),Oe=t(pt,!0);e(pt);var Ce=o(pt,2);e(et);var Ae=o(et,2);Z1(Ae,20,()=>["Predictability","FlavorDevelopment"],ge,(m,p)=>{var v=f3(),M=t(v,!0);e(v),R(()=>{u1(v,1,`btn btn-sm rounded-xl border-2 h-auto py-2.5 px-3
							${s().fermentationPhilosophy===p?"btn-secondary border-secondary text-secondary-content":"btn-ghost border-base-300"}`),l(M,p==="Predictability"?r(i).philosophyPredictability:r(i).philosophyFlavorDev)}),P("click",v,()=>l1("fermentationPhilosophy",p)),_(m,v)}),e(Ae);var Pe=o(Ae,2),vt=t(Pe,!0);e(Pe),e(mt);var Be=o(mt,2),Ee=t(Be),je=t(Ee),$t=t(je,!0);e(je);var Tt=o(je,2);e(Ee);var Nt=o(Ee,2);Z1(Nt,20,()=>["Room","ColdRetard"],ge,(m,p)=>{var v=h3(),M=t(v,!0);e(v),R(()=>{u1(v,1,`btn btn-sm rounded-xl border-2 h-auto py-2.5 px-3
								${s().proofMethod===p?"btn-secondary border-secondary text-secondary-content":"btn-ghost border-base-300"}`),l(M,p==="Room"?r(i).roomTemp:r(i).coldRetard)}),P("click",v,()=>l1("proofMethod",p)),_(m,v)}),e(Nt);var aa=o(Nt,2);{var ra=m=>{var p=M3(),v=t(p),M=t(v),F=t(M);e(M),e(v);var B=o(v,2);ce(B),e(p),R(()=>{l(F,`${r(i).fridgeTemp??""} (°${s().tempUnit??""})`),Z(B,"min",r(C1)),Z(B,"max",r(F1)),re(B,r(a1))}),P("input",B,B1),_(m,p)};d1(aa,m=>{s().proofMethod==="ColdRetard"&&m(ra)})}e(Be);var h2=o(Be,2),Ot=t(h2),na=t(Ot,!0);e(Ot);var Et=o(Ot,2);Z1(Et,20,()=>["relative","clock"],ge,(m,p)=>{var v=x3(),M=t(v,!0);e(v),R(()=>{u1(v,1,`btn btn-sm rounded-xl border-2 h-auto py-2.5 px-3
								${s().scheduleMode===p?"btn-secondary border-secondary text-secondary-content":"btn-ghost border-base-300"}`),l(M,p==="relative"?r(i).relative:r(i).clock)}),P("click",v,()=>l1("scheduleMode",p)),_(m,v)}),e(Et);var oa=o(Et,2);{var sa=m=>{var p=y3(),v=t(p),M=t(v),F=t(M,!0);e(M),e(v);var B=o(v,2);ce(B),e(p),R(()=>{l(F,r(i).startTime),re(B,s().startTime??"08:00")}),P("input",B,t1=>l1("startTime",t1.target.value||null)),_(m,p)};d1(oa,m=>{s().scheduleMode==="clock"&&m(sa)})}e(h2),e(Ze),e(it);var M2=o(it,2),It=t(M2),x2=t(It),la=t(x2,!0);e(x2),e(It);var y2=o(It,2),Gt=t(y2),Wt=t(Gt),Ut=t(Wt),ia=t(Ut,!0);e(Ut);var z2=o(Ut,2),Vt=t(z2),ca=t(Vt);{var da=m=>{var p=fe();R(v=>l(p,v),[()=>r(i).saltAutoLabel(r(H).toFixed(2),String(r(j)))]),_(m,p)},ua=m=>{var p=fe();R(()=>l(p,r(i).saltManual)),_(m,p)};d1(ca,m=>{s().saltAutoCalc?m(da):m(ua,-1)})}e(Vt);var tt=o(Vt,2);ce(tt);var _2=o(tt,2),ma=t(_2,!0);e(_2),e(z2),e(Wt);var pa=o(Wt,2);{var va=m=>{var p=z3(),v=ne(p),M=t(v);ce(M),e(v);var F=o(v,2),B=t(F,!0);e(F),R(()=>{re(M,s().saltPct),l(B,r(i).saltBakersPct)}),P("input",M,t1=>l1("saltPct",parseFloat(t1.target.value)||2)),_(m,p)};d1(pa,m=>{s().saltAutoCalc||m(va)})}e(Gt);var qt=o(Gt,2),Kt=t(qt),Yt=t(Kt),ba=t(Yt,!0);e(Yt);var k2=o(Yt,2),Zt=t(k2),ga=t(Zt,!0);e(Zt);var at=o(Zt,2);ce(at);var w2=o(at,2),fa=t(w2,!0);e(w2),e(k2),e(Kt);var ha=o(Kt,2);{var Ma=m=>{var p=_3(),v=t(p);ce(v),e(p),R(()=>re(v,s().starterHydrationPct)),P("input",v,M=>l1("starterHydrationPct",parseFloat(M.target.value)||100)),_(m,p)};d1(ha,m=>{s().starterHydrationAutoCalc||m(Ma)})}e(qt);var T2=o(qt,2),Jt=t(T2),Xt=t(Jt),Qt=t(Xt),xa=t(Qt,!0);e(Qt);var F2=o(Qt,2);e(Xt);var S2=o(Xt,2),Ft=t(S2),ya=t(Ft,!0);e(Ft);var rt=o(Ft,2);ce(rt);var e2=o(rt,2),za=t(e2,!0);e(e2),e(S2),e(Jt);var _a=o(Jt,2);{var ka=m=>{var p=k3(),v=t(p),M=t(v),F=t(M,!0);e(M);var B=o(M,2),t1=t(B);e(B),e(v);var o1=o(v,2);Z(o1,"max",X1);var Q=o(o1,2),_1=t(Q);_1.textContent="20 min";var f1=o(_1,2);f1.textContent="60 min",e(Q),e(p),R(()=>{l(F,r(i).duration),l(t1,`${s().autolyseMins??""} min`),re(o1,r($1)),Z(o1,"aria-label",r(i).ariaLabels.autolyseDurationProgress)}),_(m,p)};d1(_a,m=>{s().autolyseOn&&m(ka)})}e(T2),e(y2),e(M2),e(W1);var C2=o(W1,2);{var wa=m=>{var p=w3(),v=t(p),M=o(v,2),F=t(M),B=t(F),t1=t(B,!0);e(B);var o1=o(B,2);e(F);var Q=o(F,2),_1=t(Q),f1=t(_1),j1=t(f1,!0);e(f1);var D1=o(f1,2),me=t(D1,!0);e(D1),e(_1);var U1=o(_1,2),s1=t(U1),V1=t(s1,!0);e(s1);var te=o(s1,2),pe=t(te,!0);e(te),e(U1),e(Q);var Y1=o(Q,2),ae=t(Y1),Ie=t(ae,!0);e(ae),e(Y1),e(M),Mt(M,ve=>L1?.(ve)),e(p),R(()=>{Z(v,"aria-label",r(i).ariaLabels.closeFermentationPhilosophyModal),l(t1,r(i).philosophyModalTitle),Z(o1,"aria-label",r(i).ariaLabels.closeButton),l(j1,r(i).philosophyPredictability),l(me,r(i).philosophyModalPredictabilityBody),l(V1,r(i).philosophyFlavorDev),l(pe,r(i).philosophyModalFlavorDevBody),l(Ie,r(i).done)}),P("click",v,()=>W(g,!1)),P("click",o1,()=>W(g,!1)),P("click",ae,()=>W(g,!1)),_(m,p)};d1(C2,m=>{r(g)&&m(wa)})}var A2=o(C2,2);{var Ta=m=>{var p=S3(),v=t(p),M=o(v,2),F=t(M),B=t(F),t1=t(B,!0);e(B);var o1=o(B,2);e(F);var Q=o(F,2),_1=t(Q),f1=t(_1,!0);e(_1);var j1=o(_1,2),D1=t(j1),me=t(D1,!0);e(D1);var U1=o(D1,2);Z1(U1,21,()=>r(i).autolyseModalUseItems,ge,(ve,bt)=>{var Te=T3(),Ge=t(Te,!0);e(Te),R(()=>l(Ge,r(bt))),_(ve,Te)}),e(U1),e(j1);var s1=o(j1,2),V1=t(s1),te=t(V1,!0);e(V1);var pe=o(V1,2);Z1(pe,21,()=>r(i).autolyseModalAvoidItems,ge,(ve,bt)=>{var Te=F3(),Ge=t(Te,!0);e(Te),R(()=>l(Ge,r(bt))),_(ve,Te)}),e(pe),e(s1),e(Q);var Y1=o(Q,2),ae=t(Y1),Ie=t(ae,!0);e(ae),e(Y1),e(M),Mt(M,ve=>L1?.(ve)),e(p),R(()=>{Z(v,"aria-label",r(i).ariaLabels.closeAutolyseModal),l(t1,r(i).autolyseModalTitle),Z(o1,"aria-label",r(i).ariaLabels.closeButton),l(f1,r(i).autolyseModalIntro),l(me,r(i).autolyseModalUseTitle),l(te,r(i).autolyseModalAvoidTitle),l(Ie,r(i).done)}),P("click",v,()=>W(A,!1)),P("click",o1,()=>W(A,!1)),P("click",ae,()=>W(A,!1)),_(m,p)};d1(A2,m=>{r(A)&&m(Ta)})}var B2=o(A2,2);{var Fa=m=>{var p=C3(),v=t(p),M=o(v,2),F=t(M),B=t(F),t1=t(B,!0);e(B);var o1=o(B,2);e(F);var Q=o(F,2),_1=t(Q),f1=t(_1),j1=t(f1,!0);e(f1);var D1=o(f1,2),me=t(D1,!0);e(D1),e(_1);var U1=o(_1,2),s1=t(U1),V1=t(s1,!0);e(s1);var te=o(s1,2),pe=t(te,!0);e(te),e(U1),e(Q);var Y1=o(Q,2),ae=t(Y1),Ie=t(ae,!0);e(ae),e(Y1),e(M),Mt(M,ve=>L1?.(ve)),e(p),R(()=>{Z(v,"aria-label",r(i).ariaLabels.closeProofMethodModal),l(t1,r(i).proofMethodModalTitle),Z(o1,"aria-label",r(i).ariaLabels.closeProofMethodModal),l(j1,r(i).roomTemp),l(me,r(i).proofMethodRoomBody),l(V1,r(i).coldRetard),l(pe,r(i).proofMethodColdRetardBody),l(Ie,r(i).done)}),P("click",v,()=>W(y,!1)),P("click",o1,()=>W(y,!1)),P("click",ae,()=>W(y,!1)),_(m,p)};d1(B2,m=>{r(y)&&m(Fa)})}var Sa=o(B2,2);{var Ca=m=>{var p=A3(),v=t(p),M=o(v,2),F=t(M),B=t(F),t1=t(B,!0);e(B);var o1=o(B,2);e(F);var Q=o(F,2),_1=t(Q),f1=t(_1),j1=t(f1,!0);e(f1);var D1=o(f1,2),me=t(D1,!0);e(D1),e(_1);var U1=o(_1,2),s1=t(U1),V1=t(s1,!0);e(s1);var te=o(s1,2),pe=t(te,!0);e(te),e(U1);var Y1=o(U1,2),ae=t(Y1),Ie=t(ae,!0);e(ae);var ve=o(ae,2),bt=t(ve,!0);e(ve),e(Y1),e(Q);var Te=o(Q,2),Ge=t(Te),Aa=t(Ge,!0);e(Ge),e(Te),e(M),Mt(M,Ba=>L1?.(Ba)),e(p),R(()=>{Z(v,"aria-label",r(i).ariaLabels.closeCrumbGoalModal),l(t1,r(i).crumbModalTitle),Z(o1,"aria-label",r(i).ariaLabels.closeButton),l(j1,r(i).crumbGoalNames.Tight),l(me,r(i).crumbModalTightBody),l(V1,r(i).crumbGoalNames.Balanced),l(pe,r(i).crumbModalBalancedBody),l(Ie,r(i).crumbGoalNames.Open),l(bt,r(i).crumbModalOpenBody),l(Aa,r(i).done)}),P("click",v,()=>W(S,!1)),P("click",o1,()=>W(S,!1)),P("click",Ge,()=>W(S,!1)),_(m,p)};d1(Sa,m=>{r(S)&&m(Ca)})}R(()=>{l(h1,r(i).parameters),re(S1,s().totalFlourInputG),l(E,r(i).totalFlour),l(M1,r(i).flourSelection),l(ze,r(i).temperatures),Z(ie,"aria-label",r(i).ariaLabels.toggleTempUnit),u1(Se,1,We(s().tempUnit==="C"?"text-secondary font-semibold":"text-base-content/50")),u1(he,1,We(s().tempUnit==="F"?"text-secondary font-semibold":"text-base-content/50")),l(ke,r(i).kitchenTemp),Z(ee,"min",r(k1)),Z(ee,"max",r(T1)),re(ee,r(V)),l(Ve,`${r(i).doughTemp??""} `),l(Dt,r(i).optional),Z(we,"min",r(k1)),Z(we,"max",r(T1)),re(we,r(Y)),Z(we,"placeholder",r(i).leaveBlankAmbient),l(Lt,r(i).bakingProfile),l(kt,r(i).crumbGoal),Z(wt,"aria-label",r(i).ariaLabels.learnCrumbGoal),l(ut,r(i).crumbDescriptions[s().crumbGoal]),l(Oe,r(i).fermentationPhilosophyLabel),Z(Ce,"aria-label",r(i).ariaLabels.learnFermentationPhilosophy),l(vt,s().fermentationPhilosophy==="Predictability"?r(i).philosophyPredictabilityDesc:r(i).philosophyFlavorDevDesc),l($t,r(i).proofMethod),Z(Tt,"aria-label",r(i).ariaLabels.learnProofMethod),l(na,r(i).scheduleMode),l(la,r(i).fineTuning),l(ia,r(i).salt),o2(tt,!s().saltAutoCalc),Z(tt,"aria-checked",!s().saltAutoCalc),Z(tt,"aria-label",r(i).ariaLabels.overrideSalt),l(ma,r(i).saltOverride),l(ba,r(i).starterHydration),l(ga,s().starterHydrationAutoCalc?r(i).starterHydrationDefaultLabel:r(i).starterHydrationManual),o2(at,!s().starterHydrationAutoCalc),Z(at,"aria-checked",!s().starterHydrationAutoCalc),Z(at,"aria-label",r(i).ariaLabels.overrideStarterHydration),l(fa,r(i).starterHydrationOverride),l(xa,r(i).autolyse),Z(F2,"aria-label",r(i).ariaLabels.learnAutolyse),u1(Ft,1,We(s().autolyseOn?"text-xs text-base-content/40":"text-xs text-base-content/70 font-semibold")),l(ya,r(i).off),o2(rt,s().autolyseOn),Z(rt,"aria-checked",s().autolyseOn),Z(rt,"aria-label",r(i).ariaLabels.toggleAutolyseAuto),u1(e2,1,We(s().autolyseOn?"text-xs text-base-content/70 font-semibold":"text-xs text-base-content/40")),l(za,r(i).auto)}),P("input",S1,x1),P("click",ie,c1),P("input",ee,g1),P("input",we,O),P("click",wt,()=>W(S,!0)),P("click",Ce,()=>W(g,!0)),P("click",Tt,()=>W(y,!0)),P("change",tt,()=>l1("saltAutoCalc",!s().saltAutoCalc)),P("change",at,()=>l1("starterHydrationAutoCalc",!s().starterHydrationAutoCalc)),P("click",F2,()=>W(A,!0)),P("change",rt,z1),_(a,N1),Le(),d()}st(["input","click","change"]);var P3=N('<div class="flex items-center justify-between text-[11px] text-base-content/55 px-1"><span class="truncate"> </span> <span class="tabular-nums font-medium ml-1"> </span></div>'),j3=N('<div class="mt-2 space-y-0.5"></div>'),R3=N('<tr class="bg-base-200/30"><td class="py-1.5 text-base-content/70 text-xs pl-4"> </td><td class="py-1.5 text-right tabular-nums text-base-content/70 text-xs"> </td><td class="py-1.5 text-right tabular-nums text-base-content/50 text-xs"> </td></tr>'),D3=N('<div class="px-5 pb-4"><table class="w-full text-sm"><thead><tr class="border-b border-base-200"><th class="text-left py-2 text-xs font-semibold text-base-content/50 uppercase tracking-wide"> </th><th class="text-right py-2 text-xs font-semibold text-base-content/50 uppercase tracking-wide"> </th><th class="text-right py-2 text-xs font-semibold text-base-content/50 uppercase tracking-wide"> </th></tr></thead><tbody class="divide-y divide-base-200"><tr><td class="py-2.5 text-base-content font-medium"> </td><td class="py-2.5 text-right tabular-nums text-base-content font-semibold"> </td><td class="py-2.5 text-right tabular-nums text-base-content/70">100%</td></tr><!><tr><td class="py-2.5 text-base-content font-medium"> </td><td class="py-2.5 text-right tabular-nums text-base-content font-semibold"> </td><td class="py-2.5 text-right tabular-nums text-base-content/70"> </td></tr><tr><td class="py-2.5 text-base-content font-medium"> </td><td class="py-2.5 text-right tabular-nums text-base-content font-semibold"> </td><td class="py-2.5 text-right tabular-nums text-base-content/70"> </td></tr><tr><td class="py-2.5 text-base-content font-medium"> </td><td class="py-2.5 text-right tabular-nums text-base-content font-semibold"> </td><td class="py-2.5 text-right tabular-nums text-base-content/70"> <span class="text-[10px] text-base-content/40 block leading-tight"> </span></td></tr></tbody><tfoot><tr class="border-t-2 border-secondary/30 bg-secondary/10"><td class="py-3 font-bold text-secondary"> </td><td class="py-3 text-right tabular-nums font-bold text-secondary"> </td><td class="py-3 text-right"></td></tr></tfoot></table></div>'),L3=N('<div class="modal modal-open"><button type="button" class="modal-backdrop"></button> <div class="modal-box w-full max-w-sm p-0 overflow-hidden" role="dialog" aria-modal="true" aria-labelledby="formula-modal-title"><div class="flex items-center justify-between px-5 py-4 border-b border-base-200"><h2 id="formula-modal-title" class="text-base font-semibold text-base-content"> </h2> <button type="button" class="btn btn-ghost btn-sm btn-circle"><svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12"></path></svg></button></div> <div class="px-5 py-4 space-y-4"><div><p class="text-xs font-semibold text-secondary uppercase tracking-wide mb-1"> </p> <p class="text-sm text-base-content/70 leading-relaxed"> </p></div> <div class="border-t border-base-200 pt-4"><p class="text-xs font-semibold text-secondary uppercase tracking-wide mb-1"> </p> <p class="text-sm text-base-content/70 leading-relaxed"> </p></div></div> <div class="px-5 pb-5"><button type="button" class="btn btn-primary w-full"> </button></div></div></div>'),$3=N('<div class="card bg-base-100 shadow-sm ring-1 ring-base-300/70 overflow-hidden"><div class="flex items-center justify-between px-5 pt-5 pb-3"><div><div class="flex items-center gap-1.5"><h2 class="text-base font-semibold text-base-content uppercase tracking-wide"> </h2> <button type="button" class="btn btn-ghost btn-xs btn-circle flex-shrink-0"><svg xmlns="http://www.w3.org/2000/svg" class="w-[1.14rem] h-[1.14rem]" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true"><path fill-rule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7-4a1 1 0 11-2 0 1 1 0 012 0zM9 9a1 1 0 000 2v3a1 1 0 001 1h1a1 1 0 100-2v-3a1 1 0 00-1-1H9z" clip-rule="evenodd"></path></svg></button></div> <p class="text-xs text-base-content/50 mt-0.5"> </p></div> <div class="badge badge-secondary badge-lg tabular-nums font-bold gap-1"> </div></div> <div class="px-5 pb-4"><p class="text-xs font-semibold text-base-content/70 uppercase tracking-wide mb-3"> </p> <div class="grid grid-cols-2 gap-3"><div class="rounded-xl bg-base-200/80 ring-1 ring-base-300/60 px-3 py-3 text-center"><div class="text-2xl font-bold tabular-nums text-base-content"> </div> <div class="text-xs text-base-content/60 mt-1 font-medium"> </div> <!></div> <div class="rounded-xl bg-base-200/80 ring-1 ring-base-300/60 px-3 py-3 text-center"><div class="text-2xl font-bold tabular-nums text-base-content"> </div> <div class="text-xs text-base-content/60 mt-1 font-medium"> </div></div> <div class="rounded-xl bg-accent/10 ring-1 ring-accent/20 px-3 py-3 text-center"><div class="text-2xl font-bold tabular-nums text-accent"> </div> <div class="text-xs text-accent/70 mt-1 font-medium"> </div></div> <div class="rounded-xl bg-base-200/80 ring-1 ring-base-300/60 px-3 py-3 text-center"><div class="text-2xl font-bold tabular-nums text-base-content"> </div> <div class="text-xs text-base-content/60 mt-1 font-medium"> </div></div></div> <p class="text-xs text-base-content/50 mt-2.5 italic"> </p></div> <div class="border-t border-base-200"><button type="button" class="w-full flex items-center justify-between px-5 py-3 text-left hover:bg-base-200/50 transition-colors"><span class="text-xs font-semibold text-base-content/70 uppercase tracking-wide"> </span> <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor"><path fill-rule="evenodd" d="M5.23 7.21a.75.75 0 011.06.02L10 11.168l3.71-3.938a.75.75 0 111.08 1.04l-4.25 4.5a.75.75 0 01-1.08 0l-4.25-4.5a.75.75 0 01.02-1.06z" clip-rule="evenodd"></path></svg></button> <!></div></div> <!>',1);function N3(a,n){De(n,!0);const c=()=>oe(ye,"$lang",b),s=()=>oe(p2,"$showFullFormula",b),[b,f]=$e(),d=m1(()=>Ne[c()]);function i(E,r1){return r1<=0?"—":`${(E/r1*100).toFixed(1)}%`}function g(E){return Math.round(E).toString()}function A(E,r1){const i1=Math.round(E),v1=Math.round(r1);if(i1<=0||v1<=0)return"—";let n1=i1,M1=v1;for(;M1;)[n1,M1]=[M1,n1%M1];return`${i1/n1}:${v1/n1}`}let y=le(!1);const S='a[href],button:not([disabled]),input:not([disabled]),select:not([disabled]),textarea:not([disabled]),[tabindex]:not([tabindex="-1"])';function G(E,r1){const i1=Array.from(E.querySelectorAll(S));i1.length&&i1[0].focus();function v1(n1){if(n1.key==="Escape"){W(y,!1);return}if(n1.key!=="Tab")return;const M1=i1[0],w1=i1[i1.length-1];n1.shiftKey?document.activeElement===M1&&(n1.preventDefault(),w1.focus()):document.activeElement===w1&&(n1.preventDefault(),M1.focus())}return E.addEventListener("keydown",v1),{destroy(){E.removeEventListener("keydown",v1)}}}function J(E){return G(E)}var D=$3(),k=ne(D),u=t(k),L=t(u),U=t(L),$=t(U),I=t($,!0);e($);var x=o($,2);e(U);var T=o(U,2),z=t(T,!0);e(T),e(L);var H=o(L,2),j=t(H);e(H),e(u);var V=o(u,2),Y=t(V),a1=t(Y,!0);e(Y);var b1=o(Y,2),l1=t(b1),c1=t(l1),x1=t(c1);e(c1);var g1=o(c1,2),O=t(g1,!0);e(g1);var z1=o(g1,2);{var B1=E=>{var r1=j3();Z1(r1,21,()=>n.flourBlend,i1=>i1.type,(i1,v1)=>{var n1=P3(),M1=t(n1),w1=t(M1,!0);e(M1);var P1=o(M1,2),O1=t(P1);e(P1),e(n1),R(E1=>{l(w1,r(d).flourTypes[r(v1).type]??r(v1).type),l(O1,`${E1??""}g`)},[()=>g(n.formula.mixFlourG*r(v1).pct/100)]),_(i1,n1)}),e(r1),_(E,r1)};d1(z1,E=>{n.flourBlend.length>1&&E(B1)})}e(l1);var R1=o(l1,2),H1=t(R1),L1=t(H1);e(H1);var k1=o(H1,2),T1=t(k1,!0);e(k1),e(R1);var C1=o(R1,2),F1=t(C1),J1=t(F1);e(F1);var G1=o(F1,2),X1=t(G1,!0);e(G1),e(C1);var $1=o(C1,2),N1=t($1),W1=t(N1);e(N1);var K1=o(N1,2),p1=t(K1,!0);e(K1),e($1),e(b1);var h1=o(b1,2),K=t(h1,!0);e(h1),e(V);var C=o(V,2),h=t(C),w=t(h),X=t(w,!0);e(w);var e1=o(w,2);e(h);var A1=o(h,2);{var q=E=>{var r1=D3(),i1=t(r1),v1=t(i1),n1=t(v1),M1=t(n1),w1=t(M1,!0);e(M1);var P1=o(M1),O1=t(P1,!0);e(P1);var E1=o(P1),I1=t(E1,!0);e(E1),e(n1),e(v1);var Q1=o(v1),ze=t(Q1),ie=t(ze),Se=t(ie,!0);e(ie);var he=o(ie),_e=t(he);e(he),ot(),e(ze);var Me=o(ze);Z1(Me,17,()=>n.flourBlend,Oe=>Oe.type,(Oe,Ce)=>{var Ae=R3(),Pe=t(Ae),vt=t(Pe);e(Pe);var Be=o(Pe),Ee=t(Be);e(Be);var je=o(Be),$t=t(je);e(je),e(Ae),R(Tt=>{l(vt,`— ${r(d).flourTypes[r(Ce).type]??r(Ce).type??""}`),l(Ee,`${Tt??""}g`),l($t,`${r(Ce).pct??""}%`)},[()=>g(n.formula.totalFlourG*r(Ce).pct/100)]),_(Oe,Ae)});var ue=o(Me),xe=t(ue),ke=t(xe,!0);e(xe);var ee=o(xe),He=t(ee);e(ee);var Ue=o(ee),yt=t(Ue);e(Ue),e(ue);var Ve=o(ue),qe=t(Ve),Dt=t(qe,!0);e(qe);var we=o(qe),zt=t(we);e(we);var _t=o(we),it=t(_t,!0);e(_t),e(Ve);var Ke=o(Ve),Ye=t(Ke),Lt=t(Ye,!0);e(Ye);var Ze=o(Ye),ct=t(Ze);e(Ze);var Je=o(Ze),Xe=t(Je),kt=o(Xe),wt=t(kt,!0);e(kt),e(Je),e(Ke),e(Q1);var Qe=o(Q1),dt=t(Qe),ut=t(dt),mt=t(ut,!0);e(ut);var et=o(ut),pt=t(et);e(et),ot(),e(dt),e(Qe),e(i1),e(r1),R((Oe,Ce,Ae,Pe,vt,Be,Ee,je)=>{l(w1,r(d).ingredient),l(O1,r(d).grams),l(I1,r(d).bakersPct),l(Se,r(d).totalFlourRow),l(_e,`${Oe??""}g`),l(ke,r(d).water),l(He,`${Ce??""}g`),l(yt,`${Ae??""}%`),l(Dt,r(d).saltRow),l(zt,`${Pe??""}g`),l(it,vt),l(Lt,r(d).starter),l(ct,`${Be??""}g`),l(Xe,`${Ee??""} `),l(wt,r(d).preFermentedFlour),l(mt,r(d).totalDough),l(pt,`${je??""}g`)},[()=>g(n.formula.totalFlourG),()=>g(n.formula.totalWaterG),()=>n.formula.finalHydrationPct.toFixed(1),()=>g(n.formula.saltG),()=>i(n.formula.saltG,n.formula.totalFlourG),()=>g(n.formula.starterTotalG),()=>i(n.formula.starterFlourG,n.formula.totalFlourG),()=>g(n.formula.totalDoughWeightG)]),_(E,r1)};d1(A1,E=>{s()&&E(q)})}e(C),e(k);var S1=o(k,2);{var y1=E=>{var r1=L3(),i1=t(r1),v1=o(i1,2),n1=t(v1),M1=t(n1),w1=t(M1,!0);e(M1);var P1=o(M1,2);e(n1);var O1=o(n1,2),E1=t(O1),I1=t(E1),Q1=t(I1,!0);e(I1);var ze=o(I1,2),ie=t(ze,!0);e(ze),e(E1);var Se=o(E1,2),he=t(Se),_e=t(he,!0);e(he);var Me=o(he,2),ue=t(Me,!0);e(Me),e(Se),e(O1);var xe=o(O1,2),ke=t(xe),ee=t(ke,!0);e(ke),e(xe),e(v1),Mt(v1,He=>J?.(He)),e(r1),R(()=>{Z(i1,"aria-label",r(d).ariaLabels.closeFormulaModal),l(w1,r(d).formulaInfoTitle),Z(P1,"aria-label",r(d).ariaLabels.closeFormulaModal),l(Q1,r(d).mixAdditions),l(ie,r(d).formulaInfoMixBody),l(_e,r(d).fullFormula),l(ue,r(d).formulaInfoFormulaBody),l(ee,r(d).done)}),P("click",i1,()=>W(y,!1)),P("click",P1,()=>W(y,!1)),P("click",ke,()=>W(y,!1)),_(E,r1)};d1(S1,E=>{r(y)&&E(y1)})}R((E,r1,i1,v1,n1,M1)=>{l(I,r(d).formula),Z(x,"aria-label",r(d).ariaLabels.learnFormula),l(z,r(d).bakersPctSubtitle),l(j,`${E??""}g`),l(a1,r(d).mixAdditions),l(x1,`${r1??""}g`),l(O,r(d).mixFlour),l(L1,`${i1??""}g`),l(T1,r(d).mixWater),l(J1,`${v1??""}g`),l(X1,r(d).starter),l(W1,`${n1??""}g`),l(p1,r(d).saltRow),l(K,M1),l(X,r(d).fullFormula),u1(e1,0,`w-4 h-4 text-base-content/40 transition-transform ${s()?"rotate-180":""}`)},[()=>g(n.formula.totalDoughWeightG),()=>g(n.formula.mixFlourG),()=>g(n.formula.mixWaterG),()=>g(n.formula.starterTotalG),()=>g(n.formula.saltG),()=>r(d).starterContains(g(n.formula.starterFlourG),g(n.formula.starterWaterG),A(n.formula.starterFlourG,n.formula.starterWaterG))]),P("click",x,()=>W(y,!0)),P("click",h,()=>p2.update(E=>!E)),_(a,D),Le(),f()}st(["click"]);var O3=N('<div class="flex justify-between items-center mb-2"><span class="text-sm font-semibold text-base-content"> </span> <span class="text-sm tabular-nums font-bold text-info"> </span></div> <div class="relative h-3"><progress class="progress progress-info w-full absolute inset-0 opacity-50" max="100"></progress> <progress class="progress progress-info w-full absolute inset-0" max="100"></progress></div>',1),E3=N('<div class="flex justify-between items-center mb-2"><span class="text-sm font-semibold text-base-content"> </span> <span class="text-sm tabular-nums font-bold text-secondary"> </span></div> <div class="relative h-3"><progress class="progress progress-secondary w-full absolute inset-0 opacity-50" value="100" max="100"></progress> <progress class="progress progress-secondary w-full absolute inset-0" max="100"></progress></div> <p class="text-xs text-base-content/70 mt-1"> </p>',1),I3=N('<div class="modal modal-open"><button type="button" class="modal-backdrop"></button> <div class="modal-box w-full max-w-md p-0 overflow-hidden" role="dialog" aria-modal="true" aria-labelledby="timing-bars-modal-title"><div class="flex items-center justify-between px-5 py-4 border-b border-base-200"><h2 id="timing-bars-modal-title" class="text-base font-semibold text-base-content"> </h2> <button type="button" class="btn btn-ghost btn-sm btn-circle"><svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12"></path></svg></button></div> <div class="px-5 py-4 space-y-4"><p class="text-sm text-base-content/70 leading-relaxed"> </p> <div><p class="text-xs font-semibold text-secondary uppercase tracking-wide mb-1"> </p> <p class="text-sm text-base-content/70 leading-relaxed"> </p></div> <div class="border-t border-base-200 pt-4"><p class="text-xs font-semibold text-secondary uppercase tracking-wide mb-1"> </p> <p class="text-sm text-base-content/70 leading-relaxed"> </p></div></div> <div class="px-5 pb-5"><button type="button" class="btn btn-primary w-full"> </button></div></div></div>'),G3=N('<div class="card bg-base-100 shadow-sm ring-1 ring-base-300/70"><div class="card-body gap-5 p-5"><div class="flex items-center gap-1.5"><h2 class="text-base font-semibold text-base-content uppercase tracking-wide"> </h2> <button type="button" class="btn btn-ghost btn-xs btn-circle flex-shrink-0"><svg xmlns="http://www.w3.org/2000/svg" class="w-[1.14rem] h-[1.14rem]" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true"><path fill-rule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7-4a1 1 0 11-2 0 1 1 0 012 0zM9 9a1 1 0 000 2v3a1 1 0 001 1h1a1 1 0 100-2v-3a1 1 0 00-1-1H9z" clip-rule="evenodd"></path></svg></button></div> <div class="flex flex-wrap gap-2"><span> </span> <span> </span> <span class="badge badge-soft badge-accent badge-md font-medium"> </span></div> <div><div class="flex justify-between items-center mb-2"><span class="text-sm font-semibold text-base-content"> </span> <span class="text-sm tabular-nums font-bold text-secondary"> </span></div> <div class="relative h-3"><progress class="progress progress-warning w-full absolute inset-0" max="100"></progress> <progress class="progress progress-secondary w-full absolute inset-0 opacity-80" max="100"></progress></div> <div class="flex justify-between text-xs text-base-content/50 mt-1"><span> </span> <span> </span></div> <p class="text-xs text-base-content/70 mt-1"> </p></div> <div><!></div> <div class="rounded-xl bg-secondary/10 ring-1 ring-secondary/20 px-4 py-3 text-sm"><span class="text-base-content/70"> </span> <span class="font-bold text-base-content ml-1"> </span></div> <p class="text-xs text-base-content/50 text-center"> </p></div></div> <!>',1);function W3(a,n){De(n,!0);const c=()=>oe(ye,"$lang",b),s=()=>oe(be,"$inputs",b),[b,f]=$e(),d=85,i=95,g=m1(()=>Ne[c()]);let A=le(!1);const y=12;function S(y1){return Math.min(100,y1/y*100)}const G={Cold:"badge-info",VeryCold:"badge-info",Standard:"badge-success",Warm:"badge-warning",Hot:"badge-error"},J={Low:"badge-warning",Medium:"badge-success",High:"badge-info",VeryHigh:"badge-error"},D=m1(()=>S(n.timing.bulkMax)),k=m1(()=>S(n.timing.bulkMin)),u=m1(()=>S(n.timing.proofMax)),L=m1(()=>S(n.timing.proofMin)),U=m1(()=>S(n.timing.coldRetardMin));var $=G3(),I=ne($),x=t(I),T=t(x),z=t(T),H=t(z,!0);e(z);var j=o(z,2);e(T);var V=o(T,2),Y=t(V),a1=t(Y);e(Y);var b1=o(Y,2),l1=t(b1);e(b1);var c1=o(b1,2),x1=t(c1);e(c1),e(V);var g1=o(V,2),O=t(g1),z1=t(O),B1=t(z1,!0);e(z1);var R1=o(z1,2),H1=t(R1);e(R1),e(O);var L1=o(O,2),k1=t(L1),T1=o(k1,2);e(L1);var C1=o(L1,2),F1=t(C1),J1=t(F1,!0);e(F1);var G1=o(F1,2),X1=t(G1,!0);e(G1),e(C1);var $1=o(C1,2),N1=t($1,!0);e($1),e(g1);var W1=o(g1,2),K1=t(W1);{var p1=y1=>{var E=O3(),r1=ne(E),i1=t(r1),v1=t(i1,!0);e(i1);var n1=o(i1,2),M1=t(n1);e(n1),e(r1);var w1=o(r1,2),P1=t(w1),O1=o(P1,2);e(w1),R((E1,I1)=>{l(v1,r(g).roomProof),l(M1,`${E1??""} – ${I1??""}`),re(P1,r(u)),re(O1,r(L))},[()=>se(n.timing.proofMin*60),()=>se(n.timing.proofMax*60)]),_(y1,E)},h1=y1=>{var E=E3(),r1=ne(E),i1=t(r1),v1=t(i1,!0);e(i1);var n1=o(i1,2),M1=t(n1);e(n1),e(r1);var w1=o(r1,2),P1=o(t(w1),2);e(w1);var O1=o(w1,2),E1=t(O1,!0);e(O1),R(()=>{l(v1,r(g).coldRetardProof),l(M1,`${n.timing.coldRetardMin??""}h – ${n.timing.coldRetardMax??""}h`),re(P1,r(U)),l(E1,r(g).bakeColdNote)}),_(y1,E)};d1(K1,y1=>{n.proofMethod==="Room"?y1(p1):y1(h1,-1)})}e(W1);var K=o(W1,2),C=t(K),h=t(C,!0);e(C);var w=o(C,2),X=t(w);e(w),e(K);var e1=o(K,2),A1=t(e1,!0);e(e1),e(x),e(I);var q=o(I,2);{var S1=y1=>{var E=I3(),r1=t(E),i1=o(r1,2),v1=t(i1),n1=t(v1),M1=t(n1,!0);e(n1);var w1=o(n1,2);e(v1);var P1=o(v1,2),O1=t(P1),E1=t(O1,!0);e(O1);var I1=o(O1,2),Q1=t(I1),ze=t(Q1,!0);e(Q1);var ie=o(Q1,2),Se=t(ie,!0);e(ie),e(I1);var he=o(I1,2),_e=t(he),Me=t(_e,!0);e(_e);var ue=o(_e,2),xe=t(ue,!0);e(ue),e(he),e(P1);var ke=o(P1,2),ee=t(ke),He=t(ee,!0);e(ee),e(ke),e(i1),e(E),R(()=>{Z(r1,"aria-label",r(g).ariaLabels.closeTimingBarModal),l(M1,r(g).timingBarsModalTitle),Z(w1,"aria-label",r(g).ariaLabels.closeButton),l(E1,r(g).timingBarsModalIntro),l(ze,r(g).timingBarsBulkTitle),l(Se,r(g).timingBarsBulkBody),l(Me,r(g).timingBarsColdTitle),l(xe,r(g).timingBarsColdBody),l(He,r(g).done)}),P("click",r1,()=>W(A,!1)),P("click",w1,()=>W(A,!1)),P("click",ee,()=>W(A,!1)),_(y1,E)};d1(q,y1=>{r(A)&&y1(S1)})}R((y1,E,r1,i1,v1,n1,M1,w1)=>{l(H,r(g).timing),Z(j,"aria-label",r(g).ariaLabels.learnTimingBars),u1(Y,1,`badge badge-soft ${G[n.formula.tempBand]??"badge-ghost"??""} badge-md font-medium`),l(a1,`${r(g).tempBands[n.formula.tempBand]??""} (${y1??""})`),u1(b1,1,`badge badge-soft ${J[n.formula.hydrationBand]??"badge-ghost"??""} badge-md font-medium`),l(l1,`${r(g).hydrationBands[n.formula.hydrationBand]??""} ${r(g).hydration??""} (${E??""}%)`),l(x1,`${r1??""}% ${r(g).inoculation??""}`),l(B1,r(g).bulkFermentation),l(H1,`${i1??""} – ${v1??""}`),re(k1,r(D)),re(T1,r(k)),l(J1,r(g).fastest),l(X1,r(g).slowest),l(N1,n1),l(h,r(g).totalActiveTime),l(X,`${M1??""} –
				${w1??""}`),l(A1,r(g).timingDisclaimer)},[()=>s().tempUnit==="F"?(n.formula.effectiveTempC*9/5+32).toFixed(1)+"°F":n.formula.effectiveTempC.toFixed(1)+"°C",()=>n.formula.finalHydrationPct.toFixed(1),()=>n.formula.inoculationPct.toFixed(1),()=>se(n.timing.bulkMin*60),()=>se(n.timing.bulkMax*60),()=>r(g).foldSchedule(n.timing.foldCount,n.timing.foldIntervalMins),()=>se((n.timing.bulkMin+(n.proofMethod==="Room"?n.timing.proofMin:n.timing.coldRetardMin))*60+d),()=>se((n.timing.bulkMax+(n.proofMethod==="Room"?n.timing.proofMax:n.timing.coldRetardMax))*60+i)]),P("click",j,()=>W(A,!0)),_(a,$),Le(),f()}st(["click"]);var U3=N("<div> </div>"),V3=N("<div> </div> <!>",1),q3=N("<div> </div>"),K3=N("<p> </p>"),Y3=N('<button type="button"><!></button>'),Z3=N('<div class="flex gap-2 mt-1.5 flex-wrap"></div>'),J3=N('<li class="relative flex gap-3 pb-3 cursor-pointer select-none group pl-11" role="checkbox" tabindex="0"><div class="absolute top-0 bottom-0 w-px left-4 bg-secondary/20"></div> <div><span class="-rotate-45"><!></span></div> <div><div class="flex items-start justify-between gap-2"><span> </span> <div class="text-right shrink-0"><!></div></div> <!> <!></div></li>'),X3=N('<div class="absolute bottom-0 w-px left-4 top-8 bg-secondary/20"></div>'),Q3=N("<div> </div>"),en=N("<div> </div> <!>",1),tn=N("<div> </div>"),an=N("<p> </p>"),rn=N("<button><!></button>"),nn=N('<div class="flex flex-wrap items-center gap-2 mt-2"></div>'),on=N('<li class="relative flex gap-4 pb-5 cursor-pointer select-none group" role="checkbox" tabindex="0"><!> <div><!></div> <div><div class="flex items-start justify-between gap-2"><span> </span> <div class="text-right shrink-0"><!></div></div> <!> <!></div></li>'),sn=N('<div class="shadow-sm card bg-base-100 ring-1 ring-base-300/70"><div class="p-5 card-body"><h2 class="mb-1 text-base font-semibold tracking-wide uppercase text-base-content"> </h2> <p class="mb-3 text-xs italic text-base-content/60"> </p> <ol class="relative space-y-0"></ol></div></div>');function ln(a,n){De(n,!0);const c=()=>oe(ye,"$lang",s),[s,b]=$e(),f=m1(()=>Ne[c()]);let d=le(R2(new Set)),i=le(R2(new Map)),g=le("");Bt(()=>{const x=JSON.stringify(n.steps.map(T=>T.label+"|"+T.durationMins+"|"+T.rangeMinMins));x!==r(g)&&(W(g,x,!0),W(d,new Set,!0),W(i,new Map,!0))});function A(x){const T=new Set(r(d));T.has(x)?T.delete(x):T.add(x),W(d,T,!0)}function y(x,T){const z=new Map(r(i)),H=new Set(z.get(x)??[]);H.has(T)?H.delete(T):H.add(T),z.set(x,H),W(i,z,!0);const j=n.steps[x]?.setCount??0;if(j>0&&H.size===j){const V=new Set(r(d));V.add(x),W(d,V,!0)}}function S(x,T){return r(i).get(x)?.has(T)??!1}const G=m1(()=>{let x=0;if(n.scheduleMode!=="clock"||!n.startTime)return n.steps.map(j=>{const V=j.isSubStep?-1:x++;return{step:j,clockTime:null,endClockTime:null,topLevelIndex:V}});let T=0,z=0,H=0;return n.steps.map(j=>{const V=j.isSubStep?-1:x++;if(j.isSubStep){const Y=Ct(n.startTime,z+H),a1=j.durationMins??(j.rangeMinMins!=null?j.rangeMinMins:0);H+=a1;const b1=Ct(n.startTime,z+H);return{step:j,clockTime:Y,endClockTime:b1,topLevelIndex:V}}else{T=Math.max(T,z+H),z=T,H=0;const Y=Ct(n.startTime,T),a1=j.durationMins??(j.rangeMinMins!=null?j.rangeMinMins:0);T+=a1;const b1=Ct(n.startTime,T);return{step:j,clockTime:Y,endClockTime:b1,topLevelIndex:V}}})});function J(x){return x.durationMins!==null&&x.durationMins!==void 0?se(x.durationMins):x.rangeMinMins!==void 0&&x.rangeMaxMins!==void 0?`${se(x.rangeMinMins)} – ${se(x.rangeMaxMins)}`:""}var D=sn(),k=t(D),u=t(k),L=t(u,!0);e(u);var U=o(u,2),$=t(U,!0);e(U);var I=o(U,2);Z1(I,21,()=>r(G),ge,(x,T,z)=>{let H=()=>r(T).step,j=()=>r(T).clockTime,V=()=>r(T).endClockTime,Y=()=>r(T).topLevelIndex;var a1=v2(),b1=ne(a1);{var l1=x1=>{var g1=J3(),O=o(t(g1),2),z1=t(O),B1=t(z1);{var R1=p1=>{var h1=fe("✓");_(p1,h1)},H1=m1(()=>r(d).has(z));d1(B1,p1=>{r(H1)&&p1(R1)})}e(z1),e(O);var L1=o(O,2),k1=t(L1),T1=t(k1),C1=t(T1,!0);e(T1);var F1=o(T1,2),J1=t(F1);{var G1=p1=>{var h1=V3(),K=ne(h1),C=t(K,!0);e(K);var h=o(K,2);{var w=X=>{var e1=U3(),A1=t(e1);e(e1),R(q=>{u1(e1,1,`text-[10px] tabular-nums ${q??""}`),l(A1,`→ ${V()??""}`)},[()=>r(d).has(z)?"text-base-content/40 line-through":"text-base-content/50"]),_(X,e1)};d1(h,X=>{V()&&V()!==j()&&X(w)})}R(X=>{u1(K,1,`text-xs tabular-nums ${X??""}`),l(C,j())},[()=>r(d).has(z)?"text-base-content/40 line-through":"text-secondary/70"]),_(p1,h1)},X1=p1=>{var h1=q3(),K=t(h1,!0);e(h1),R((C,h)=>{u1(h1,1,`text-xs tabular-nums ${C??""}`),l(K,h)},[()=>r(d).has(z)?"text-base-content/40 line-through":"text-secondary/70",()=>J(H())]),_(p1,h1)};d1(J1,p1=>{n.scheduleMode==="clock"&&j()?p1(G1):p1(X1,-1)})}e(F1),e(k1);var $1=o(k1,2);{var N1=p1=>{var h1=K3(),K=t(h1,!0);e(h1),R(C=>{u1(h1,1,`text-[11px] mt-0.5 leading-snug ${C??""}`),l(K,H().notes)},[()=>r(d).has(z)?"text-base-content/25 line-through":"text-base-content/55"]),_(p1,h1)};d1($1,p1=>{H().notes&&p1(N1)})}var W1=o($1,2);{var K1=p1=>{var h1=Z3();Z1(h1,21,()=>Array(H().setCount),ge,(K,C,h)=>{var w=Y3(),X=t(w);{var e1=q=>{var S1=fe("✓");_(q,S1)},A1=m1(()=>S(z,h));d1(X,q=>{r(A1)&&q(e1)})}e(w),R(q=>u1(w,1,`w-5 h-5 rounded border-2 text-[10px] font-bold flex items-center justify-center transition-colors
                        ${q??""}`),[()=>S(z,h)?"bg-success/15 border-success/40 text-success":"border-base-300 hover:border-secondary/50"]),P("click",w,q=>{q.stopPropagation(),y(z,h)}),_(K,w)}),e(h1),_(p1,h1)};d1(W1,p1=>{H().setCount&&H().setCount>0&&p1(K1)})}e(L1),e(g1),R((p1,h1,K,C)=>{Z(g1,"aria-checked",p1),u1(O,1,`shrink-0 w-5 h-5 rounded-sm rotate-45 text-[9px] font-bold flex items-center justify-center z-10 transition-colors mt-0.5
							${h1??""}`),u1(L1,1,`flex-1 min-w-0 transition-opacity ${K??""}`),u1(T1,1,`text-xs font-medium leading-tight transition-colors
									${C??""}`),l(C1,H().label)},[()=>r(d).has(z),()=>r(d).has(z)?"bg-success/15 text-success":"bg-secondary/10 text-secondary/70 group-hover:bg-secondary/20",()=>r(d).has(z)?"opacity-50":"",()=>r(d).has(z)?"text-base-content/40 line-through":"text-base-content/80"]),P("click",g1,()=>A(z)),P("keydown",g1,p1=>{(p1.key==="Enter"||p1.key===" ")&&(p1.preventDefault(),A(z))}),_(x1,g1)},c1=x1=>{var g1=on(),O=t(g1);{var z1=C=>{var h=X3();_(C,h)};d1(O,C=>{z<r(G).length-1&&C(z1)})}var B1=o(O,2),R1=t(B1);{var H1=C=>{var h=fe("✓");_(C,h)},L1=m1(()=>r(d).has(z)),k1=C=>{var h=fe();R(()=>l(h,Y()+1)),_(C,h)};d1(R1,C=>{r(L1)?C(H1):C(k1,-1)})}e(B1);var T1=o(B1,2),C1=t(T1),F1=t(C1),J1=t(F1,!0);e(F1);var G1=o(F1,2),X1=t(G1);{var $1=C=>{var h=en(),w=ne(h),X=t(w,!0);e(w);var e1=o(w,2);{var A1=q=>{var S1=Q3(),y1=t(S1);e(S1),R(E=>{u1(S1,1,`text-xs text-base-content/50 tabular-nums ${E??""}`),l(y1,`→ ${V()??""}`)},[()=>r(d).has(z)?"line-through":""]),_(q,S1)};d1(e1,q=>{V()&&V()!==j()&&q(A1)})}R(q=>{u1(w,1,`text-xs font-bold tabular-nums ${q??""}`),l(X,j())},[()=>r(d).has(z)?"text-base-content/50 line-through":"text-secondary"]),_(C,h)},N1=C=>{var h=tn(),w=t(h,!0);e(h),R((X,e1)=>{u1(h,1,`text-xs font-bold tabular-nums ${X??""}`),l(w,e1)},[()=>r(d).has(z)?"text-base-content/50 line-through":"text-secondary",()=>J(H())]),_(C,h)};d1(X1,C=>{n.scheduleMode==="clock"&&j()?C($1):C(N1,-1)})}e(G1),e(C1);var W1=o(C1,2);{var K1=C=>{var h=an(),w=t(h,!0);e(h),R(X=>{u1(h,1,`text-xs mt-1 leading-snug ${X??""}`),l(w,H().notes)},[()=>r(d).has(z)?"text-base-content/30 line-through":"text-base-content/70"]),_(C,h)};d1(W1,C=>{H().notes&&C(K1)})}var p1=o(W1,2);{var h1=C=>{var h=nn();Z1(h,21,()=>Array.from({length:H().setCount},(w,X)=>X),ge,(w,X)=>{var e1=rn(),A1=t(e1);{var q=E=>{var r1=fe("✓");_(E,r1)},S1=m1(()=>S(z,r(X))),y1=E=>{var r1=fe();R(()=>l(r1,r(X)+1)),_(E,r1)};d1(A1,E=>{r(S1)?E(q):E(y1,-1)})}e(e1),R(E=>u1(e1,1,`w-7 h-7 rounded-full font-bold text-xs flex items-center justify-center transition-colors ${E??""}`),[()=>S(z,r(X))?"bg-success/15 text-success":"bg-secondary/15 text-secondary hover:bg-secondary/25"]),P("click",e1,E=>{E.stopPropagation(),y(z,r(X))}),_(w,e1)}),e(h),_(C,h)},K=m1(()=>H().setCount&&!r(d).has(z));d1(p1,C=>{r(K)&&C(h1)})}e(T1),e(g1),R((C,h,w,X)=>{Z(g1,"aria-checked",C),u1(B1,1,`shrink-0 w-8 h-8 rounded-full font-bold text-xs flex items-center justify-center z-10 transition-colors
							${h??""}`),u1(T1,1,`flex-1 min-w-0 transition-opacity ${w??""}`),u1(F1,1,`text-sm font-semibold leading-tight transition-colors
									${X??""}`),l(J1,H().label)},[()=>r(d).has(z),()=>r(d).has(z)?"bg-success/15 text-success":"bg-secondary/15 text-secondary group-hover:bg-secondary/25",()=>r(d).has(z)?"opacity-50":"",()=>r(d).has(z)?"text-base-content/50 line-through":"text-base-content"]),P("click",g1,()=>A(z)),P("keydown",g1,C=>{(C.key==="Enter"||C.key===" ")&&(C.preventDefault(),A(z))}),_(x1,g1)};d1(b1,x1=>{H().isSubStep?x1(l1):x1(c1,-1)})}_(x,a1)}),e(I),e(k),e(D),R(()=>{l(L,r(f).schedule),l($,r(f).scheduleComplete)}),_(a,D),Le(),b()}st(["click","keydown"]);var cn=N('<div class="card bg-base-100 shadow-sm ring-1 ring-base-300/70"><div class="card-body p-5"><h2 class="text-base font-semibold text-base-content uppercase tracking-wide mb-3"> </h2> <div class="text-sm text-base-content space-y-2"><p><span class="font-semibold text-secondary"> </span> </p> <p><span class="font-semibold text-warning"> </span> </p> <p><span class="font-semibold text-error"> </span> </p></div> <div class="mt-4 pt-4 border-t border-base-200 text-xs text-base-content/70 space-y-1"><p><strong> </strong> </p> <p><strong> </strong> </p> <p><strong> </strong> </p></div></div></div>');function dn(a,n){De(n,!0);const c=()=>oe(ye,"$lang",s),[s,b]=$e(),f=m1(()=>Ne[c()]),d=m1(()=>r(f).guidance[n.crumbGoal]),i=m1(()=>r(f).crumbGoalNames[n.crumbGoal]);var g=cn(),A=t(g),y=t(A),S=t(y,!0);e(y);var G=o(y,2),J=t(G),D=t(J),k=t(D,!0);e(D);var u=o(D);e(J);var L=o(J,2),U=t(L),$=t(U,!0);e(U);var I=o(U);e(L);var x=o(L,2),T=t(x),z=t(T,!0);e(T);var H=o(T);e(x),e(G);var j=o(G,2),V=t(j),Y=t(V),a1=t(Y,!0);e(Y);var b1=o(Y);e(V);var l1=o(V,2),c1=t(l1),x1=t(c1,!0);e(c1);var g1=o(c1);e(l1);var O=o(l1,2),z1=t(O),B1=t(z1,!0);e(z1);var R1=o(z1);e(O),e(j),e(A),e(g),R(H1=>{l(S,r(f).readingYourCrumb),l(k,H1),l(u,` ${r(d).description??""}`),l($,r(f).underFermented),l(I,` ${r(d).underFermented??""}`),l(z,r(f).overFermented),l(H,` ${r(d).overFermented??""}`),l(a1,r(f).floatTest),l(b1,` ${r(f).floatTestDesc??""}`),l(x1,r(f).pokeTest),l(g1,` ${r(f).pokeTestDesc??""}`),l(B1,r(f).jiggleTest),l(R1,` ${r(f).jiggleTestDesc??""}`)},[()=>r(f).target(r(i))]),_(a,g),Le(),b()}var un=N('<div class="flex justify-between items-center py-2 border-b border-base-200"><dt class="text-sm text-base-content/70"> </dt> <dd class="text-sm font-semibold text-base-content tabular-nums"> </dd></div>'),mn=N('<button type="button" class="fixed inset-0 z-40 bg-neutral/40 backdrop-blur-sm"></button> <div class="fixed bottom-0 left-0 right-0 z-50 max-h-[70vh] overflow-y-auto rounded-t-2xl bg-base-100 shadow-xl ring-1 ring-base-300/80" role="dialog" aria-modal="true"><div class="sticky top-0 flex items-center justify-between px-5 py-4 bg-base-100/95 backdrop-blur border-b border-base-200"><h2 class="text-base font-semibold text-base-content"> </h2> <button type="button" class="btn btn-ghost btn-sm btn-circle"><svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12"></path></svg></button></div> <div class="px-5 py-4"><p class="text-sm text-base-content/70 mb-4"> </p> <dl class="space-y-2"></dl></div> <div class="px-5 pb-6"><button type="button" class="btn btn-primary w-full"> </button></div></div>',1);function pn(a,n){De(n,!0);const c=()=>oe(ye,"$lang",b),s=()=>oe(m2,"$assumptionsOpen",b),[b,f]=$e(),d=m1(()=>Ne[c()]);function i(){m2.set(!1)}var g=v2(),A=ne(g);{var y=S=>{var G=mn(),J=ne(G),D=o(J,2),k=t(D),u=t(k),L=t(u,!0);e(u);var U=o(u,2);e(k);var $=o(k,2),I=t($),x=t(I,!0);e(I);var T=o(I,2);Z1(T,21,()=>Object.entries(n.assumptions),ge,(V,Y)=>{var a1=m1(()=>ir(r(Y),2));let b1=()=>r(a1)[0],l1=()=>r(a1)[1];var c1=un(),x1=t(c1),g1=t(x1,!0);e(x1);var O=o(x1,2),z1=t(O,!0);e(O),e(c1),R(()=>{l(g1,b1()),l(z1,l1())}),_(V,c1)}),e(T),e($);var z=o($,2),H=t(z),j=t(H,!0);e(H),e(z),e(D),R(()=>{Z(J,"aria-label",r(d).ariaLabels.closeAssumptionsDrawer),Z(D,"aria-label",r(d).calculationAssumptions),l(L,r(d).calculationAssumptions),Z(U,"aria-label",r(d).ariaLabels.closeButton),l(x,r(d).assumptionsDesc),l(j,r(d).done)}),P("click",J,i),P("click",U,i),P("click",H,i),_(S,G)};d1(A,S=>{s()&&S(y)})}_(a,g),Le(),f()}st(["click"]);var vn=N('<div class="install-cta-row border-b border-neutral-content/15 bg-neutral/70 svelte-1uha8ag"><div class="max-w-2xl mx-auto px-4 py-2 flex justify-end"><button type="button"> </button></div></div>'),bn=N("<!> <!> <!> <!>",1),gn=N('<div class="card bg-base-100/95 shadow-sm ring-1 ring-base-300/70"><div class="card-body items-center text-center"><div class="text-4xl mb-3" aria-hidden="true">⚖️</div> <p class="text-base-content/70 font-medium"> </p> <p class="text-base-content/50 text-sm mt-1"> </p></div></div>'),fn=N('<dialog class="modal modal-open" aria-modal="true" aria-labelledby="install-help-title"><div class="modal-box max-w-lg"><h3 id="install-help-title" class="text-lg font-semibold"> </h3> <p class="mt-2 text-sm text-base-content/80"> </p> <ul class="mt-3 list-disc space-y-2 pl-5 text-sm leading-relaxed text-base-content/90"><li> </li> <li> </li> <li> </li></ul> <div class="modal-action"><button type="button" class="btn btn-primary btn-sm rounded-full"> </button></div></div> <form method="dialog" class="modal-backdrop"><button type="button"> </button></form></dialog>'),hn=N('<div class="min-h-screen bg-gradient-to-b from-base-200 via-base-200 to-base-300/40"><header class="bg-neutral/95 text-neutral-content border-b border-primary/25 shadow-sm backdrop-blur supports-[backdrop-filter]:bg-neutral/90 sticky top-0 z-30"><!> <div class="max-w-2xl mx-auto px-4 py-4 flex flex-wrap items-center justify-between gap-y-3"><div class="flex items-center gap-3 min-w-0"><span class="flex h-9 w-9 shrink-0 items-center justify-center rounded-xl bg-primary/20 text-xl text-primary ring-1 ring-primary/35" aria-hidden="true">🍞</span> <div><h1 class="text-base font-bold text-neutral-content leading-tight">DoughCulator</h1> <p class="text-xs text-neutral-content/70 leading-tight"> </p></div></div> <div class="flex items-center flex-wrap justify-end gap-2"><label class="swap swap-rotate inline-grid h-9 w-9 place-items-center rounded-full border border-transparent bg-transparent text-neutral-content/75 transition-colors duration-200 hover:border-neutral-content/35 hover:bg-neutral-content/10 hover:text-neutral-content focus-within:border-primary/45 focus-within:ring-2 focus-within:ring-primary/55 focus-within:ring-offset-2 focus-within:ring-offset-neutral/95"><input type="checkbox" class="sr-only appearance-none"/> <svg class="swap-on h-5 w-5 fill-current" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M5.64,17l-.71.71a1,1,0,0,0,0,1.41,1,1,0,0,0,1.41,0l.71-.71A1,1,0,0,0,5.64,17ZM5,12a1,1,0,0,0-1-1H3a1,1,0,0,0,0,2H4A1,1,0,0,0,5,12Zm7-7a1,1,0,0,0,1-1V3a1,1,0,0,0-2,0V4A1,1,0,0,0,12,5ZM5.64,7.05a1,1,0,0,0,.7.29,1,1,0,0,0,.71-.29,1,1,0,0,0,0-1.41l-.71-.71A1,1,0,0,0,4.93,6.34Zm12,.29a1,1,0,0,0,.7-.29l.71-.71a1,1,0,1,0-1.41-1.41L17,5.64a1,1,0,0,0,0,1.41A1,1,0,0,0,17.66,7.34ZM21,11H20a1,1,0,0,0,0,2h1a1,1,0,0,0,0-2Zm-9,8a1,1,0,0,0-1,1v1a1,1,0,0,0,2,0V20A1,1,0,0,0,12,19ZM18.36,17A1,1,0,0,0,17,18.36l.71.71a1,1,0,0,0,1.41,0,1,1,0,0,0,0-1.41ZM12,6.5A5.5,5.5,0,1,0,17.5,12,5.51,5.51,0,0,0,12,6.5Zm0,9A3.5,3.5,0,1,1,15.5,12,3.5,3.5,0,0,1,12,15.5Z"></path></svg> <svg class="swap-off h-5 w-5 fill-current" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M21.64,13a1,1,0,0,0-1.05-.14,8.05,8.05,0,0,1-3.37.73A8.15,8.15,0,0,1,9.08,5.49a8.59,8.59,0,0,1,.25-2A1,1,0,0,0,8,2.36,10.14,10.14,0,1,0,22,14.05,1,1,0,0,0,21.64,13Zm-9.5,6.69A8.14,8.14,0,0,1,7.08,5.22v.27A10.15,10.15,0,0,0,17.22,15.63a9.79,9.79,0,0,0,2.1-.22A8.11,8.11,0,0,1,12.14,19.73Z"></path></svg></label> <div class="join border border-neutral-content/25 rounded-full bg-neutral-content/5 p-0.5"><button type="button">EN</button> <button type="button">ES</button> <button type="button">SV</button></div> <button type="button" class="btn btn-outline btn-sm rounded-full border-neutral-content/25 text-neutral-content/80 hover:border-neutral-content/40 hover:bg-neutral-content/10 hover:text-neutral-content"> </button> <button type="button"> </button></div></div></header> <main class="max-w-2xl mx-auto px-4 py-6 space-y-4"><!> <!></main> <footer class="max-w-2xl mx-auto px-4 py-8 text-center text-xs text-base-content/60"><p> </p> <p class="mt-1"> </p> <div class="mt-6 flex justify-center"><a href="https://www.buymeacoffee.com/alestryperez" target="_blank" rel="noopener noreferrer"><img src="https://cdn.buymeacoffee.com/buttons/v2/default-yellow.png" alt="Buy Me A Coffee" style="height: 60px !important; width: 217px !important;" loading="lazy"/></a></div></footer> <!></div> <!>',1);function wn(a,n){De(n,!0);const c=()=>oe(ye,"$lang",f),s=()=>oe(J2,"$result",f),b=()=>oe(be,"$inputs",f),[f,d]=$e(),i=m1(()=>Ne[c()]);let g=le(!1),A=le(null),y=le(!1),S=le("idle");function G(){const h=s().formula,w=s().schedule,X=s().assumptions,e1=w.map((q,S1)=>{let y1="";return q.durationMins!==null&&q.durationMins!==void 0?y1=se(q.durationMins):q.rangeMinMins!==void 0&&q.rangeMaxMins!==void 0&&(y1=`${se(q.rangeMinMins)} – ${se(q.rangeMaxMins)}`),`${S1+1}. ${q.label}${y1?" ("+y1+")":""}${q.notes?" — "+q.notes:""}`}),A1=Object.entries(X).map(([q,S1])=>`${q}: ${S1}`);return[r(i).copyTitle,r(i).copyDivider,`${r(i).totalFlourRow}: ${Math.round(h.totalFlourG)}g (${b().flourBlend.map(q=>`${r(i).flourTypes[q.type]??q.type}: ${Math.round(h.totalFlourG*q.pct/100)}g`).join(", ")})`,`${r(i).water}: ${Math.round(h.totalWaterG)}g (${h.finalHydrationPct.toFixed(1)}%)`,`${r(i).saltRow}: ${Math.round(h.saltG)}g`,`${r(i).starter}: ${Math.round(h.starterTotalG)}g`,"",r(i).copyScheduleHeader,r(i).copyScheduleDivider,...e1,"",r(i).copyAssumptionsHeader,r(i).copyAssumptionsDivider,...A1,"",r(i).copyFooter].join(`
`)}async function J(){const h=G();try{if(!navigator.clipboard?.writeText)throw new Error("Clipboard API unavailable");await navigator.clipboard.writeText(h),W(g,!0),setTimeout(()=>W(g,!1),2500)}catch{const w=document.createElement("textarea");w.value=h,w.setAttribute("readonly",""),w.style.position="fixed",w.style.opacity="0",w.style.pointerEvents="none",document.body.appendChild(w),w.focus(),w.select();try{document.execCommand("copy")&&(W(g,!0),setTimeout(()=>W(g,!1),2500))}finally{document.body.removeChild(w)}}}function D(){m2.set(!0)}function k(h){ye.set(h)}function u(){if(typeof window>"u")return!1;const h=navigator;return window.matchMedia("(display-mode: standalone)").matches||h.standalone===!0}async function L(){if(u()){W(S,"installed");return}if(!r(A)){W(y,!0);return}await r(A).prompt();const{outcome:h}=await r(A).userChoice;W(S,h,!0),W(A,null),W(y,!1)}function U(){W(y,!1)}const $=m1(()=>b().totalFlourInputG);let I=le(!1);Bt(()=>{if(u()){W(S,"installed"),W(A,null);return}const h=X=>{const e1=X;e1.preventDefault(),W(A,e1,!0),W(S,"idle")},w=()=>{W(S,"installed"),W(A,null),W(y,!1)};return window.addEventListener("beforeinstallprompt",h),window.addEventListener("appinstalled",w),()=>{window.removeEventListener("beforeinstallprompt",h),window.removeEventListener("appinstalled",w)}}),Bt(()=>{W(I,localStorage.getItem("theme")==="dark")}),Bt(()=>{const h=r(I)?"dark":"bumblebee";document.documentElement.setAttribute("data-theme",h),localStorage.setItem("theme",h)});var x=hn();ur("1uha8ag",h=>{U2(()=>{cr.title="DoughCulator"})});var T=ne(x),z=t(T),H=t(z);{var j=h=>{var w=vn(),X=t(w),e1=t(X),A1=t(e1,!0);e(e1),e(X),e(w),R(()=>{u1(e1,1,`btn btn-xs sm:btn-sm rounded-full shadow-sm ${r(A)?"btn-primary":"btn-outline border-neutral-content/30 text-neutral-content hover:border-neutral-content/45 hover:bg-neutral-content/10 hover:text-neutral-content"}`),l(A1,r(i).saveToHomeScreen)}),P("click",e1,L),_(h,w)};d1(H,h=>{r(S)!=="installed"&&h(j)})}var V=o(H,2),Y=t(V),a1=o(t(Y),2),b1=o(t(a1),2),l1=t(b1,!0);e(b1),e(a1),e(Y);var c1=o(Y,2),x1=t(c1),g1=t(x1);ce(g1),ot(4),e(x1);var O=o(x1,2),z1=t(O),B1=o(z1,2),R1=o(B1,2);e(O);var H1=o(O,2),L1=t(H1,!0);e(H1);var k1=o(H1,2),T1=t(k1,!0);e(k1),e(c1),e(V),e(z);var C1=o(z,2),F1=t(C1);H3(F1,{});var J1=o(F1,2);{var G1=h=>{var w=bn(),X=ne(w);N3(X,{get formula(){return s().formula},get flourBlend(){return b().flourBlend}});var e1=o(X,2);W3(e1,{get timing(){return s().timing},get formula(){return s().formula},get proofMethod(){return b().proofMethod}});var A1=o(e1,2);{let S1=m1(()=>b().scheduleMode==="clock"?b().startTime??"08:00":null);ln(A1,{get steps(){return s().schedule},get scheduleMode(){return b().scheduleMode},get startTime(){return r(S1)}})}var q=o(A1,2);dn(q,{get crumbGoal(){return b().crumbGoal}}),_(h,w)},X1=h=>{var w=gn(),X=t(w),e1=o(t(X),2),A1=t(e1,!0);e(e1);var q=o(e1,2),S1=t(q,!0);e(q),e(X),e(w),R(()=>{l(A1,r(i).emptyStateTitle),l(S1,r(i).emptyStateSubtitle)}),_(h,w)};d1(J1,h=>{r($)>0?h(G1):h(X1,-1)})}e(C1);var $1=o(C1,2),N1=t($1),W1=t(N1,!0);e(N1);var K1=o(N1,2),p1=t(K1,!0);e(K1),ot(2),e($1);var h1=o($1,2);{var K=h=>{var w=fn(),X=t(w),e1=t(X),A1=t(e1,!0);e(e1);var q=o(e1,2),S1=t(q,!0);e(q);var y1=o(q,2),E=t(y1),r1=t(E,!0);e(E);var i1=o(E,2),v1=t(i1,!0);e(i1);var n1=o(i1,2),M1=t(n1,!0);e(n1),e(y1);var w1=o(y1,2),P1=t(w1),O1=t(P1,!0);e(P1),e(w1),e(X);var E1=o(X,2),I1=t(E1),Q1=t(I1,!0);e(I1),e(E1),e(w),R(()=>{l(A1,r(i).installHelpTitle),l(S1,r(i).installHelpIntro),l(r1,r(i).installHelpIOS),l(v1,r(i).installHelpAndroid),l(M1,r(i).installHelpDesktop),l(O1,r(i).close),Z(I1,"aria-label",r(i).close),l(Q1,r(i).close)}),P("click",P1,U),P("click",I1,U),_(h,w)};d1(h1,h=>{r(y)&&h(K)})}e(T);var C=o(T,2);pn(C,{get assumptions(){return s().assumptions}}),R(()=>{l(l1,r(i).appSubtitle),Z(x1,"aria-label",r(i).ariaLabels.toggleDarkMode),Z(O,"aria-label",r(i).ariaLabels.selectLanguage),u1(z1,1,`btn btn-xs join-item rounded-l-full border-0 ${c()==="en"?"btn-primary":"btn-ghost text-neutral-content/70 hover:text-neutral-content hover:bg-neutral-content/10"}`),u1(B1,1,`btn btn-xs join-item border-0 ${c()==="es"?"btn-primary":"btn-ghost text-neutral-content/70 hover:text-neutral-content hover:bg-neutral-content/10"}`),u1(R1,1,`btn btn-xs join-item rounded-r-full border-0 ${c()==="sv"?"btn-primary":"btn-ghost text-neutral-content/70 hover:text-neutral-content hover:bg-neutral-content/10"}`),l(L1,r(i).assumptions),k1.disabled=r($)<=0,u1(k1,1,`btn btn-sm rounded-full shadow-sm ${r(g)?"btn-success":r($)>0?"btn-primary":"btn-disabled"}`),l(T1,r(g)?r(i).copied:r(i).copyRecipe),l(W1,r(i).footerLine1),l(p1,r(i).footerLine2)}),kr(g1,()=>r(I),h=>W(I,h)),P("click",z1,()=>k("en")),P("click",B1,()=>k("es")),P("click",R1,()=>k("sv")),P("click",H1,D),P("click",k1,J),_(a,x),Le(),d()}st(["click"]);export{wn as component};
